...
##                                                                            ##
##   [概要]                                                                   ##
##      PGAを閾値以上使用しているセッションをkillする(本番用)                 ##
##                                                                            ##
##   [作成/更新履歴]                                                          ##
...
##                         ・Copyrightの削除                                  ##
##                         ・環境依存値の変数化                               ##
##                         ・p.pga_used_memをp.pga_alloc_memに変更            ##
##                                                                            ##
##   [戻り値]                                                                 ##
##      0 : 正常                                                              ##
##      8 : 異常                                                              ##
...
##                                                                            ##
##   [使用方法]                                                               ##
##      /uspg/jp1/zc/shl/<環境依存値>/ZCZZ_WI_AUTOKILL.ksh                    ##
##                                                                            ##
################################################################################
...
##シェル固有環境変数
KILL_PID_LIST=/uspg/jp1/zc/shl/tmp/ZCZZ_kill_pid_list_temp2.lst    #kill対象PIDリスト一時ファイル
...
--      ,ROUND(p.pga_used_mem / 1024 / 1024) pga_mg
      ,ROUND(p.pga_alloc_mem / 1024 / 1024) pga_mg
--2014/07/31 S.Noguchi Mod End
      ,s.seconds_in_wait
FROM v\$session s
    ,v\$process p
