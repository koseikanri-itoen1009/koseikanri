...
REM                                                                            
REM   [概要]                                                                   
REM          コンカレントマネージャ管理表のクリーンアップスクリプト            
REM          ※KROWN:157244に記載されているスクリプトを使用                    
REM                                                                            
REM                                                                            
REM   [作成/更新履歴]                                                          
REM        作成者  ：   SCSK 髙橋           2014/07/31 2.0.0                   
REM        更新履歴：   SCSK 髙橋           2014/07/31 2.0.0                   
REM                       初版/HWリプレース対応(リプレース_00007)              
REM                                                                            
REM                                                                            
REM +=========================================================================+
...
DOCUMENT
   ...
   WARNING : Do not run this script without explicit instructions from Oracle Support 
