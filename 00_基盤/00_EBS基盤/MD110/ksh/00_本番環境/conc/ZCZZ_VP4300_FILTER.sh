...
# [作成/更新履歴]
#    作成者  ：
#    更新履歴： SCSK 山田             2022/04/25 3.0.0
#                 基幹システムリフト対応 (リプレース_17512)
#                 ・シェバンの変更 -fオプション削除
#                 ・enqコマンドの変更
################################################################
...
##2022/04/25 S.Yamada Mod Start
#enq -U -P${Printer} >> ${logFile} 2>&1
/usr/sbin/lpadmin -E -p${Printer} >> ${logFile} 2>&1
##2022/04/25 S.Yamada Mod End
