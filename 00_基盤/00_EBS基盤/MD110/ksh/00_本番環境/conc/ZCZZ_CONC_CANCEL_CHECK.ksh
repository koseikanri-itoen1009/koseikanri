...
##            数値(入力された数値分、過去に遡った期間)  10 ～ 60(10の倍数)    ##
##                                                                            ##
##   [使用方法]                                                               ##
...
##2021/12/23 S.Yamada Mod Start   ※E_本稼動_17512対応
#L_hosutomei=`/bin/hostname`                     #ホスト名
L_hosutomei=`/bin/hostname -s`                  #ホスト名
##2021/12/23 S.Yamada Mod End     ※E_本稼動_17512対応
...
##2021/12/23 S.Yamada Del Start   ※E_本稼動_17512対応
### 環境変数設定 ###
##export NLS_LANG=American_America.JA16SJIS       #SQLの結果を文字化けさせない設定
##2021/12/23 S.Yamada Del End     ※E_本稼動_17512対応
...
##2021/12/23 S.Yamada Add Start   ※E_本稼動_17512対応
### 環境変数設定 ###
export NLS_LANG='American_America.UTF8'            #SQLの結果を文字化けさせない設定
##2021/12/23 S.Yamada Add End     ※E_本稼動_17512対応
...
#   /usr/bin/cat ${TE_ZCZZHYOUJUNSHUTURYOKU} ${TE_ZCZZHYOUJUNERA} | /usr/bin/tee -a ${L_rogumei} 1>&2
   /bin/cat ${TE_ZCZZHYOUJUNSHUTURYOKU} ${TE_ZCZZHYOUJUNERA} | /usr/bin/tee -a ${L_rogumei} 1>&2
##2021/12/23 S.Yamada Mod End      ※E_本稼動_17512対応
   L_shuryo ${TE_ZCZZIJOUSHURYO}
fi
...
#   /usr/bin/cat ${TE_ZCZZHYOUJUNSHUTURYOKU} | /usr/bin/tee -a ${L_rogumei} 1>&2
   /bin/cat ${TE_ZCZZHYOUJUNSHUTURYOKU} | /usr/bin/tee -a ${L_rogumei} 1>&2
##2021/12/23 S.Yamada Mod End      ※E_本稼動_17512対応
   L_shuryo ${TE_ZCZZIJOUSHURYO}
fi
