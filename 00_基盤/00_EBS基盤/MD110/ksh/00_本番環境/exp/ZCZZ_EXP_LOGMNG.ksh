...
##                                                                            ##
##   [概要]                                                                   ##
##      保存期間を過ぎた外部APサーバのログファイルの削除を実施する。          ##
##                                                                            ##
##   [作成/更新履歴]                                                          ##
##        作成者  ：   Oracle 堀井           2008/03/17 1.0.1                 ##
##        更新履歴：   Oracle 堀井           2008/03/17 1.0.1                 ##
##                       初版                                                 ##
...
##                                                                            ##
##   [使用方法]                                                               ##
##      /uspg/jp1/zc/shl/<環境依存値>/ZCZZ_EXP_LOGMNG.ksh                     ##
##                                                                            ##
################################################################################
...
then
##2014/07/31 S.Noguchi Mod Start
#   echo "ZCZZ00003:[Error] ZCZZEXTAPDELFILE.env が存在しない、または見つかりません。 HOST=${L_hosutomei}" \
   echo "ZCZZ00003:[Error] ZCZZEXPDELFILE.env が存在しない、または見つかりません。 HOST=${L_hosutomei}" \
        | /usr/bin/fold -w 75 | /usr/bin/tee -a ${L_rogumei} 1>&2
##2014/07/31 S.Noguchi Mod End
