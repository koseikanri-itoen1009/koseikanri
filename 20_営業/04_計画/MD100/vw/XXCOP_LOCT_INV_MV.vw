 ...
 *  2009-09-14    1.4   SCS.Goto         障害:0001362対応
 *
 ************************************************************************/
--20090914_Ver1.4_0001362_SCS.Goto_DEL_START
...
--  AND    iwm.attribute1             = '0'
--/
--20090914_Ver1.4_0001362_SCS.Goto_DEL_END
--20090914_Ver1.4_0001362_SCS.Goto_ADD_START
CREATE MATERIALIZED VIEW APPS.XXCOP_LOCT_INV_MV
  TABLESPACE "XXDATA2"
  BUILD IMMEDIATE
  USING INDEX
  ...
  AS
  SELECT
    'A20'                   organization_code,
    1                       organization_id,
    '2020'                  whse_code,
    '2020'                  whse_short_name,
    1                       inv_loct_id,
    1                       item_id,
    '0000001'               item_no,
    '0000001'               item_short_name,
    1                       num_of_cases,
    ilm.lot_no              lot_no,
    ilm.lot_id              lot_id,
    FND_DATE.STRING_TO_DATE(ilm.attribute1, 'YYYY/MM/DD') manufacture_date,
  ...
  WHERE ROWNUM = 1
/
--20090914_Ver1.4_0001362_SCS.Goto_ADD_END
--
