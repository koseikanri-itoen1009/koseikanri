 ...
 *  2009-04-27    1.2   Daisuke.Abe       y”„ãŒv‰æo—Í‘Î‰zT1_0689,T1_0692,T1_0694,T1_0695
 *  2009-04-27    1.2   Daisuke.Abe       y”„ãŒv‰æo—Í‘Î‰zT1_0734,T1_0739,T1_0744,T1_0745
 *  2009-04-27    1.2   Daisuke.Abe       y”„ãŒv‰æo—Í‘Î‰zT1_0751
 *
 *****************************************************************************************/
--
...
--
    ...
    IS
      SELECT
              ...
              /* 20090427_abe_”„ãŒv‰æo—Í‘Î‰ START*/
             -- (xev.last_name || 'ƒOƒ‹[ƒv') group_name,           -- ‰c‹ÆƒOƒ‹[ƒv–¼
              (SELECT (xev.last_name || 'ƒOƒ‹[ƒv')
               FROM  xxcso_employees_v           xev 
               WHERE xev.employee_number = (SELECT MIN(xrrv2.employee_number)
                                            FROM   xxcso_resource_relations_v2 xrrv2 -- ƒŠƒ\[ƒXŠÖ˜Aƒ}ƒXƒ^(ÅV)VIEW
                                            WHERE  (CASE
...
--
    ...
    IS
      SELECT
              ...
              --)     group_name,                                   -- ƒOƒ‹[ƒv–¼
              (SELECT  (xev.last_name  || 'ƒOƒ‹[ƒv')
               FROM    xxcso_employees_v           xev                     -- ]‹Æˆõƒ}ƒXƒ^iÅVjƒrƒ…[
               WHERE   xev.employee_number =   (SELECT MIN(xrrv2.employee_number)
                                                FROM   xxcso_resource_relations_v2 xrrv2 -- ƒŠƒ\[ƒXŠÖ˜Aƒ}ƒXƒ^(ÅV)VIEW
                                                WHERE  (CASE
                                                          WHEN TO_DATE(xrrv2.issue_date,'YYYYMMDD') <= gd_online_sysdate
