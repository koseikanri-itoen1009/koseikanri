...
* 概要説明   : 帳合問屋用見積CSV出力Query格納用ビュー行クラス
* バージョン : 1.0
*============================================================================
* 修正履歴
* 日付       Ver. 担当者       修正内容
* ---------- ---- ------------ ----------------------------------------------
* 2009-01-13 1.0  SCS及川領     新規作成
*============================================================================
*/
...
public class XxcsoCsvQueryVORowImpl extends OAViewRowImpl 
{
  ...
  protected static final int REFERENCEQUOTENUMBERS = 32;
  protected static final int STORENAMES = 33;
  ...
  protected static final int EMPLOYEENUMBERS = 39;
  protected static final int FULLNAMES = 40;
  protected static final int BASECODES = 41;
  protected static final int BASENAMES = 42;
  protected static final int DELIVPLACES = 43;
  protected static final int PAYMENTCONDITIONS = 44;
  protected static final int QUOTEINFOSTARTDATES = 45;
  protected static final int QUOTEINFOENDDATES = 46;
  protected static final int QUOTESUBMITNAMES = 47;
  protected static final int STATUSS = 48;
  protected static final int SALESUNITTYPES = 49;
  protected static final int STOREUNITTYPES = 50;
  protected static final int DELIVPRICETAXTYPES = 51;
  protected static final int SPECIALNOTES = 52;
  protected static final int INVENTORYITEMCODES = 53;
  protected static final int ITEMSHORTNAMES = 54;
  protected static final int QUOTEDIVS = 55;
  protected static final int USUALLYDELIVPRICES = 56;
  protected static final int THISTIMEDELIVPRICES = 57;
  ...
  protected static final int ITEMFULLNAME = 68;
  protected static final int JANCODE = 69;
  protected static final int CASEJANCODE = 70;
  protected static final int ITFCODE = 71;
  protected static final int VESSELGROUP = 72;
  protected static final int FIXEDPRICENEW = 73;
  protected static final int SALESQUOTELINEID = 74;
  protected static final int STOREQUOTELINEID = 75;
  /**
   * 
  ...
  /**
   * 
   * Gets the attribute value for the calculated attribute ReferenceQuoteNumberS
   */
  public String getReferenceQuoteNumberS()
  {
    return (String)getAttributeInternal(REFERENCEQUOTENUMBERS);
  }

  /**
   * 
   * Sets <code>value</code> as the attribute value for the calculated attribute ReferenceQuoteNumberS
   */
  public void setReferenceQuoteNumberS(String value)
  {
    setAttributeInternal(REFERENCEQUOTENUMBERS, value);
  }

  /**
   * 
   * Gets the attribute value for the calculated attribute StoreNameS
   */
  public String getStoreNameS()
  {
    return (String)getAttributeInternal(STORENAMES);
  }

  /**
   * 
   * Sets <code>value</code> as the attribute value for the calculated attribute StoreNameS
   */
  public void setStoreNameS(String value)
  {
    setAttributeInternal(STORENAMES, value);
  }
  ...
  /**
   * 
   * Gets the attribute value for the calculated attribute SalesUnitTypeS
   */
  public String getSalesUnitTypeS()
  {
    return (String)getAttributeInternal(SALESUNITTYPES);
  }

  /**
   * 
   * Sets <code>value</code> as the attribute value for the calculated attribute SalesUnitTypeS
   */
  public void setSalesUnitTypeS(String value)
  {
    setAttributeInternal(SALESUNITTYPES, value);
  }

  /**
   * 
   * Gets the attribute value for the calculated attribute StoreUnitTypeS
   */
  public String getStoreUnitTypeS()
  {
    return (String)getAttributeInternal(STOREUNITTYPES);
  }

  /**
   * 
   * Sets <code>value</code> as the attribute value for the calculated attribute StoreUnitTypeS
   */
  public void setStoreUnitTypeS(String value)
  {
    setAttributeInternal(STOREUNITTYPES, value);
  }
  ...
  /**
   * 
   * Gets the attribute value for the calculated attribute SalesQuoteLineId
   */
  public Number getSalesQuoteLineId()
  {
    return (Number)getAttributeInternal(SALESQUOTELINEID);
  }

  /**
   * 
   * Sets <code>value</code> as the attribute value for the calculated attribute SalesQuoteLineId
   */
  public void setSalesQuoteLineId(Number value)
  {
    setAttributeInternal(SALESQUOTELINEID, value);
  }

  /**
   * 
   * Gets the attribute value for the calculated attribute StoreQuoteLineId
   */
  public Number getStoreQuoteLineId()
  {
    return (Number)getAttributeInternal(STOREQUOTELINEID);
  }

  /**
   * 
   * Sets <code>value</code> as the attribute value for the calculated attribute StoreQuoteLineId
   */
  public void setStoreQuoteLineId(Number value)
  {
    setAttributeInternal(STOREQUOTELINEID, value);
  }
  ...
  protected Object getAttrInvokeAccessor(int index, AttributeDefImpl attrDef) throws Exception
  {
    switch (index)
      ...
      case REFERENCEQUOTENUMBERS:
        return getReferenceQuoteNumberS();
      case STORENAMES:
      ...
      case STATUSS:
        return getStatusS();
      case SALESUNITTYPES:
        return getSalesUnitTypeS();
      case STOREUNITTYPES:
        return getStoreUnitTypeS();
      ...
      case SALESQUOTELINEID:
        return getSalesQuoteLineId();
      case STOREQUOTELINEID:
        return getStoreQuoteLineId();
      default:
  ...
  protected void setAttrInvokeAccessor(int index, Object value, AttributeDefImpl attrDef) throws Exception
  {
    switch (index)
      ...
      case QUOTETYPES:
        ...
        return;
      case REFERENCEQUOTENUMBERS:
        setReferenceQuoteNumberS((String)value);
        return;
      case STORENAMES:
        setStoreNameS((String)value);
        return;
      case QUOTENUMBERS:
      ...
      case STATUSS:
        ...
        return;
      case SALESUNITTYPES:
        setSalesUnitTypeS((String)value);
        return;
      case STOREUNITTYPES:
        setStoreUnitTypeS((String)value);
        return;
      case DELIVPRICETAXTYPES:
      ...
      case FIXEDPRICENEW:
        ...
        return;
      case SALESQUOTELINEID:
        setSalesQuoteLineId((Number)value);
        return;
      case STOREQUOTELINEID:
        setStoreQuoteLineId((Number)value);
        return;
      default:
