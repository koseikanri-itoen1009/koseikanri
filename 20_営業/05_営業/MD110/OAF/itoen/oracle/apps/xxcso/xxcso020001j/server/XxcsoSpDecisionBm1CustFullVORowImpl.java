/*============================================================================
* ÉtÉ@ÉCÉãñº : XxcsoSpDecisionBm1CustFullVORowImpl
* äTóvê‡ñæ   : BM1ìoò^Å^çXêVópÉrÉÖÅ[çsÉNÉâÉX
* ÉoÅ[ÉWÉáÉì : 1.1
*============================================================================
* èCê≥óöó
...
/*******************************************************************************
 * BM1Çìoò^Å^çXêVÇ∑ÇÈÇΩÇﬂÇÃÉrÉÖÅ[çsÉNÉâÉXÇ≈Ç∑ÅB
 * @author  SCSè¨êÏç_
 * @version 1.0
 *******************************************************************************
 */
public class XxcsoSpDecisionBm1CustFullVORowImpl extends OAViewRowImpl 
{
   ...
   */
  public XxcsoSpDecisionBm1CustFullVORowImpl()
  {
  }
  ...
  /**
   * 
   * Gets the attribute value for the calculated attribute TransferCommissionTypeView
   */
  public String getTransferCommissionTypeView()
  {
    return (String)getAttributeInternal(TRANSFERCOMMISSIONTYPEVIEW);
  }

  /**
   * 
   * Sets <code>value</code> as the attribute value for the calculated attribute TransferCommissionTypeView
   */
