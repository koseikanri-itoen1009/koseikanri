/*============================================================================
* ファイル名 : XxcsoCreateBasePlanCsvVORowImp1
* 概要説明   : 売上計画出力／拠点別計画CSV出力用ビュー行クラス
* バージョン : 1.0
*============================================================================
* 修正履歴
* 日付       Ver. 担当者       修正内容
...
/*******************************************************************************
 * 売上計画出力　拠点別計画CSV出力用ビュー行クラス
 * @author  SCS丸山美緒
 * @version 1.0
 *******************************************************************************
 */
public class XxcsoCreateBasePlanCsvVORowImpl extends OAViewRowImpl 
{
  ...
  protected static final int RSLTVDNEXTSERVAMT = 39;
  protected static final int RSLTVDEXISTSERVAMT = 40;
   ...
   */
  public XxcsoCreateBasePlanCsvVORowImpl()
  {
  }
  ...
  protected void setAttrInvokeAccessor(int index, Object value, AttributeDefImpl attrDef) throws Exception
  {
    switch (index)
      ...
      case RSLTVDNEWSERVAMT:
        ...
        return;
      case RSLTVDNEXTSERVAMT:
        setRsltVdNextServAmt((String)value);
        return;
      case RSLTVDEXISTSERVAMT:
  ...
  /**
   * 
   * Gets the attribute value for the calculated attribute RsltVdNextServAmt
   */
  public String getRsltVdNextServAmt()
  {
    return (String)getAttributeInternal(RSLTVDNEXTSERVAMT);
  }

  /**
   * 
   * Sets <code>value</code> as the attribute value for the calculated attribute RsltVdNextServAmt
   */
  public void setRsltVdNextServAmt(String value)
  {
