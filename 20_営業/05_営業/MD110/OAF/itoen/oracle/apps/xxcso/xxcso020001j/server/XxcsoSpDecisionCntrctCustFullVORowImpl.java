/*============================================================================
* ÉtÉ@ÉCÉãñº : XxcsoSpDecisionCntrctCustFullVORowImpl
* äTóvê‡ñæ   : å_ñÒêÊìoò^Å^çXêVópÉrÉÖÅ[çsÉNÉâÉX
* ÉoÅ[ÉWÉáÉì : 1.0
*============================================================================
* èCê≥óöó
...
/*******************************************************************************
 * å_ñÒêÊÇìoò^Å^çXêVÇ∑ÇÈÇΩÇﬂÇÃÉrÉÖÅ[çsÉNÉâÉXÇ≈Ç∑ÅB
 * @author  SCSè¨êÏç_
 * @version 1.0
 *******************************************************************************
 */
public class XxcsoSpDecisionCntrctCustFullVORowImpl extends OAViewRowImpl 
{
  ...
  protected static final int CONTRACTNUMBER = 36;
  /**
   * 
   * This is the default constructor (do not remove)
   */
  public XxcsoSpDecisionCntrctCustFullVORowImpl()
  {
  }
