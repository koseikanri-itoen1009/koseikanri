...
/*******************************************************************************
 * BM1送付先テーブル情報ビュー行オブジェクトクラス
 * @author  SCS小川浩
 * @version 1.0
 *******************************************************************************
 */
public class XxcsoBm1DestinationFullVORowImpl extends OAViewRowImpl 
{
  ...
  protected static final int XXCSOBM1BANKACCOUNTFULLVO = 33;
  /**
   * 
   * This is the default constructor (do not remove)
   */
  public XxcsoBm1DestinationFullVORowImpl()
  {
  }
