/*============================================================================
* ファイル名 : XxcsoQuoteItemLovVORowImpl
* 概要説明   : 見積から追加LOVビュー行クラス
* バージョン : 1.0
*============================================================================
* 修正履歴
* 日付       Ver. 担当者       修正内容
 ...
 *******************************************************************************
 */
public class XxcsoQuoteItemLovVORowImpl extends OAViewRowImpl 
{
  ...
  protected static final int QUOTENUMBER = 4;
  protected static final int QUOTEREVISIONNUMBER = 5;
  protected static final int PUBLISHDATE = 6;
  protected static final int JANCODE = 7;
  protected static final int ITFCODE = 8;
  protected static final int QUOTESTARTDATE = 9;
  protected static final int DELIVPRICE = 10;
  protected static final int STORESALESPRICE = 11;
  protected static final int STORESALESPRICEINCTAX = 12;
  protected static final int QUOTATIONPRICE = 13;
  protected static final int REMARKS = 14;
  protected static final int QUOTESUBMITNAME = 15;
  protected static final int DELETEENABLEDVALUE = 16;
  protected static final int QUOTELINEID = 17;
  /**
   * 
   * This is the default constructor (do not remove)
   */
  public XxcsoQuoteItemLovVORowImpl()
  {
  }
  ...
  protected Object getAttrInvokeAccessor(int index, AttributeDefImpl attrDef) throws Exception
  {
    switch (index)
      ...
      case DELETEENABLEDVALUE:
        return getDeleteEnabledValue();
      case QUOTELINEID:
  ...
  protected void setAttrInvokeAccessor(int index, Object value, AttributeDefImpl attrDef) throws Exception
  {
    switch (index)
      ...
      case QUOTESUBMITNAME:
        ...
        return;
      case DELETEENABLEDVALUE:
        setDeleteEnabledValue((String)value);
        return;
      case QUOTELINEID:
  ...
  /**
   * 
   * Gets the attribute value for the calculated attribute DeleteEnabledValue
   */
  public String getDeleteEnabledValue()
  {
    return (String)getAttributeInternal(DELETEENABLEDVALUE);
  }

  /**
   * 
   * Sets <code>value</code> as the attribute value for the calculated attribute DeleteEnabledValue
   */
  public void setDeleteEnabledValue(String value)
  {
    setAttributeInternal(DELETEENABLEDVALUE, value);
  }
