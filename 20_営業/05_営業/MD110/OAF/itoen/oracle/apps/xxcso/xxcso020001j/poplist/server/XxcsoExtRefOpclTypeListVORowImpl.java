/*============================================================================
* ファイル名 : XxcsoBusinessCondTypeListVOImpl
* 概要説明   : 物件オープン・クローズポップリスト用ビュー行クラス
* バージョン : 1.0
*============================================================================
* 修正履歴
* 日付       Ver. 担当者       修正内容
...
/*******************************************************************************
 * 物件オープン・クローズに表示するポップリストのビュー行クラスです。
 * @author  SCS小川浩
 * @version 1.0
 *******************************************************************************
 */
public class XxcsoExtRefOpclTypeListVORowImpl extends OAViewRowImpl 
{
   ...
   */
  public XxcsoExtRefOpclTypeListVORowImpl()
  {
  }
