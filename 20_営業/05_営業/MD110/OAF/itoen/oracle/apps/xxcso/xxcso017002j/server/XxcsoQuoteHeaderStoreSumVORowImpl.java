/*============================================================================
* ファイル名 : XxcsoQuoteHeaderStoreSumVORowImpl
* 概要説明   : 見積ヘッダー再読込み用ビュー行クラス
* バージョン : 1.0
*============================================================================
* 修正履歴
* 日付       Ver. 担当者       修正内容
...
/*******************************************************************************
 * 見積ヘッダー情報を再読込みするためのビュー行クラスです。
 * @author  SCS及川領
 * @version 1.0
 *******************************************************************************
 */

public class XxcsoQuoteHeaderStoreSumVORowImpl extends OAViewRowImpl 
{
  ...
  protected static final int XXCSOQUOTELINESTORESUMVO = 34;
  /**
   * 
   * This is the default constructor (do not remove)
   */
  public XxcsoQuoteHeaderStoreSumVORowImpl()
  {
  }
  ...
  protected Object getAttrInvokeAccessor(int index, AttributeDefImpl attrDef) throws Exception
  {
    switch (index)
      ...
      case BASENAME:
        return getBaseName();
      case XXCSOQUOTELINESTORESUMVO:
        return getXxcsoQuoteLineStoreSumVO();
      default:
  ...
  /**
   * 
   * Gets the associated <code>RowIterator</code> using master-detail link XxcsoQuoteLineStoreSumVO
   */
  public oracle.jbo.RowIterator getXxcsoQuoteLineStoreSumVO()
  {
    return (oracle.jbo.RowIterator)getAttributeInternal(XXCSOQUOTELINESTORESUMVO);
  }
}