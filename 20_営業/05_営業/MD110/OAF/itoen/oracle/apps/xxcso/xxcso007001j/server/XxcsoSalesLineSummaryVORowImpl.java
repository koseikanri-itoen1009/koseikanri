/*============================================================================
* ファイル名 : XxcsoSalesLineSummaryVORowImpl
* 概要説明   : 商談決定情報明細取得用ビュー行クラス
* バージョン : 1.0
*============================================================================
* 修正履歴
* 日付       Ver. 担当者       修正内容
...
/*******************************************************************************
 * 商談決定情報明細を取得するためのビュー行クラスです。
 * @author  SCS小川浩
 * @version 1.0
 *******************************************************************************
 */
public class XxcsoSalesLineSummaryVORowImpl extends OAViewRowImpl 
{
  ...
  protected static final int NOTIFIEDFLAG = 17;
  protected static final int SALESCLASSCODE = 18;
  protected static final int SALESADOPTCLASSRENDER = 19;
  protected static final int SALESAREARENDER = 20;
  protected static final int DELIVPRICERENDER = 21;
  protected static final int STORESALESPRICERENDER = 22;
  protected static final int STORESALESPRICEINCTAXRENDER = 23;
  protected static final int QUOTATIONPRICERENDER = 24;
  /**
   * 
   * This is the default constructor (do not remove)
   */
  public XxcsoSalesLineSummaryVORowImpl()
  {
  }

  /**
   * 
   * Gets the attribute value for the calculated attribute SalesLineId
   */
  ...
  /**
   * 
   * Sets <code>value</code> as the attribute value for the calculated attribute SalesLineId
   */
  ...
  /**
   * 
   * Gets the attribute value for the calculated attribute NotifiedFlag
   */
  ...
  /**
   * 
   * Sets <code>value</code> as the attribute value for the calculated attribute NotifiedFlag
   */
