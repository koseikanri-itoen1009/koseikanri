/*============================================================================
* ファイル名 : XxcsoBm1ContractSpCustFullVORowImpl
* 概要説明   : BM1SP専決顧客テーブル情報ビュー行オブジェクトクラス
* バージョン : 1.0
*============================================================================
* 修正履歴
* 日付       Ver. 担当者       修正内容
...
/*******************************************************************************
 * BM1SP専決顧客テーブル情報ビュー行オブジェクトクラス。
 * @author  SCS小川浩
 * @version 1.0
 *******************************************************************************
 */
public class XxcsoBm1ContractSpCustFullVORowImpl extends OAViewRowImpl 
{
   ...
   */
  public XxcsoBm1ContractSpCustFullVORowImpl()
  {
  }

  /**
   * 
   * Gets XxcsoContractSpCustsEO entity object.
   */
  public itoen.oracle.apps.xxcso.common.schema.server.XxcsoContractSpCustsEOImpl getXxcsoContractSpCustsEO()
  {
    return (itoen.oracle.apps.xxcso.common.schema.server.XxcsoContractSpCustsEOImpl)getEntity(0);
  }
  ...
  /**
   * 
   * Gets the attribute value for POSTAL_CODE_FIRST using the alias name PostalCodeFirst
   */
  ...
  /**
   * 
   * Sets <code>value</code> as attribute value for POSTAL_CODE_FIRST using the alias name PostalCodeFirst
   */
  ...
  /**
   * 
   * Gets the attribute value for POSTAL_CODE_SECOND using the alias name PostalCodeSecond
   */
  ...
  /**
   * 
   * Sets <code>value</code> as attribute value for POSTAL_CODE_SECOND using the alias name PostalCodeSecond
   */
