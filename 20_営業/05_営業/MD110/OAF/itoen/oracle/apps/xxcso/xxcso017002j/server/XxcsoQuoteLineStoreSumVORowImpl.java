...
/*******************************************************************************
 * 見積明細情報を再読込みするためのビュー行クラスです。
 * @author  SCS及川領
 * @version 1.0
 *******************************************************************************
 */

public class XxcsoQuoteLineStoreSumVORowImpl extends OAViewRowImpl 
{
   ...
   */
  public XxcsoQuoteLineStoreSumVORowImpl()
  {
  }
