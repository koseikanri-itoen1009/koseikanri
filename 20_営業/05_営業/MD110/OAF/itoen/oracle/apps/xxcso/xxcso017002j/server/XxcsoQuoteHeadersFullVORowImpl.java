...
public class XxcsoQuoteHeadersFullVORowImpl extends OAViewRowImpl 
{
  ...
  protected static final int STORENAME = 29;
  protected static final int PARTYNAME = 30;
  protected static final int SALESUNITTYPE = 31;
  protected static final int FULLNAME = 32;
  protected static final int BASENAME = 33;
  protected static final int XXCSOQUOTELINESSTOREFULLVO = 34;
  /**
   * 
   ...
   * 参照用見積ヘッダーID設定処理
   * 帳合用見積の構築を行います。
   * @param value 参照用見積ヘッダーID
   *****************************************************************************
   */
  public void setReferenceQuoteHeaderId(Number value)
  {
    XxcsoQuoteStoreRegistAMImpl am
      = (XxcsoQuoteStoreRegistAMImpl)getApplicationModule();
    if ( am == null )
    {
      throw
        XxcsoMessage.createInstanceLostError(
          "XxcsoQuoteStoreRegistAMImpl"
        );
    }

    // 帳合用見積の構築処理
    am.buildQuoteStore(value);
   ...
   *****************************************************************************
   */
  public void setReferenceQuoteHeaderIdNoBuild(Number value)
  {
    setAttributeInternal(REFERENCEQUOTEHEADERID, value);
  }
  ...
  protected Object getAttrInvokeAccessor(int index, AttributeDefImpl attrDef) throws Exception
  {
    switch (index)
      ...
      case PARTYNAME:
        return getPartyName();
      case SALESUNITTYPE:
        return getSalesUnitType();
      case FULLNAME:
        return getFullName();
      case BASENAME:
        return getBaseName();
      case XXCSOQUOTELINESSTOREFULLVO:
        return getXxcsoQuoteLinesStoreFullVO();
      default:
  ...
  /**
   * 
   * Gets the associated <code>RowIterator</code> using master-detail link XxcsoQuoteLinesStoreFullVO
   */
  public oracle.jbo.RowIterator getXxcsoQuoteLinesStoreFullVO()
  {
    return (oracle.jbo.RowIterator)getAttributeInternal(XXCSOQUOTELINESSTOREFULLVO);
  }
  ...
  /**
   * 
   * Gets the attribute value for the calculated attribute SalesUnitType
   */
  public String getSalesUnitType()
  {
    return (String)getAttributeInternal(SALESUNITTYPE);
  }

  /**
   * 
   * Sets <code>value</code> as the attribute value for the calculated attribute SalesUnitType
   */
  public void setSalesUnitType(String value)
  {
    setAttributeInternal(SALESUNITTYPE, value);
  }
