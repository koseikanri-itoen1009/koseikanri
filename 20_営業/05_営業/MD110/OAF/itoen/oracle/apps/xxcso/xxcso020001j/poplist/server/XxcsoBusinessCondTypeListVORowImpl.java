/*============================================================================
* ファイル名 : XxcsoBusinessCondTypeListVORowImpl
* 概要説明   : 業態（小分類）ポップリスト用ビュー行クラス
* バージョン : 1.0
*============================================================================
* 修正履歴
* 日付       Ver. 担当者       修正内容
...
/*******************************************************************************
 * 業態（小分類）に表示するポップリストのビュー行クラスです。
 * @author  SCS小川浩
 * @version 1.0
 *******************************************************************************
 */
public class XxcsoBusinessCondTypeListVORowImpl extends OAViewRowImpl 
{
   ...
   */
  public XxcsoBusinessCondTypeListVORowImpl()
  {
  }
