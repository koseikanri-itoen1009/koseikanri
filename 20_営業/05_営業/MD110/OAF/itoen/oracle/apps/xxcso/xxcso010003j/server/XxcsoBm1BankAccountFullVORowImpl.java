/*============================================================================
* ファイル名 : XxcsoBm1BankAccountFullVORowImpl
* 概要説明   : BM1銀行口座アドオンテーブル情報ビュー行オブジェクトクラス
* バージョン : 1.0
*============================================================================
* 修正履歴
* 日付       Ver. 担当者       修正内容
...
/*******************************************************************************
 * BM1銀行口座アドオンテーブル情報を取得するためのビュー行クラス
 * @author  SCS小川浩
 * @version 1.0
 *******************************************************************************
 */
public class XxcsoBm1BankAccountFullVORowImpl extends OAViewRowImpl 
{
   ...
   */
  public XxcsoBm1BankAccountFullVORowImpl()
  {
  }
