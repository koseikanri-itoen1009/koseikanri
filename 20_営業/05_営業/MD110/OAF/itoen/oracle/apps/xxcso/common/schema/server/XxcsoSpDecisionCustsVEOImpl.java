/*============================================================================
* ファイル名 : XxcsoSpDecisionCustsVEOImpl
* 概要説明   : SP専決顧客エンティティクラス
* バージョン : 1.0
*============================================================================
* 修正履歴
* 日付       Ver. 担当者       修正内容
 ...
 *******************************************************************************
 */
public class XxcsoSpDecisionCustsVEOImpl extends OAPlsqlEntityImpl 
{
  ...
  protected static final int XXCSOSPDECISIONHEADERSVEO = 36;
   ...
   */
  public XxcsoSpDecisionCustsVEOImpl()
  {
  }
  ...
  public static synchronized EntityDefImpl getDefinitionObject()
  {
    ...
    {
      mDefinitionObject = (oracle.apps.fnd.framework.server.OAEntityDefImpl)EntityDefImpl.findDefObject("itoen.oracle.apps.xxcso.common.schema.server.XxcsoSpDecisionCustsVEO");
    }
  ...
  public void create(AttributeList list)
  {
    ...
    // 仮の値を設定します。
    EntityDefImpl custDef = XxcsoSpDecisionCustsVEOImpl.getDefinitionObject();
    Iterator custIt = custDef.getAllEntityInstancesIterator(txn);

    int minValue = 0;
    
    while( custIt.hasNext() )
    {
      XxcsoSpDecisionCustsVEOImpl custEo
        = (XxcsoSpDecisionCustsVEOImpl)custIt.next();
      int spDecisionCustomerId = custEo.getSpDecisionCustomerId().intValue();

      if ( minValue > spDecisionCustomerId )
      {
        minValue = spDecisionCustomerId;
      }
    }
    ...
    setSpDecisionCustomerId(new Number(minValue));
  ...
  public void insertRow()
  {
    ...
    Number spDecisionCustomerId
      = getOADBTransaction().getSequenceValue("XXCSO_SP_DECISION_CUSTS_S01");

    setSpDecisionCustomerId(spDecisionCustomerId);
    ...
    try
    {
      XxcsoCustomDmlExecUtils.insertRow(
        txn
       ,"xxcso_sp_decision_custs"
       ,this
       ,XxcsoSpDecisionCustsVEOImpl.getDefinitionObject()
      );
    }
    catch ( SQLException e )
    {
      ...
      throw XxcsoMessage.createSqlErrorMessage(
        e,
        XxcsoConstants.TOKEN_VALUE_SP_DECISION_CUST +
  ...
  private void replaceNumber()
  {
    ...
    {
      setEmployeeNumber(getEmployeeNumber().replaceAll(",",""));
    }
  }
