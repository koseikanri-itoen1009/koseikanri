...
-- Description   : HHT-EBSインターフェース：(IN)売上計画（SQL-LOADER-売上計画）
-- MD.050        : MD050_IPO_CSO_014_A01_HHT-EBSインターフェース：(IN)売上計画(SQL-LOADER-売上計画)
-- MD.070        : なし
-- Version       : 1.0
--
...
FIELDS TERMINATED BY "," TRAILING NULLCOLS
  (
    NO_SEQ                  INTEGER EXTERNAL "XXCSO_IN_SALES_PLAN_MONTH_S01.NEXTVAL",   -- シーケンス番号
    ...
    SALES_PLAN_MONTH        POSITION(*) INTEGER EXTERNAL "TO_CHAR(TO_DATE(:SALES_PLAN_MONTH,'YYYYMM'),'YYYYMM')" , -- 売上計画年月
