CREATE OR REPLACE PACKAGE BODY XXCCP009A07C
AS
/*****************************************************************************************
 * Copyright(c)SCSK Corporation, 2011. All rights reserved.
 *
 * Package Name     : XXCCP009A07C(body)
...
--
  ...
  -- ユーザー定義グローバル定数
  -- ===============================
  cv_pkg_name      CONSTANT VARCHAR2(100) := 'XXCCP009A07C'; -- パッケージ名
--
  -- ===============================
  -- ユーザー定義グローバル型
  -- ===============================
...
--
    ...
    fnd_file.put_line(
      ...
      ,buff   => '"会計期間","勘定科目","勘定科目名","期首借方","期首貸方","期首残","期中借方","期中貸方","期中残","期末残"'
    );
    -- データ部出力(CSV)
    FOR jg_balance_rec IN jg_balance_cur
     LOOP
       ...
       FND_FILE.PUT_LINE(
          which  => FND_FILE.OUTPUT
         ,buff   => '"'|| jg_balance_rec.period_name                 || '","'
