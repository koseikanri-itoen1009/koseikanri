 ...
 *  2009/02/10    1.01  SCS 嶋田         ログの出力先が誤っていた箇所を修正
 *  2009/02/18    1.02  SCS 嶋田         証書受領の処理時、すでに証書受領済のレコードに
 *                                       関しては処理を行わない様にチェックを追加する
 *  2009/02/19    1.03  SCS 嶋田         顧客コードを追加
 *  2009/02/23    1.04  SCS 嶋田         契約ステータスが204:満了の際の対応を追加
 *
 *****************************************************************************************/
--
--#######################  固定グローバル定数宣言部 START   #######################
