...
-- 2014-08-06 S.Yamashita Add Start --
    cash_price               xxcff_vd_object_info_upload_wk.cash_price%TYPE,             -- 購入価格
...
--     ,g_load_data_tab(18)       -- 再リース料
     ,g_load_data_tab(18)       -- 購入価格
     ,g_load_data_tab(19)       -- 取得日
     ,g_load_data_tab(20)       -- 移動日
     ,g_load_data_tab(21)       -- 設置先
     ,g_load_data_tab(22)       -- 設置場所
     ,g_load_data_tab(23)       -- 申告地
     ,g_load_data_tab(24)       -- 事業所
     ,g_load_data_tab(25)       -- 除･売却日
     ,g_load_data_tab(26)       -- 売却価額
     ,g_load_data_tab(27)       -- 撤去費用
     ,g_load_data_tab(28)       -- 除売却確定フラグ
...
-- 2014-08-06 S.Yamashita Add Start --
             ,xvoiu.cash_price              AS cash_price            -- 購入価格
-- 2014-08-06 S.Yamashita Add End --
...
-- 2014-08-06 S.Yamashita Add Start --
             ,xvoh.cash_price               AS xvoh_cash_price             -- 購入価格(物件管理)
-- 2014-08-06 S.Yamashita Add End --
...
-- 2014-08-06 S.Yamashita Add Start --
    lv_nvl_cash_price              xxcff_vd_object_info_upload_wk.cash_price%TYPE;             -- 購入価格
-- 2014-08-06 S.Yamashita Add End --
...
-- 2014-08-06 S.Yamashita Add Start --
        lv_nvl_cash_price             := g_vd_object_tab(in_rec_no).xvoh_cash_price;                    -- 購入価格
-- 2014-08-06 S.Yamashita Add End --
