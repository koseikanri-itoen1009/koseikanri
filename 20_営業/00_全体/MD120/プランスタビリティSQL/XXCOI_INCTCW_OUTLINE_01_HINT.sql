CREATE OR REPLACE PRIVATE OUTLINE XXPT_INCTCW_OUTLINE_02
ON
SELECT /*+ use_nl(X SUB) INDEX(MTL_SECONDARY_INVENTORIES_U1) */
...
FROM
 ( SELECT X.ORGANIZATION_ID ORGANIZATION_ID , X.INVENTORY_ITEM_ID 
  ...
  NVL(MR.DEMAND_SOURCE_DELIVERY,-9999) ) )) UNION ALL SELECT 
