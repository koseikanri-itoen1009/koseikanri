        ...
        ELSE
          ...
          ELSE
            ...
            IF (lv_skip_flg = '1') THEN
              --========================================
              -- 処理区分が「新規登録」、「更新」の場合で、禁則文字が存在した場合
              -- スキップ件数のカウント
              --========================================
              gn_warn_cnt := gn_warn_cnt + 1;
            ELSE
              --========================================
              -- 処理区分が「新規登録」、「更新」の場合で、禁則文字が存在しなかった場合
              -- CSVファイル出力(A-4)
              -- 自販機差分連携用社員データ更新(A-5)
              --  (連携フラグには1:連携ありをセット)
              -- 差分連携用日付更新(アサインメントマスタ)(A-6)
