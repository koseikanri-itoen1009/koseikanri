...
-- 2016/11/25 E_本稼動_09591 add start by K.Kiriu
        ,iimb.attribute19                  AS freshness_condition           -- 鮮度条件
-- 2016/11/25 E_本稼動_09591 add end by K.Kiriu
-- 2018/10/23 E_本稼動_15277 add start by Y.Shoji
        ,ximb.lot_reversal_type            AS lot_reversal_type             -- ロット逆転区分
-- 2018/10/23 E_本稼動_15277 add end by Y.Shoji
-- 2019/6/4 E_本稼動_15472 add start by N.Abe
        ,xsib.class_for_variable_tax       AS food_type_code                -- 食品区分
-- 2019/6/4 E_本稼動_15472 add end by N.Abe
-- 2019/07/02 E_本稼動_15625 add start by N.Abe
        ,xsib.item_dtl_status              AS item_dtl_status               -- 品目詳細ステータス
        ,CASE WHEN xsib.item_dtl_status IS NULL THEN NULL
              ELSE xsib.item_dtl_status || ':' || hss.item_dtl_status_name
              END                          AS item_dtl_status_name          -- 品目詳細ステータス名
        ,xsib.remarks                      AS remarks                       -- 備考
-- 2019/07/02 E_本稼動_15625 add end   by N.Abe
...
/
-- 2018/10/23 E_本稼動_15277 add start by Y.Shoji
COMMENT ON COLUMN APPS.XXCMM_ITEM_SCREEN_V.lot_reversal_type IS 'ロット逆転区分'
/
-- 2018/10/23 E_本稼動_15277 add end by Y.Shoji
-- 2019/6/4 E_本稼動_15472 add start by N.Abe
COMMENT ON COLUMN APPS.XXCMM_ITEM_SCREEN_V.food_type_code IS '食品区分'
/
-- 2019/6/4 E_本稼動_15472 add end by N.Abe
-- 2019/07/02 E_本稼動_15625 add start by N.Abe
COMMENT ON COLUMN APPS.XXCMM_ITEM_SCREEN_V.item_dtl_status IS '品目詳細ステータス'
/
COMMENT ON COLUMN APPS.XXCMM_ITEM_SCREEN_V.item_dtl_status_name IS '品目詳細ステータス名'
/
COMMENT ON COLUMN APPS.XXCMM_ITEM_SCREEN_V.remarks IS '備考'
/
-- 2019/07/02 E_本稼動_15625 add end   by N.Abe
