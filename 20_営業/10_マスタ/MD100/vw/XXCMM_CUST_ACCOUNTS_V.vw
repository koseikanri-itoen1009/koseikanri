...
-- 2014/11/21 [E_本稼動_12237]倉庫管理システム対応 mod start by Yasunari.Nagasue
...
-- 2017/04/05 [E_本稼動_13976]eSM外部データ連携対応 mod start by S.Yamashita
...
-- 2017/06/14 [E_本稼動_14271]mod start
...
AS
-- 2017/06/14 [E_本稼動_14271]mod end
-- 2017/04/05 [E_本稼動_13976]eSM外部データ連携対応 mod end by S.Yamashita
...
-- 2014/11/21 [E_本稼動_12237]倉庫管理システム対応 mod end   by Yasunari.Nagasue
-- 2017/04/05 [E_本稼動_13976]eSM外部データ連携対応 add start by S.Yamashita
       xca.esm_target_div esm_target_div,
-- 2017/04/05 [E_本稼動_13976]eSM外部データ連携対応 add end by S.Yamashita
-- 2017/06/14 [E_本稼動_14271]add start
...
/
-- 2021/05/31 [E_本稼動_16026]mod start
--COMMENT ON COLUMN apps.xxcmm_cust_accounts_v.intro_chain_code2 IS '紹介者チェーンコード２'
COMMENT ON COLUMN apps.xxcmm_cust_accounts_v.intro_chain_code2 IS '控除用チェーンコード'
-- 2021/05/31 [E_本稼動_16026]mod end
/
...
-- 2010/09/22 障害E_本稼動_02021 add end by Shigeto.Niki
-- 2014/11/21 [E_本稼動_12237]倉庫管理システム対応 mod start by Yasunari.Nagasue
COMMENT ON COLUMN apps.xxcmm_cust_accounts_v.cust_fresh_con_code IS '顧客別鮮度条件コード'
/
-- 2014/11/21 [E_本稼動_12237]倉庫管理システム対応 mod end   by Yasunari.Nagasue
-- 2017/04/05 [E_本稼動_13976]eSM外部データ連携対応 add start by S.Yamashita
COMMENT ON COLUMN apps.xxcmm_cust_accounts_v.esm_target_div IS 'ストレポ＆商談くん連携対象フラグ'
/
-- 2017/04/05 [E_本稼動_13976]eSM外部データ連携対応 add end by S.Yamashita
-- 2017/06/14 [E_本稼動_14271]add start
COMMENT ON COLUMN apps.xxcmm_cust_accounts_v.offset_cust_div IS '相殺用顧客区分'
/
COMMENT ON COLUMN apps.xxcmm_cust_accounts_v.offset_cust_code IS '相殺用顧客コード'
/
