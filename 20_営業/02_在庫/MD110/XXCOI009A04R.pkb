 ...
 *  2017/12/28    1.12  Y.Shoji          [E_本稼動_14486]レコード種別'22'（商品入替）追加対応
 *
 *****************************************************************************************/
--
--#######################  固定グローバル定数宣言部 START   #######################
...
-- == 2017/12/28 V1.12 Added START ===============================================================
    cv_record_type_22             CONSTANT VARCHAR2(2)  :=  '22';
-- == 2017/12/28 V1.12 Added END =================================================================
--
    -- 参照タイプ
-- == 2009/06/19 V1.4 Modified START ===============================================================
...
-- == 2015/04/16 V1.11 Modified END   ==============================================================
      ...
      AND     xhit.record_type                          =   flv.attribute1
-- == 2011/04/08 V1.10 Added START ===============================================================
-- == 2017/12/28 V1.12 MOD START ===============================================================
--      AND     xhit.record_type                          <>  cv_record_type_21
      AND     xhit.record_type                          NOT IN (cv_record_type_21 ,cv_record_type_22)
-- == 2017/12/28 V1.12 MOD END ===============================================================
-- == 2011/04/08 V1.10 Added END =================================================================
      AND     xhit.invoice_type                         =   flv.attribute2
      AND     NVL(xhit.department_flag, cv_99)          =   flv.attribute3
      AND     flv.lookup_type                           =   cv_invoice_type
