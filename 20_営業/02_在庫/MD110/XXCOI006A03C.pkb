...
--
  ...
  cv_exec_2             CONSTANT VARCHAR2(1)  :=  '2';        -- 起動フラグ：月次夜間強制確定
...
-- == 2009/04/27 V1.7 Added END   ===============================================================
  ...
  IS
    SELECT  xid.inventory_seq           xir_inv_seq                 -- 棚卸SEQ
           ...
           ,MAX(xir.warehouse_kbn)      warehouse_kbn               -- 倉庫区分
    ...
    FROM    xxcoi_inv_result              xir                       -- HHT棚卸結果テーブル
           ...
           ,(SELECT  MAX(xir.inventory_seq)      inventory_seq
                    ...
                    ,xir.base_code               base_code                   -- 拠点コード
                    ,xir.inventory_place         inventory_place             -- 棚卸場所
             FROM    xxcoi_inv_result              xir                       -- HHT棚卸結果テーブル
                    ,xxcoi_inv_control             xic                       -- 棚卸管理テーブル
