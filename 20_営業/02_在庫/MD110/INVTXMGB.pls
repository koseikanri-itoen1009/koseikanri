...
/* $Header: INVTXMGB.pls 115.107.115100.13 2006/02/24 10:42:56 amohamme ship $ */
...
BEGIN
    ...
    IF (l_debug = 1) THEN
       inv_log_util.trace('$Header: INVTXMGB.pls 115.107.115100.13 2006/02/24 10:42:56 amohamme ship $',l_procedure_name, 9);
    END IF;
