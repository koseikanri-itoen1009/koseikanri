CREATE OR REPLACE PACKAGE BODY XXCFR003A07C AS
/*************************************************************************
 ...
 *  2009-09-28    1.1  SCS 萱原 伸哉 AR仕様変更IE535対応
 *  2010-01-29    1.2  SCS 安川 智博 障害「E_本稼動_01503」対応
 *  2023-05-17    1.3  SCSK Y.Koh     E_本稼動_19168【AR】インボイス対応_イセトー、汎用請求書、請求金額一覧
 *  2023-12-19    1.4  SCSK Y.Ryu     E_本稼動_19496対応
 ************************************************************************/
...
--
  ...
  cv_pkg_name        CONSTANT VARCHAR2(100) := 'XXCFR003A07C';  -- パッケージ名
...
--                    xil.sold_location_code,
--                    xil.sold_location_name,
--                    xil.ship_cust_code,
--                    xil.ship_cust_name,
--                    xih.bill_shop_code,
--                    xih.bill_shop_name,
                    ...
                    g_ship_cust_tab(i).receipt_cust_code,        -- 入金先顧客コード
                    g_ship_cust_tab(i).receipt_cust_name,        -- 入金先顧客名
...
-- Modify 2009/09/28 Ver1.1 End   ----------------------------------------------                    
                    ...
                    TO_CHAR(xil.delivery_date,'YYYY/MM/DD'),
-- Modify 2009/09/28 Ver1.1 Start   ----------------------------------------------
--                    DECODE(xil.vd_cust_type,
--                           cv_is_not_vd,
--                           xil.slip_num,
