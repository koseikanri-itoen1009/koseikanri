 ...
 * ---------------------- ----------------------------------------------------------
 *  init                        初期処理(A-1)
 *  lock_plan_result            商品計画明細テーブル既存データロック(A-12)
 *  delete_plan_result          商品計画明細テーブル既存データ削除(A-12)
 *  insert_plan_result          データ登録(A-12)
 *  year_data_select            仮データ作成(対象年度の年間実績抽出)(A-8)
 *  obj_month_data_select       仮データ作成(対象月のデータ抽出)(A-8)
 *  temp_2months_data           仮データ作成(直近2ヶ月分データを使う場合)(A-8)
 *  temp_data_make              仮データ作成(A-8)
 *  sales_result_select         販売実績抽出処理(A-2)
 *  submain                     メイン処理プロシージャ
...
--
  ...
  PROCEDURE insert_plan_result(
    ...
    ,iv_item_group_no          IN  VARCHAR2                     -- 商品群コー
...
--
    -- 登録処理
      ...
      VALUES(
        ...
        ,cn_request_id                            -- 要求ID
        ,cn_program_application_id                -- コンカレント・プログラム・アプリケ
...
--
   ...
   * Description      : 仮データ作成(対象年度の年間実績抽出)(A-8)
   ***********************************************************************************/
...
--
   ...
   * Description      : 仮データ作成(対象月のデータ抽出)(A-8)
   ***********************************************************************************/
...
--
   ...
   * Description      : 仮データ作成(直近2ヶ月分のデータを使う場合)(A-8)
   ***********************************************************************************/
