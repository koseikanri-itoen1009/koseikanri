...
--                             , iv_token_value4 => '粗利額指定 粗利率算出 > 粗利額(千円)='||TO_CHAR(on_amount_gross_margin / 1000)||' 売上(千円)='||TO_CHAR(ln_sales_budget / 1000)||' エラー内容='||SQLERRM
                             , iv_token_value4 => '粗利額指定 粗利率算出 > 粗利額(千円)='||TO_CHAR(on_amount_gross_margin / 1000)||' 売上(千円)='||TO_CHAR(on_sales_budget / 1000)||' エラー内容='||SQLERRM
-- Ver.1.1 SCSK K.Nara MOD END
                           );
              fnd_file.put_line(
                 which  => FND_FILE.OUTPUT
...
--                             , iv_token_value4 => '粗利額指定 1本当たりの売値算出 > 売上(千円)='||TO_CHAR(ln_sales_budget / 1000)||' 粗利額(千円)='||TO_CHAR(on_amount_gross_margin / 1000)||' 営業原価='||TO_CHAR(in_discrete_cost)||' エラー内容='||SQLERRM
                             , iv_token_value4 => '粗利額指定 1本当たりの売値算出 > 売上(千円)='||TO_CHAR(on_sales_budget / 1000)||' 粗利額(千円)='||TO_CHAR(on_amount_gross_margin / 1000)||' 営業原価='||TO_CHAR(in_discrete_cost)||' エラー内容='||SQLERRM
-- Ver.1.1 SCSK K.Nara MOD END
                           );
              fnd_file.put_line(
                 which  => FND_FILE.OUTPUT
...
--                             , iv_token_value4 => '粗利額指定 数量算出 > 売上(千円)='||TO_CHAR(ln_sales_budget / 1000)||' 1本当たりの売値='||TO_CHAR(ln_sales_bdgt_per1)||' エラー内容='||SQLERRM
                             , iv_token_value4 => '粗利額指定 数量算出 > 売上(千円)='||TO_CHAR(on_sales_budget / 1000)||' 1本当たりの売値='||TO_CHAR(ln_sales_bdgt_per1)||' エラー内容='||SQLERRM
-- Ver.1.1 SCSK K.Nara MOD END
                           );
              fnd_file.put_line(
                 which  => FND_FILE.OUTPUT
...
--                           , iv_token_value4 => '粗利率指定 粗利額算出 > 売上(千円)='||TO_CHAR(ln_sales_budget / 1000)||' 粗利率='||TO_CHAR(in_margin_rate)||' エラー内容='||SQLERRM
                           , iv_token_value4 => '粗利率指定 粗利額算出 > 売上(千円)='||TO_CHAR(on_sales_budget / 1000)||' 粗利率='||TO_CHAR(in_margin_rate)||' エラー内容='||SQLERRM
-- Ver.1.1 SCSK K.Nara MOD END
                         );
            fnd_file.put_line(
               which  => FND_FILE.OUTPUT
...
--                           , iv_token_value4 => '粗利率指定 1本当たりの売値算出 > 売上(千円)='||TO_CHAR(ln_sales_budget / 1000)||' 粗利額(千円)='||TO_CHAR(on_amount_gross_margin / 1000)||' 営業原価='||TO_CHAR(in_discrete_cost)||' エラー内容='||SQLERRM
                           , iv_token_value4 => '粗利率指定 1本当たりの売値算出 > 売上(千円)='||TO_CHAR(on_sales_budget / 1000)||' 粗利額(千円)='||TO_CHAR(on_amount_gross_margin / 1000)||' 営業原価='||TO_CHAR(in_discrete_cost)||' エラー内容='||SQLERRM
-- Ver.1.1 SCSK K.Nara MOD END
                         );
            fnd_file.put_line(
               which  => FND_FILE.OUTPUT
...
--                             , iv_token_value4 => '粗利率指定 数量算出 > 売上(千円)='||TO_CHAR(ln_sales_budget / 1000)||' 1本当たりの売値='||TO_CHAR(ln_sales_bdgt_per1)||' エラー内容='||SQLERRM
                             , iv_token_value4 => '粗利率指定 数量算出 > 売上(千円)='||TO_CHAR(on_sales_budget / 1000)||' 1本当たりの売値='||TO_CHAR(ln_sales_bdgt_per1)||' エラー内容='||SQLERRM
-- Ver.1.1 SCSK K.Nara MOD END
                           );
              fnd_file.put_line(
                 which  => FND_FILE.OUTPUT
...
--                           , iv_token_value4 => '掛率指定 数量算出 > 売上(千円)='||TO_CHAR(ln_sales_budget / 1000)||' 1本当たりの売値='||TO_CHAR(ln_sales_bdgt_per1)||' エラー内容='||SQLERRM
                           , iv_token_value4 => '掛率指定 数量算出 > 売上(千円)='||TO_CHAR(on_sales_budget / 1000)||' 1本当たりの売値='||TO_CHAR(ln_sales_bdgt_per1)||' エラー内容='||SQLERRM
-- Ver.1.1 SCSK K.Nara MOD END
                         );
            fnd_file.put_line(
               which  => FND_FILE.OUTPUT
...
--                           , iv_token_value4 => '掛率指定 粗利率算出 > 粗利額(千円)='||TO_CHAR(on_amount_gross_margin / 1000)||' 売上(千円)='||TO_CHAR(ln_sales_budget / 1000)||' エラー内容='||SQLERRM
                           , iv_token_value4 => '掛率指定 粗利率算出 > 粗利額(千円)='||TO_CHAR(on_amount_gross_margin / 1000)||' 売上(千円)='||TO_CHAR(on_sales_budget / 1000)||' エラー内容='||SQLERRM
-- Ver.1.1 SCSK K.Nara MOD END
                         );
            fnd_file.put_line(
               which  => FND_FILE.OUTPUT
...
-- Ver.1.1 SCSK K.Nara ADD START
           ,on_sales_budget        => g_item_line_tab(ln_item_line_cnt).sales_budget        -- 算出結果_売上(単位：円)
-- Ver.1.1 SCSK K.Nara ADD END
