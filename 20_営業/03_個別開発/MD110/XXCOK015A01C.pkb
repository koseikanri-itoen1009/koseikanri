...
-- Start 2009/07/10 Ver_1.5 0000498 M.Hiruta ADD
  cv_chain_code              CONSTANT VARCHAR2(4)     := 'BM01'; -- チェーン店コード
-- End   2009/07/10 Ver_1.5 0000498 M.Hiruta ADD
  -- ===============================================
  -- グローバル変数
  -- ===============================================
...
-- Start 2009/07/10 Ver_1.5 0000498 M.Hiruta REPAIR
--      , iv_chain_code      => cv_space        -- チェーン店コード
      , iv_chain_code      => cv_chain_code   -- チェーン店コード
-- End   2009/07/10 Ver_1.5 0000498 M.Hiruta REPAIR
...
-- 2009/08/24 Ver.1.7 [障害0001160] SCS T.Taniguchi START
--    lv_cust_name2        :=  RPAD( SUBSTRB( NVL( it_bm_data_rec.vendor_name, cv_space ), 31, 30 ), 30, cv_space ); -- 顧客名２
    lv_cust_name2        :=  RPAD( NVL( SUBSTRB( it_bm_data_rec.vendor_name, 31, 30 ), cv_space ), 30, cv_space ); -- 顧客名２
-- 2009/08/24 Ver.1.7 [障害0001160] SCS T.Taniguchi END
...
--    lv_atena2            :=  RPAD( SUBSTRB( NVL( it_bm_data_rec.vendor_name, cv_space ), 31, 30 ), 30, cv_space ); -- 宛名２
    lv_atena2            :=  RPAD( NVL( SUBSTRB( it_bm_data_rec.vendor_name, 31, 30 ), cv_space ), 30, cv_space ); -- 宛名２
-- 2009/08/24 Ver.1.7 [障害0001160] SCS T.Taniguchi END
-- 2009/07/15 Ver.1.6 [障害0000688] SCS K.Yamaguchi REPAIR END
