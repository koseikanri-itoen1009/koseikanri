CREATE OR REPLACE PACKAGE BODY XXCOK015A03R3
AS
/*****************************************************************************************
 * Copyright(c)Sumisho Computer Systems Corporation, 2008. All rights reserved.
 *
 * Package Name     : XXCOK015A03R3(body)
 ...
 *  2022/07/29    2.0   K.Kanada         [障害E_本稼動_18463]性能問題のため一括発行する事務センター用と単独発行する拠点用で分ける
 *
 *****************************************************************************************/
  --==================================================
  -- グローバル定数
...
--  cv_pkg_name                      CONSTANT VARCHAR2(20)    := 'XXCOK015A03R';
  cv_pkg_name                      CONSTANT VARCHAR2(20)    := 'XXCOK015A03R3';
...
-- Ver.2.0 K.Kanada Add S
      AND 1=1   -- 実行ユーザの所属部門が事務センタ
-- Ver.2.0 K.Kanada Add E
