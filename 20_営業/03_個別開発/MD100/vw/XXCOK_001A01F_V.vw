 ...
 *  2020/12/21    1.3   R.Oikawa         [E_本稼動_16834]対応
 *
 **************************************************************************************/
...
-- 2020/12/07 Ver.1.3 [E_本稼動_16834] SCSK R.Oikawa REPAIR START
 ,resv_selling_clr_flag
 ,base_split_flag
-- 2020/12/07 Ver.1.3 [E_本稼動_16834] SCSK R.Oikawa REPAIR END
 ,created_by
 ,creation_date
 ,last_updated_by
 ,last_update_date
...
-- 2011/02/03 Ver.1.1 [E_本稼動_02010,06187] SCS M.Hirose REPAIR END
-- 2020/12/07 Ver.1.3 [E_本稼動_16834] SCSK R.Oikawa REPAIR START
COMMENT ON COLUMN apps.xxcok_001a01f_v.resv_selling_clr_flag     IS '予約売上消去フラグ'
/
COMMENT ON COLUMN apps.xxcok_001a01f_v.base_split_flag           IS '拠点分割情報連携フラグ'
/
-- 2020/12/07 Ver.1.3 [E_本稼動_16834] SCSK R.Oikawa REPAIR END
