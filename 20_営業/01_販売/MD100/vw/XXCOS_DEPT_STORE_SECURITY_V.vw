...
;
COMMENT ON  COLUMN  xxcos_dept_store_security_v.user_id          IS  'ユーザID';
COMMENT ON  COLUMN  xxcos_dept_store_security_v.user_name        IS  'ユーザ名称';
COMMENT ON  COLUMN  xxcos_dept_store_security_v.account_number   IS  '顧客コード';
