...
;
--
COMMENT ON COLUMN xxcos_good_prod_class_v.inventory_item_id       IS '品目ID' ;
COMMENT ON COLUMN xxcos_good_prod_class_v.segment1                IS '品目コード' ;
COMMENT ON COLUMN xxcos_good_prod_class_v.goods_prod_class_code   IS '商品製品区分コード' ;
COMMENT ON COLUMN xxcos_good_prod_class_v.goods_prod_class_name   IS '商品製品区分名' ;
--
COMMENT ON TABLE  xxcos_good_prod_class_v                         IS '商品製品区分ビュー' ;
/
