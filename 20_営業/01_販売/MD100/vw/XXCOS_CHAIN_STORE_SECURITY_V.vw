...
;
COMMENT ON  COLUMN  xxcos_chain_store_security_v.user_id          IS  'ユーザID';
COMMENT ON  COLUMN  xxcos_chain_store_security_v.user_name        IS  'ユーザ名称';
COMMENT ON  COLUMN  xxcos_chain_store_security_v.account_number   IS  '顧客コード';
COMMENT ON  COLUMN  xxcos_chain_store_security_v.chain_code       IS  'チェーン店コード';
COMMENT ON  COLUMN  xxcos_chain_store_security_v.chain_store_code IS  '店舗コード';
COMMENT ON  COLUMN  xxcos_chain_store_security_v.chain_store_name IS  '店舗名称';
/* 2009/05/07 Ver1.1 Add Start */
COMMENT ON  COLUMN  xxcos_chain_store_security_v.status           IS  'ステータス';
/* 2009/05/07 Ver1.1 Add End   */
--
COMMENT ON  TABLE   xxcos_chain_store_security_v                  IS  '店舗(チェーン店)セキュリティビュー';
