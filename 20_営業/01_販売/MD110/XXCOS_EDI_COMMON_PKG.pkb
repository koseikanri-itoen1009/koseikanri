...
/* 2010/07/13 Ver1.10 Add Start */
              ,iv_boot_flag                IN VARCHAR2  DEFAULT NULL  -- 婲摦庬暿(1:僐儞僇儗儞僩丄2:夋柺)
              ,ov_err_flag                 OUT NOCOPY VARCHAR2        -- 僄儔乕庬暿
...
/* 2010/07/13 Ver1.10 Add Start */
    cv_msg_cust_item_err    CONSTANT VARCHAR2(20) := 'APP-XXCOS1-13597';  --屭媞昳栚僠僃僢僋僄儔乕
/* 2010/07/13 Ver1.10 Add End */
    --僩乕僋儞
...
/* 2012/08/24 Ver1.11 Add Start */
    cv_tkn_invoice_number   CONSTANT VARCHAR2(14) := 'INVOICE_NUMBER';    -- 揱昜斣崋
...
/* 2010/07/13 Ver1.10 Add Start */
    cv_flag_0               CONSTANT VARCHAR2(1)  := '0';       -- 0:弶婜抣
    cv_flag_1               CONSTANT VARCHAR2(1)  := '1';       -- 1:枹搊榐
    cv_flag_2               CONSTANT VARCHAR2(1)  := '2';       -- 2:暋悢審搊榐
    cv_flag_3               CONSTANT VARCHAR2(1)  := '3';       -- 3:椉曽
    cv_boot_flag_conc       CONSTANT VARCHAR2(1)  := '1';       -- 1:僐儞僇儗儞僩婲摦
    cv_boot_flag_form       CONSTANT VARCHAR2(1)  := '2';       -- 2:夋柺婲摦
/* 2010/07/13 Ver1.10 Add End */
/* 2012/08/24 Ver1.11 Add Start */
    cv_invoice_number       CONSTANT VARCHAR2(16) := ' 丄揱昜僐乕僪丗 '; -- 屌掕抣:揱昜僐乕僪丗(昳栚椺奜僄儔乕儊僢僙乕僕梡)
    cv_message_end          CONSTANT VARCHAR2(2)  := ' )';               -- 屌掕抣:)(昳栚椺奜僄儔乕儊僢僙乕僕梡)
/* 2012/08/24 Ver1.11 Add End */
/* 2009/08/11 Ver1.7 Add Start */
    --僾儘僼傽僀儖柤徧
...
/* 2010/07/13 Ver1.10 Add Start */
    lv_err_flag          VARCHAR2(1);      -- 僄儔乕庬暿(1:枹搊榐丄2:暋悢審搊榐丄3:椉曽)
    lv_err_flag_tmp      VARCHAR2(1);      -- 僄儔乕庬暿tmp
/* 2010/07/13 Ver1.10 Add End */
...
/* 2010/07/13 Ver1.10 Add Start */
    lv_ret_warn          VARCHAR2(1);      -- 儕僞乕儞丒僐乕僪:寈崘
    lv_ret_error         VARCHAR2(1);      -- 儕僞乕儞丒僐乕僪:僄儔乕
    lv_warn_flag         VARCHAR2(1);      -- 寈崘僼儔僌
/* 2010/07/13 Ver1.10 Add End */
/* 2009/08/11 Ver1.7 Add Start */
...
/* 2009/08/11 Ver1.7 Add End   */
/* 2010/07/13 Ver1.10 Add Start */
    conv_err_expt      EXCEPTION;  -- 昳栚曄姺偺椺奜
/* 2010/07/13 Ver1.10 Add End   */
--
...
/* 2010/07/13 Ver1.10 Add Start */
    lv_ret_warn    := xxccp_common_pkg.set_status_warn;    -- 儕僞乕儞僐乕僪:寈崘
    lv_ret_error   := xxccp_common_pkg.set_status_error;   -- 儕僞乕儞僐乕僪:僄儔乕
/* 2010/07/13 Ver1.10 Add End */
/* 2009/08/11 Ver1.7 Add Start */
...
/* 2010/07/13 Ver1.10 Add Start */
                 , lv_err_flag                                  -- 僄儔乕庬暿(1:枹搊榐丄2:暋悢審搊榐丄3:椉曽)
/* 2010/07/13 Ver1.10 Add End */
