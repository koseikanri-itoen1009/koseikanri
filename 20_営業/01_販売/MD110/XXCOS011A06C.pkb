...
-- ADD DATE:2011/02/08 AUTHOR:OUKOU VER：1.12 CONTENT:E_本稼動_05917 START
      --伊藤忠、国分、菱食、トーカン、スマイル以外
      ELSE
        lv_whse_directly_class  := NULL;
-- ADD DATE:2011/02/08 AUTHOR:OUKOU VER：1.12 CONTENT:E_本稼動_05917 END
      END IF;
--************************************* 2009/05/28 T.Tominaga Var1.4 ADD START ******************************************
      --------------------------
      --行Ｎｏの編集
