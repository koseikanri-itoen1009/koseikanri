...
-- **************** 2009/12/29 1.21 N.Maeda ADD START ********************* --
    -- 配送LTが0の場合
      IF ( ln_delivery_lt = cn_lead_time_non ) THEN
        -- 稼働日日付       = 出荷予定日
        ld_oprtn_day := it_order_rec.request_date;
      ELSE
        -- ===============================
        -- 翌稼動日取得
        -- ===============================
...
--****************************** 2009/11/22 1.15 S.Miyakoshi MOD  END  ******************************--
      ...
      --
      -- 売上対象区分チェック
-- ****************** 2009/12/14 1.20 N.Maeda MOD START ******************** --
...
----****************************** 2009/11/22 1.15 S.Miyakoshi ADD  END  ******************************--
      IF ( it_order_rec.parent_item_code = it_order_rec.child_code ) THEN
-- ****************** 2009/12/14 1.20 N.Maeda MOD  END  ******************** --
