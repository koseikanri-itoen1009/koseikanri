...
-- 2012/08/02 Ver.1.23 T.Osawa Add Start
    gt_edi_errors(ln_idx).shop_name_alt                := SUBSTRB(it_edi_work.shop_name_alt, 1, 20);     -- 店舗名称（カナ）
-- 2012/08/02 Ver.1.23 T.Osawa Add End
