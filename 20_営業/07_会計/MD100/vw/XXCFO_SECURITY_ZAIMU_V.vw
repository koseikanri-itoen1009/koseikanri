CREATE OR REPLACE FORCE VIEW XXCFO_SECURITY_ZAIMU_V(
/*************************************************************************
 * 
 * View Name       : XXCFO_SECURITY_ZAIMU_V
 * Description     : 財務経理ビュー
 * MD.050          : 
 * MD.070          : 
 * Version         : 1.0
 ...
 ************************************************************************/
  ...
  SELECT flv.lookup_code lookup_code    -- ルックアップコード
   ...
   WHERE flv.lookup_type = 'XXCFO1_SECURITY_ZAIMU'                                  -- クイックコード.ルックアップタイプ = 'XXCFO1_SECURITY_ZAIMU'（セキュリティ財務経理部門）
