...
-- 2008/07/30 v1.6 Start
     -- 入力されている場合
     IF (gt_takeback_class_tbl(gn_i) IS NOT NULL) THEN
-- 2008/07/30 v1.6 End
      --カウント変数初期化
      ln_cnt := 0; 
--
...
-- 2008/07/30 v1.6 Start
     -- 入力されている場合
     IF (gt_producted_item_code_tbl(gn_i) IS NOT NULL) THEN
-- 2008/07/30 v1.6 End
      BEGIN
-- 2008/10/31 H.Itou Mod Start 統合テスト指摘528
--        SELECT  ximv.item_id                  -- 品目ID
        SELECT  ximv.inventory_item_id          -- INV品目ID
-- 2008/10/31 H.Itou Mod End
