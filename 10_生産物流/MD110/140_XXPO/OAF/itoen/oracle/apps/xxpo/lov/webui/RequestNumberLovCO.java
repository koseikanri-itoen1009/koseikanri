 ...
 ***************************************************************************
 */
public class RequestNumberLovCO extends OAControllerImpl
{
...
// 20080528 yoshimoto add End
    ...
    if (XxpoConstants.PEOPLE_CODE_O.equals(peopleCode))
    {
      ...
      // 発注NoVOを取得
      OAViewObject requestNumberVO = (OAViewObject)am.findViewObject("RequestNumberVO1");

      // 初期化
      requestNumberVO.setWhereClause(null);       // clean up from previous invokation
      requestNumberVO.setWhereClauseParams(null); // clean up from previous invokation.
...
// 20080516 yoshimoto mod End
      ...
      requestNumberVO.setWhereClause(whereClause.toString());
