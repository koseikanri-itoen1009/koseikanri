  ...
  public void processFormRequest(OAPageContext pageContext, OAWebBean webBean)
  {
    try
    {
      ...
      } else if ("deleteRow".equals(pageContext.getParameter(EVENT_PARAM)))
      {
          ...
          // 明細番号取得
          String orderLineNumber = pageContext.getParameter("ORDER_LINE_NUMBER");
      ...
      {
        // 起動タイプ取得
        exeType = pageContext.getParameter(XxpoConstants.URL_PARAM_EXE_TYPE);
        // 明細番号取得
      ...
      } else if (pageContext.getParameter("Back") != null) 
      {
        ...
        pageParams.put(XxpoConstants.URL_PARAM_EXE_TYPE, exeType);
        pageParams.put(XxpoConstants.URL_PARAM_REQ_NO,   reqNo);
        pageParams.put(XxpoConstants.URL_PARAM_PREV_URL, XxpoConstants.URL_XXPO440001JL);
      ...
      // 仮引当アイコンが選択された場合
      } else if ("ReserveIcon".equals(pageContext.getParameter(EVENT_PARAM)))
      {
        // 【共通処理】トランザクション終了
        TransactionUnitHelper.endTransactionUnit(pageContext, XxpoConstants.TXN_XXPO440001J);
        ...
        //パラメータ用HashMap生成
        HashMap pageParams = new HashMap();
        pageParams.put(XxwshConstants.URL_PARAM_CALL_PICTURE_KBN,   XxwshConstants.CALL_PIC_KBN_PROD_CREATE);
