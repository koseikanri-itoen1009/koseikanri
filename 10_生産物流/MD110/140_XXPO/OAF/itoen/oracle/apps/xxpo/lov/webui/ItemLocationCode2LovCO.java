 ...
 ***************************************************************************
 */
public class ItemLocationCode2LovCO extends OAControllerImpl
{
...
// 20080528 yoshimoto add End
    ...
    if (XxpoConstants.PEOPLE_CODE_O.equals(peopleCode))
    {
      ...
      // 発注NoVOを取得
      OAViewObject orderNumberVO = (OAViewObject)am.findViewObject("ItemLocationCode2VO1");
