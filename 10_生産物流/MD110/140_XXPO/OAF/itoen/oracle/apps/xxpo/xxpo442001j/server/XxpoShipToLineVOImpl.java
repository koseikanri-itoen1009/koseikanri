/*============================================================================
* ファイル名 : XxpoShipToLineVOImpl
* 概要説明   : 入庫実績入力明細ビューオブジェクト
* バージョン : 1.0
*============================================================================
* 修正履歴
* 日付       Ver. 担当者       修正内容
...
import oracle.jbo.domain.Number;
 /***************************************************************************
  * 入庫実績入力明細ビューオブジェクトクラスです。
  * @author  ORACLE 新藤 義勝
  * @version 1.0
  ***************************************************************************
  */
  public class XxpoShipToLineVOImpl extends OAViewObjectImpl 
  {
  /**
   * 
   * This is the default constructor (do not remove)
   */
  public XxpoShipToLineVOImpl()
  {
  }
 /*****************************************************************************
  * VOの初期化を行います。
