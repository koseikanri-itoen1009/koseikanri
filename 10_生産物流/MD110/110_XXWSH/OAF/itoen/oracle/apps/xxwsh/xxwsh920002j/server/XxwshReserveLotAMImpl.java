...
* 2019-02-25 1.15 小路恭弘       E_本稼動_15398対応
*============================================================================
*/
...
//               && XxcmnUtility.chkCompareDate(1, standardDate, new Date(productionDate.replaceAll("/", "-"))))
              // 引当可能鮮度チェックを実行
              data = XxwshUtility.doCheckFreshCondition2(
                       getOADBTransaction(),
                       deliverToId,
                       lotId,
                       scheduleArrivalDate,
