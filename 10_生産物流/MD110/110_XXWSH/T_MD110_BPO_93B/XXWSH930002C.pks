 ...
 *  2009/01/29    1.40 Oracle 佐久間尚豊 本番障害対応#917,1045【1045はHHTのみの対応】
 ...
 *  2009/02/20    1.44 Oracle 佐久間尚豊 本番障害対応#1199 配送No/移動No-EOSデータ種別単位のエラーは明細単位で出力する。
 ...
 *  2009/06/08    1.55 SCS    伊藤ひとみ 本番障害対応#1369 1回の取込で実績を二重上げてしまった場合、品目重複エラーとなるよう修正
