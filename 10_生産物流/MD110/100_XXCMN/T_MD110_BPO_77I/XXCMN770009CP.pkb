create or replace PACKAGE BODY xxcmn770009cp
AS
/*****************************************************************************************
 * Copyright(c)Oracle Corporation Japan, 2008. All rights reserved.
 *
 * Package Name     : XXCMN770009CP(body)
 * Description      : 他勘定振替原価差異表(プロト)
...
--
  ...
  -- ユーザー定義グローバル定数
  -- ===============================
  gv_pkg_name             CONSTANT VARCHAR2(20) := 'xxcmn770009cp' ;   -- パッケージ名
--
