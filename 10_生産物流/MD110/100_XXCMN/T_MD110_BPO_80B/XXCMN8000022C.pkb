CREATE OR REPLACE PACKAGE BODY xxcmn8000022c
AS
/*****************************************************************************************
 * Copyright(c)Oracle Corporation Japan, 2008. All rights reserved.
 *
 * Package Name     : xxcmn8000022c(body)
 * Description      : 品目マスタインタフェース標準原価反映のみ
...
--
  gv_pkg_name          CONSTANT VARCHAR2(100) := 'xxcmn8000022c'; -- パッケージ名
