/*============================================================================
* ファイル名 : XxinvMrpFileUlInterfaceEOImpl.java
...
*============================================================================
*/
package itoen.oracle.apps.xxinv.schema.server;
...
public class XxinvMrpFileUlInterfaceEOImpl extends OAEntityImpl 
{
   ...
   */
  public XxinvMrpFileUlInterfaceEOImpl()
  {
  }
  ...
  public static synchronized EntityDefImpl getDefinitionObject()
  {
    ...
    {
      mDefinitionObject = (oracle.apps.fnd.framework.server.OAEntityDefImpl)EntityDefImpl.findDefObject("itoen.oracle.apps.xxinv.schema.server.XxinvMrpFileUlInterfaceEO");
    }
  ...
  public void create(AttributeList attributeList)
  {
    ...
    Number fileId = transaction.getSequenceValue("XXINV_MRP_FILE_UL_S1");
    setFileId(fileId);
    // ファイルフォーマット情報を設定する。
    setFileFormat(XxcmnConstants.CSV_NM);
    // Whoカラムを設定する。
