...
##                        リプレース_00004対応                                ##
##                    SCSK      竹浪 隼      2021/12/20 3.0.0                 ##
##                        E_本稼動_17774対応(環境依存値の修正)                ##
##                    SCSK      竹浪 隼      2022/07/27 3.0.1                 ##
##                        ZBZZEXECONCSUB.ksh を元にSQLLoader取込処理を        ##
##                        実行するように修正                                  ##
##                                                                            ##
##    [戻り値]                                                                ##
##        0     正常                                                          ##
...
##                                 変数定義                                   ##
################################################################################
##処理対象のCSVファイルの格納ディレクトリ読込
#2022/07/27 ADD Ver.3.0.1 by Shun Takenami START
ls -l $(dirname ${6})
#2022/07/27 ADD Ver.3.0.1 by Shun Takenami END
## 変数定義
...
L_tmppath="/xebst2/`whoami`/`whoami`comn/temp"
