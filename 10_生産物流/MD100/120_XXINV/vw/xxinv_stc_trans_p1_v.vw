...
COMMENT ON COLUMN xxinv_stc_trans_p1_v.lot_no                IS 'ロットNo';
COMMENT ON COLUMN xxinv_stc_trans_p1_v.manufacture_date      IS '製造年月日';
COMMENT ON COLUMN xxinv_stc_trans_p1_v.uniqe_sign            IS '固有記号';
COMMENT ON COLUMN xxinv_stc_trans_p1_v.expiration_date       IS '賞味期限';
COMMENT ON COLUMN xxinv_stc_trans_p1_v.arrival_date          IS '着日';
COMMENT ON COLUMN xxinv_stc_trans_p1_v.leaving_date          IS '発日';
COMMENT ON COLUMN xxinv_stc_trans_p1_v.status                IS 'ステータス';
COMMENT ON COLUMN xxinv_stc_trans_p1_v.reason_code           IS '事由コード';
COMMENT ON COLUMN xxinv_stc_trans_p1_v.reason_code_name      IS '事由コード名';
COMMENT ON COLUMN xxinv_stc_trans_p1_v.voucher_no            IS '伝票No';
COMMENT ON COLUMN xxinv_stc_trans_p1_v.ukebaraisaki_name     IS '受払先';
COMMENT ON COLUMN xxinv_stc_trans_p1_v.deliver_to_name       IS '配送先';
COMMENT ON COLUMN xxinv_stc_trans_p1_v.stock_quantity        IS '入庫数';
COMMENT ON COLUMN xxinv_stc_trans_p1_v.leaving_quantity      IS '出庫数';
--
COMMENT ON TABLE  xxinv_stc_trans_p1_v IS '入出庫情報ビュー 製品 ロット管理品' ;
/
