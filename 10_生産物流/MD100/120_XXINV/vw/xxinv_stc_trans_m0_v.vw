CREATE OR REPLACE VIEW xxinv_stc_trans_m0_v 
(
...
-- 2008/10/23 Y.Yamamoto v1.1 delete endi
...
--
-- 2008/12/07 N.Yoshida start
COMMENT ON COLUMN xxinv_stc_trans_m0_v.po_trans_id           IS '発注実績用ID';
-- 2008/12/07 N.Yoshida end
COMMENT ON COLUMN xxinv_stc_trans_m0_v.ownership_code        IS '名義コード';
COMMENT ON COLUMN xxinv_stc_trans_m0_v.inventory_location_id IS '保管倉庫ID';
COMMENT ON COLUMN xxinv_stc_trans_m0_v.item_id               IS '品目ID';
COMMENT ON COLUMN xxinv_stc_trans_m0_v.lot_no                IS 'ロットNo';
COMMENT ON COLUMN xxinv_stc_trans_m0_v.manufacture_date      IS '製造年月日';
COMMENT ON COLUMN xxinv_stc_trans_m0_v.uniqe_sign            IS '固有記号';
COMMENT ON COLUMN xxinv_stc_trans_m0_v.expiration_date       IS '賞味期限';
COMMENT ON COLUMN xxinv_stc_trans_m0_v.arrival_date          IS '着日';
COMMENT ON COLUMN xxinv_stc_trans_m0_v.leaving_date          IS '発日';
COMMENT ON COLUMN xxinv_stc_trans_m0_v.status                IS 'ステータス';
COMMENT ON COLUMN xxinv_stc_trans_m0_v.reason_code           IS '事由コード';
COMMENT ON COLUMN xxinv_stc_trans_m0_v.reason_code_name      IS '事由コード名';
COMMENT ON COLUMN xxinv_stc_trans_m0_v.voucher_no            IS '伝票No';
COMMENT ON COLUMN xxinv_stc_trans_m0_v.ukebaraisaki_name     IS '受払先';
COMMENT ON COLUMN xxinv_stc_trans_m0_v.deliver_to_name       IS '配送先';
COMMENT ON COLUMN xxinv_stc_trans_m0_v.stock_quantity        IS '入庫数';
COMMENT ON COLUMN xxinv_stc_trans_m0_v.leaving_quantity      IS '出庫数';
--
COMMENT ON TABLE  xxinv_stc_trans_m0_v IS '入出庫情報ビュー 製品以外 非ロット管理品' ;
/
