CREATE OR REPLACE VIEW xxinv_stc_trans_m1_v 
(
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_in_xf.attribute3                          AS expiration_date -- <---- ここまで共通
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_in_tr.attribute3                          AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_in_xf20.attribute3                        AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_out_xf.attribute3                         AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
-- 2008/12/07 N.Yoshida start
        ...
        ,ilm_out_tr.attribute3                         AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_out_xf20.attribute3                       AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_out_om.attribute3                         AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
-- 2009/01/23 Upd N.Yoshida End
        ...
        ,(SELECT xrpm_out_om.new_div_invent
          ...
          AND    xrpm_out_om.item_div_origin         IS NULL
         ) xrpm
-- 2008/12/01 Upd Y.Kawano Start
...
-- 2008/11/26 Upd Y.Kawano End
  ...
  AND  ((mcb_out_om.segment1                          = xrpm.item_div_ahead)
     OR (mcb_out_om.segment1                         <> '5'
...
-- 2008/10/24 Y.Yamamoto v1.1 update end
          ...
          AND    xrpm_out_om2.item_div_origin         IS NULL
         ) xrpm
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_out_ad.attribute3                          AS expiration_date -- <---- ここまで共通
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_in_po_e.attribute3                        AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_in_xf_e.attribute3                        AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_in_tr_e.attribute3                        AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_in_pr_e.attribute3                        AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_in_pr_e70.attribute3                      AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_in_ad_e_x97.attribute3                    AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_in_ad_e_x9.attribute3                     AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
--        ,ilm_in_ad_e_xx.attribute3                     AS expiration_date -- <---- ここまで共通
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_out_xf_e.attribute3                       AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_out_tr_e.attribute3                       AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_out_pr_e.attribute3                       AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_out_pr_e70.attribute3                     AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_out_om_e.attribute3                       AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
-- 2009/01/23 Upd N.Yoshida End
        ...
        ,(SELECT xrpm_out_om_e.new_div_invent
          ...
          AND    xrpm_out_om_e.item_div_origin                 IS NULL
         ) xrpm
-- 2008/12/01 Upd Y.Kawano Start
...
-- 2008/12/01 Upd Y.Kawano End
  ...
  AND  ((mcb_out_om_e.segment1                          = xrpm.item_div_ahead)
     OR (mcb_out_om_e.segment1                         <> '5' 
     AND xrpm.item_div_ahead                           IS NULL))
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_out_om3_e.attribute3                      AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_out_ad_e_x97.attribute3                   AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
-- 2008/12/07 N.Yoshida start
        ...
        ,ilm_out_ad_e_x2.attribute3                    AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
--        ,ilm_out_ad_e_12.attribute3                    AS expiration_date -- <---- ここまで共通
...
-- 2008/12/07 N.Yoshida end
        ...
        ,ilm_out_ad_e_xx.attribute3                    AS expiration_date -- <---- ここまで共通
--2009/01/07 Y.Kawano Mod Start
...
--
-- 2008/12/07 N.Yoshida start
COMMENT ON COLUMN xxinv_stc_trans_m1_v.po_trans_id           IS '発注実績用ID';
-- 2008/12/07 N.Yoshida end
COMMENT ON COLUMN xxinv_stc_trans_m1_v.ownership_code        IS '名義コード';
COMMENT ON COLUMN xxinv_stc_trans_m1_v.inventory_location_id IS '保管倉庫ID';
COMMENT ON COLUMN xxinv_stc_trans_m1_v.item_id               IS '品目ID';
COMMENT ON COLUMN xxinv_stc_trans_m1_v.lot_no                IS 'ロットNo';
COMMENT ON COLUMN xxinv_stc_trans_m1_v.manufacture_date      IS '製造年月日';
COMMENT ON COLUMN xxinv_stc_trans_m1_v.uniqe_sign            IS '固有記号';
COMMENT ON COLUMN xxinv_stc_trans_m1_v.expiration_date       IS '賞味期限';
COMMENT ON COLUMN xxinv_stc_trans_m1_v.arrival_date          IS '着日';
COMMENT ON COLUMN xxinv_stc_trans_m1_v.leaving_date          IS '発日';
COMMENT ON COLUMN xxinv_stc_trans_m1_v.status                IS 'ステータス';
COMMENT ON COLUMN xxinv_stc_trans_m1_v.reason_code           IS '事由コード';
COMMENT ON COLUMN xxinv_stc_trans_m1_v.reason_code_name      IS '事由コード名';
COMMENT ON COLUMN xxinv_stc_trans_m1_v.voucher_no            IS '伝票No';
COMMENT ON COLUMN xxinv_stc_trans_m1_v.ukebaraisaki_name     IS '受払先';
COMMENT ON COLUMN xxinv_stc_trans_m1_v.deliver_to_name       IS '配送先';
COMMENT ON COLUMN xxinv_stc_trans_m1_v.stock_quantity        IS '入庫数';
COMMENT ON COLUMN xxinv_stc_trans_m1_v.leaving_quantity      IS '出庫数';
--
COMMENT ON TABLE  xxinv_stc_trans_m1_v IS '入出庫情報ビュー 製品以外 非ロット管理品' ;
/
