...
SELECT xstv.whse_code
 ...
 FROM (
        ...
        FROM   xxcmn_item_locations_v       xilv_in_pr_e70                 -- OPM保管場所情報VIEW
              ...
              ,gmd_routings_tl              grt_in_pr_e70                  -- 工順マスタ名称
        ...
        AND    grt_in_pr_e70.routing_desc            IN ( FND_PROFILE.VALUE('XXINV_DUMMY_ROUTING')   -- 品目振替
                                                         ,FND_PROFILE.VALUE('XXINV_DUMMY_ROUTING_SEPARATE')) -- 解体
        ...
        AND (( grb_in_pr_e70.routing_class            = '70'
           AND xrpm_in_pr_e70.item_div_ahead          = xicv_in_pr_e70.item_class_code
           AND xrpm_in_pr_e70.item_div_origin         = xicv_in_pr_e70.item_class_code )
          OR ( grb_in_pr_e70.routing_class            = '62' ))
        ...
        UNION ALL
        -- 在庫調整 入庫実績(仕入返品出庫)
        SELECT xilv_in_ad_e_x2.whse_code
              ,xilv_in_ad_e_x2.mtl_organization_id
              ,xilv_in_ad_e_x2.customer_stock_whse
              ,xilv_in_ad_e_x2.inventory_location_id
              ,xilv_in_ad_e_x2.segment1
              ,xilv_in_ad_e_x2.description
              ,ximv_in_ad_e_x2.item_id
              ,ximv_in_ad_e_x2.item_no
              ,ximv_in_ad_e_x2.item_name
              ,ximv_in_ad_e_x2.item_short_name
              ,ximv_in_ad_e_x2.num_of_cases
              ,ilm_in_ad_e_x2.lot_id
              ,ilm_in_ad_e_x2.lot_no
              ,ilm_in_ad_e_x2.attribute1
              ,ilm_in_ad_e_x2.attribute2
              ,ilm_in_ad_e_x2.attribute3                                     -- <---- ここまで共通
              ,itc_in_ad_e_x2.trans_date
              ,itc_in_ad_e_x2.trans_date
              ,'2'                                            AS status      -- 実績
              ,xrpm_in_ad_e_x2.new_div_invent
              ,flv_in_ad_e_x2.meaning
              ,xrart_in_ad_e_x2.rcv_rtn_number
              ,xrart_in_ad_e_x2.vendor_id
              ,xvv_in_ad_e_x2.vendor_full_name
              ,NULL                                           AS deliver_to_id
              ,NULL                                           AS deliver_to_name
              ,itc_in_ad_e_x2.trans_qty
              ,0                                              AS leaving_quantity
              ,ximv_in_ad_e_x2.lot_ctl
        FROM   xxcmn_item_locations_v  xilv_in_ad_e_x2                       -- OPM保管場所情報VIEW
              ,xxcmn_item_mst_v        ximv_in_ad_e_x2                       -- OPM品目情報VIEW
              ,ic_lots_mst             ilm_in_ad_e_x2                        -- OPMロットマスタ
              ,xxcmn_rcv_pay_mst       xrpm_in_ad_e_x2                       -- 受払区分アドオンマスタ
              ,fnd_lookup_values       flv_in_ad_e_x2                        -- クイックコード <---- ここまで共通
              ...
              ,xxcmn_vendors_v         xvv_in_ad_e_x2                        -- 仕入先情報VIEW
        WHERE  xrpm_in_ad_e_x2.doc_type               = 'ADJI'
        ...
        AND    SIGN( itc_in_ad_e_x2.trans_qty )       = xrpm_in_ad_e_x2.rcv_pay_div
        AND    itc_in_ad_e_x2.item_id                 = ximv_in_ad_e_x2.item_id
        AND    ilm_in_ad_e_x2.item_id                 = ximv_in_ad_e_x2.item_id
        AND    itc_in_ad_e_x2.lot_id                  = ilm_in_ad_e_x2.lot_id
        AND    itc_in_ad_e_x2.whse_code               = xilv_in_ad_e_x2.whse_code
        AND    itc_in_ad_e_x2.location                = xilv_in_ad_e_x2.segment1
        ...
        AND    xvv_in_ad_e_x2.vendor_id               = xrart_in_ad_e_x2.vendor_id
        AND    flv_in_ad_e_x2.lookup_type             = 'XXCMN_NEW_DIVISION'
        AND    flv_in_ad_e_x2.language                = 'JA'
        AND    flv_in_ad_e_x2.lookup_code             = xrpm_in_ad_e_x2.new_div_invent
        UNION ALL
        -- 在庫調整 入庫実績(浜岡入庫)
        ...
        SELECT xilv_in_ad_e_xx.whse_code
              ...
              ,TO_CHAR( ijm_in_ad_e_xx.journal_no )
              ,TO_NUMBER( xrpm_in_ad_e_xx.new_div_invent )
              ,flv_in_ad_e_xx.meaning
              ,NULL                                           AS deliver_to_id
              ,NULL                                           AS deliver_to_name
        ...
        AND    ilm_out_xf_e.item_id                  = ximv_out_xf_e.item_id
        ...
        AND    ilm_out_tr_e.item_id                  = ximv_out_tr_e.item_id
        ...
        FROM   xxcmn_item_locations_v       xilv_out_pr_e70                 -- OPM保管場所情報VIEW
              ...
              ,gmd_routings_tl              grt_out_pr_e70                  -- 工順マスタ名称
        ...
        AND    grt_out_pr_e70.routing_desc            IN ( FND_PROFILE.VALUE('XXINV_DUMMY_ROUTING')   -- 品目振替
                                                         ,FND_PROFILE.VALUE('XXINV_DUMMY_ROUTING_SEPARATE')) -- 解体
        ...
        AND (( grb_out_pr_e70.routing_class            = '70'
           AND xrpm_out_pr_e70.item_div_ahead          = xicv_out_pr_e70.item_class_code
           AND xrpm_out_pr_e70.item_div_origin         = xicv_out_pr_e70.item_class_code )
          OR ( grb_out_pr_e70.routing_class            = '62' ))
        ...
        SELECT xilv_out_ad_e_xx.whse_code
              ...
              ,TO_CHAR( ijm_out_ad_e_xx.journal_no )
              ,TO_NUMBER( xrpm_out_ad_e_xx.new_div_invent )
              ,flv_out_ad_e_xx.meaning
              ,NULL                                           AS deliver_to_id
              ,NULL                                           AS deliver_to_name
              ,0                                              AS stock_quantity
