CREATE OR REPLACE VIEW APPS.XXSKY_レシピ_現在_V
(
 レシピ番号
,レシピ名称
,レシピ摘要
...
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.レシピ番号                     IS 'レシピ番号'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.レシピ名称                     IS 'レシピ名称'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.レシピ摘要                     IS 'レシピ摘要'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.バージョン                     IS 'バージョン'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.ステータス                     IS 'ステータス'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.ステータス名                   IS 'ステータス名'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.所有者組織コード               IS '所有者組織コード'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.所有者組織名                   IS '所有者組織名'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.作成組織コード                 IS '作成組織コード'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.作成組織名                     IS '作成組織名'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.フォーミュラ番号               IS 'フォーミュラ番号'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.フォーミュラ名称               IS 'フォーミュラ名称'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.フォーミュラ名称２             IS 'フォーミュラ名称２'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.フォーミュラ摘要               IS 'フォーミュラ摘要'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.フォーミュラ摘要２             IS 'フォーミュラ摘要２'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.工順番号                       IS '工順番号'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.工順名                         IS '工順名'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.調達区分                       IS '調達区分'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.調達区分名                     IS '調達区分名'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.包装難度                       IS '包装難度'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.管理区分                       IS '管理区分'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.管理区分名                     IS '管理区分名'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.品目コード                     IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.品目名                         IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.品目略称                       IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.商品区分                       IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.商品区分名                     IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.品目区分                       IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.品目区分名                     IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.群コード                       IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.レシピ使用                     IS 'レシピ使用'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.妥当性ルール日付_自            IS '妥当性ルール日付_自'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.妥当性ルール日付_至            IS '妥当性ルール日付_至'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.最小数量                       IS '最小数量'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.最大数量                       IS '最大数量'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.標準数量                       IS '標準数量'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.単位                           IS '単位'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.作成者                         IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.作成日                         IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.最終更新者                     IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.最終更新日                     IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKY_レシピ_現在_V.最終更新ログイン               IS '最終更新ログイン'
/
