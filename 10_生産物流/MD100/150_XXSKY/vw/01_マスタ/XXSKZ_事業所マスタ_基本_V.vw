/*************************************************************************
 * 
 * View  Name      : XXSKZ_事業所マスタ_基本_V
 * Description     : XXSKZ_事業所マスタ_基本_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 ************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_事業所マスタ_基本_V
(
 事業所コード
,事業所名
,事業所略称
...
-- 2010/01/28 T.Yoshimoto Mod End 本稼動#1168
  FROM  xxcmn_locations_all XLA        --事業所アドオン
       ...
       ,xxskz_locations_v   XLV        --SKYLINK用中間VIEW 事業所情報VIEW
...
/
COMMENT ON TABLE APPS.XXSKZ_事業所マスタ_基本_V IS 'SKYLINK用事業所マスタ（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.事業所コード                  IS '事業所コード'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.事業所名                      IS '事業所名'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.事業所略称                    IS '事業所略称'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.事業所カナ名                  IS '事業所カナ名'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.適用開始日                    IS '適用開始日'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.適用終了日                    IS '適用終了日'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.郵便番号                      IS '郵便番号'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.住所                          IS '住所'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.電話番号                      IS '電話番号'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.FAX番号                       IS 'FAX番号'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.本部コード                    IS '本部コード'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.失効日                        IS '失効日'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.使用用途                      IS '使用用途'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.使用用途名                    IS '使用用途名'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.出荷管理元区分                IS '出荷管理元区分'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.出荷管理元区分名              IS '出荷管理元区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.購買担当フラグ                IS '購買担当フラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.購買担当フラグ名              IS '購買担当フラグ名'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.出荷担当フラグ                IS '出荷担当フラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.出荷担当フラグ名              IS '出荷担当フラグ名'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.担当職責１                    IS '担当職責１'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.担当職責２                    IS '担当職責２'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.担当職責３                    IS '担当職責３'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.担当職責４                    IS '担当職責４'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.担当職責５                    IS '担当職責５'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.担当職責６                    IS '担当職責６'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.担当職責７                    IS '担当職責７'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.担当職責８                    IS '担当職責８'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.担当職責９                    IS '担当職責９'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.担当職責１０                  IS '担当職責１０'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.親事業所コード                IS '親事業所コード'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.親事業所名                    IS '親事業所名'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.他拠点出荷依頼作成可否区分    IS '他拠点出荷依頼作成可否区分'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.他拠点出荷依頼作成可否区分名  IS '他拠点出荷依頼作成可否区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.地区コード                    IS '地区コード'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.地区名                        IS '地区名'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.作成者                        IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.作成日                        IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.最終更新者                    IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.最終更新日                    IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKZ_事業所マスタ_基本_V.最終更新ログイン              IS '最終更新ログイン'
/
