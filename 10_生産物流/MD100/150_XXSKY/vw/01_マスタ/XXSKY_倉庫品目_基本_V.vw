CREATE OR REPLACE VIEW APPS.XXSKY_倉庫品目_基本_V
(
 元倉庫コード
,元倉庫名
,商品区分
...
-- 2010/01/28 T.Yoshimoto Mod Start 本稼動#1168
       ...
       ,(SELECT XILV1.description
         FROM xxsky_item_locations_v XILV1  --OPM保管場所情報VIEW(元倉庫名用)
...
-- 2010/01/28 T.Yoshimoto Mod Start 本稼動#1168
       ...
       ,(SELECT XILV2.description
         FROM xxsky_item_locations_v XILV2  --OPM保管場所情報VIEW(代表倉庫名用)
...
-- 2010/01/28 T.Yoshimoto Del End 本稼動#1168
/
COMMENT ON TABLE APPS.XXSKY_倉庫品目_基本_V IS 'SKYLINK用倉庫品目（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_倉庫品目_基本_V.元倉庫コード                   IS '元倉庫コード'
/
COMMENT ON COLUMN APPS.XXSKY_倉庫品目_基本_V.元倉庫名                       IS '元倉庫名'
/
COMMENT ON COLUMN APPS.XXSKY_倉庫品目_基本_V.商品区分                       IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_倉庫品目_基本_V.商品区分名                     IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_倉庫品目_基本_V.品目区分                       IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKY_倉庫品目_基本_V.品目区分名                     IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_倉庫品目_基本_V.群コード                       IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKY_倉庫品目_基本_V.品目コード                     IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKY_倉庫品目_基本_V.品目名                         IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKY_倉庫品目_基本_V.品目略称                       IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_倉庫品目_基本_V.代表倉庫コード                 IS '代表倉庫コード'
/
COMMENT ON COLUMN APPS.XXSKY_倉庫品目_基本_V.代表倉庫名                     IS '代表倉庫名'
/
COMMENT ON COLUMN APPS.XXSKY_倉庫品目_基本_V.作成者                         IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKY_倉庫品目_基本_V.作成日                         IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKY_倉庫品目_基本_V.最終更新者                     IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKY_倉庫品目_基本_V.最終更新日                     IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKY_倉庫品目_基本_V.最終更新ログイン               IS '最終更新ログイン'
/
