CREATE OR REPLACE VIEW APPS.XXSKY_仕入単価明細_基本_V
(
 商品区分
,商品区分名
,品目区分
...
-- 2010/01/28 T.Yoshimoto Del End 本稼動#1168
/
COMMENT ON TABLE APPS.XXSKY_仕入単価明細_基本_V IS 'SKYLINK用仕入単価明細（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.商品区分                       IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.商品区分名                     IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.品目区分                       IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.品目区分名                     IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.群コード                       IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.内訳品目コード                 IS '内訳品目コード'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.内訳品目名                     IS '内訳品目名'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.内訳品目略称                   IS '内訳品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.付帯コード                     IS '付帯コード'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.メーカーコード                 IS 'メーカーコード'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.メーカー名                     IS 'メーカー名'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.費目区分                       IS '費目区分'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.費目区分名                     IS '費目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.項目区分                       IS '項目区分'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.項目区分名                     IS '項目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.数量                           IS '数量'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.数量単位                       IS '数量単位'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.単価                           IS '単価'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.単価単位                       IS '単価単位'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.歩留率                         IS '歩留率'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.仕入単価                       IS '仕入単価'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.演算区分                       IS '演算区分'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.演算区分名                     IS '演算区分名'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.実質単価                       IS '実質単価'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.ヘッダID                       IS 'ヘッダID'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.作成者                         IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.作成日                         IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.最終更新者                     IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.最終更新日                     IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKY_仕入単価明細_基本_V.最終更新ログイン               IS '最終更新ログイン'
/
