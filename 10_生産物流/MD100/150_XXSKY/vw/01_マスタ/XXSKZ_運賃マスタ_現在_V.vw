/*************************************************************************
 * 
 * View  Name      : XXSKZ_運賃マスタ_現在_V
 * Description     : XXSKZ_運賃マスタ_現在_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 ************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_運賃マスタ_現在_V
(
 支払請求区分
,支払請求区分名
,商品区分
...
-- 2010/01/28 T.Yoshimoto Del End 本稼動#1168
/
COMMENT ON TABLE APPS.XXSKZ_運賃マスタ_現在_V IS 'SKYLINK用運賃マスタ（現在）VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃マスタ_現在_V.支払請求区分                IS '支払請求区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃マスタ_現在_V.支払請求区分名              IS '支払請求区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃マスタ_現在_V.商品区分                    IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃マスタ_現在_V.商品区分名                  IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃マスタ_現在_V.運送業者                    IS '運送業者'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃マスタ_現在_V.運送業者名                  IS '運送業者名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃マスタ_現在_V.配送区分                    IS '配送区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃マスタ_現在_V.配送区分名                  IS '配送区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃マスタ_現在_V.運賃距離                    IS '運賃距離'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃マスタ_現在_V.重量                        IS '重量'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃マスタ_現在_V.適用開始日                  IS '適用開始日'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃マスタ_現在_V.適用終了日                  IS '適用終了日'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃マスタ_現在_V.運送費                      IS '運送費'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃マスタ_現在_V.リーフ混載割増              IS 'リーフ混載割増'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃マスタ_現在_V.作成者                      IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃マスタ_現在_V.作成日                      IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃マスタ_現在_V.最終更新者                  IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃マスタ_現在_V.最終更新日                  IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃マスタ_現在_V.最終更新ログイン            IS '最終更新ログイン'
/
