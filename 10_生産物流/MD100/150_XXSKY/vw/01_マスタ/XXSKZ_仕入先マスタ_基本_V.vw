/*************************************************************************
 * 
 * View  Name      : XXSKZ_仕入先マスタ_基本_V
 * Description     : XXSKZ_仕入先マスタ_基本_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 ************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_仕入先マスタ_基本_V
(
 仕入先コード
,仕入先名
,仕入先略称
...
-- 2010/01/28 T.Yoshimoto Del End 本稼動#1168
/
COMMENT ON TABLE APPS.XXSKZ_仕入先マスタ_基本_V IS 'SKYLINK用仕入先マスタ（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.仕入先コード         IS '仕入先コード'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.仕入先名             IS '仕入先名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.仕入先略称           IS '仕入先略称'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.仕入先カナ名         IS '仕入先カナ名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.適用開始日           IS '適用開始日'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.適用終了日           IS '適用終了日'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.郵便番号             IS '郵便番号'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.住所１               IS '住所１'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.住所２               IS '住所２'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.電話番号             IS '電話番号'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.FAX番号              IS 'FAX番号'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.部署                 IS '部署'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.部署名               IS '部署名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.支払条件設定日       IS '支払条件設定日'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.支払先               IS '支払先'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.支払先名             IS '支払先名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.斡旋者               IS '斡旋者'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.斡旋者名             IS '斡旋者名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.顧客コード           IS '顧客コード'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.顧客名               IS '顧客名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.生産実績処理タイプ   IS '生産実績処理タイプ'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.生産実績処理タイプ名 IS '生産実績処理タイプ名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.仕入先区分           IS '仕入先区分'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.仕入先区分名         IS '仕入先区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.代表工場             IS '代表工場'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.代表工場名           IS '代表工場名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.代表納入先           IS '代表納入先'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.代表納入先名         IS '代表納入先名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.支給価格表           IS '支給価格表'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.関連取引先           IS '関連取引先'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.関連取引先名         IS '関連取引先名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.備考                 IS '備考'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.作成者               IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.作成日               IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.最終更新者           IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.最終更新日           IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入先マスタ_基本_V.最終更新ログイン     IS '最終更新ログイン'
/