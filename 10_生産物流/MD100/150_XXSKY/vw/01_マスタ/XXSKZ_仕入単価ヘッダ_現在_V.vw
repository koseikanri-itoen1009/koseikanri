/*************************************************************************
 * 
 * View  Name      : XXSKZ_仕入単価ヘッダ_現在_V
 * Description     : XXSKZ_仕入単価ヘッダ_現在_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 ************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_仕入単価ヘッダ_現在_V
(
 商品区分
,商品区分名
,品目区分
...
-- 2010/01/28 T.Yoshimoto Mod End 本稼動#1168
  FROM  xxpo_price_headers    XPH    --仕入／標準単価ヘッダアドオン
       ...
       ,xxskz_vendors_v       XVV_T  --仕入先情報VIEW(取引先名取得用)
...
/
COMMENT ON TABLE APPS.XXSKZ_仕入単価ヘッダ_現在_V IS 'SKYLINK用仕入単価ヘッダ（現在）VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.商品区分                       IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.商品区分名                     IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.品目区分                       IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.品目区分名                     IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.群コード                       IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.品目コード                     IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.品目名                         IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.品目略称                       IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.付帯コード                     IS '付帯コード'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.取引先コード                   IS '取引先コード'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.取引先名                       IS '取引先名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.工場コード                     IS '工場コード'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.工場名                         IS '工場名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.支給先コード                   IS '支給先コード'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.支給先名                       IS '支給先名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.固有記号                       IS '固有記号'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.計算区分                       IS '計算区分'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.計算区分名                     IS '計算区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.適用開始日                     IS '適用開始日'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.適用終了日                     IS '適用終了日'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.内訳合計                       IS '内訳合計'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.変更処理フラグ                 IS '変更処理フラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.摘要                           IS '摘要'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.ヘッダID                       IS 'ヘッダID'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.作成者                         IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.作成日                         IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.最終更新者                     IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.最終更新日                     IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価ヘッダ_現在_V.最終更新ログイン               IS '最終更新ログイン'
/
