/*************************************************************************
 * 
 * View  Name      : XXSKZ_フォーミュラ_現在_V
 * Description     : XXSKZ_フォーミュラ_現在_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 ************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_フォーミュラ_現在_V
(
 フォーミュラ番号
,フォーミュラ名称
,フォーミュラ名称２
...
-- 2010/01/28 T.Yoshimoto Del End 本稼動#1168
/
COMMENT ON TABLE APPS.XXSKZ_フォーミュラ_現在_V IS 'SKYLINK用フォーミュラマスタ（現在）VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.フォーミュラ番号               IS 'フォーミュラ番号'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.フォーミュラ名称               IS 'フォーミュラ名称'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.フォーミュラ名称２             IS 'フォーミュラ名称２'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.フォーミュラ摘要               IS 'フォーミュラ摘要'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.フォーミュラ摘要２             IS 'フォーミュラ摘要２'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.バージョン                     IS 'バージョン'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.スケーリング可                 IS 'スケーリング可'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.ステータス                     IS 'ステータス'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.ステータス名                   IS 'ステータス名'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.調合量                         IS '調合量'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.調合量_単位                    IS '調合量_単位'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.内容量                         IS '内容量'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.内容量_単位                    IS '内容量_単位'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.密度                           IS '密度'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.工場固有記号                   IS '工場固有記号'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.初回生産日                     IS '初回生産日'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.パッカー                       IS 'パッカー'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.パッカー名                     IS 'パッカー名'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.生産工場                       IS '生産工場'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.生産工場名                     IS '生産工場名'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.振替半製品                     IS '振替半製品'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.振替半製品名                   IS '振替半製品名'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.原料分解要否                   IS '原料分解要否'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.原料分解要否名                 IS '原料分解要否名'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.歩留計算要否                   IS '歩留計算要否'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.歩留計算要否名                 IS '歩留計算要否名'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.オンラインフラグ               IS 'オンラインフラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.オンラインフラグ名             IS 'オンラインフラグ名'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.明細タイプ                     IS '明細タイプ'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.明細タイプ名                   IS '明細タイプ名'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.明細番号                       IS '明細番号'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.品目コード                     IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.品目名                         IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.品目略称                       IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.商品区分                       IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.商品区分名                     IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.品目区分                       IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.品目区分名                     IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.群コード                       IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.数量                           IS '数量'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.単位                           IS '単位'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.収率タイプ                     IS '収率タイプ'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.収率タイプ名                   IS '収率タイプ名'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.メーカー                       IS 'メーカー'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.メーカー名                     IS 'メーカー名'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.配合率                         IS '配合率'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.一本当り使用量                 IS '一本当り使用量'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.一本当り使用量_単位            IS '一本当り使用量_単位'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.基準単価                       IS '基準単価'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.作成者                         IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.作成日                         IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.最終更新者                     IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.最終更新日                     IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKZ_フォーミュラ_現在_V.最終更新ログイン               IS '最終更新ログイン'
/
