CREATE OR REPLACE VIEW APPS.XXSKY_配送距離マスタ_基本_V
(
 商品区分
,商品区分名
,運送業者コード
...
/
COMMENT ON TABLE APPS.XXSKY_配送距離マスタ_基本_V IS 'SKYLINK用配送距離マスタ（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.商品区分         IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.商品区分名       IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.運送業者コード   IS '運送業者コード'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.運送業者名       IS '運送業者名'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.出庫倉庫         IS '出庫倉庫'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.出庫倉庫名       IS '出庫倉庫名'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.コード区分       IS 'コード区分'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.コード区分名     IS 'コード区分名'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.配送先コード     IS '配送先コード'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.配送先名         IS '配送先名'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.適用開始日       IS '適用開始日'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.適用終了日       IS '適用終了日'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.車立距離         IS '車立距離'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.小口距離         IS '小口距離'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.混載割増距離     IS '混載割増距離'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.実際距離         IS '実際距離'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.エリアA          IS 'エリアA'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.エリアB          IS 'エリアB'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.エリアC          IS 'エリアC'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.作成者           IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.作成日           IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.最終更新者       IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.最終更新日       IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKY_配送距離マスタ_基本_V.最終更新ログイン IS '最終更新ログイン'
/