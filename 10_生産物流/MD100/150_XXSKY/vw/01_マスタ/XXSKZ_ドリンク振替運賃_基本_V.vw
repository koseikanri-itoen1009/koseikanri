/*************************************************************************
 * 
 * View  Name      : XXSKZ_ドリンク振替運賃_基本_V
 * Description     : XXSKZ_ドリンク振替運賃_基本_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 ************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_ドリンク振替運賃_基本_V
(
 商品分類
,商品分類名
,配送区分
...
/
COMMENT ON TABLE APPS.XXSKZ_ドリンク振替運賃_基本_V IS 'SKYLINK用ドリンク振替運賃（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク振替運賃_基本_V.商品分類                       IS '商品分類'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク振替運賃_基本_V.商品分類名                     IS '商品分類名'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク振替運賃_基本_V.配送区分                       IS '配送区分'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク振替運賃_基本_V.配送区分名                     IS '配送区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク振替運賃_基本_V.拠点大分類                     IS '拠点大分類'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク振替運賃_基本_V.拠点大分類名                   IS '拠点大分類名'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク振替運賃_基本_V.適用開始日                     IS '適用開始日'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク振替運賃_基本_V.適用終了日                     IS '適用終了日'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク振替運賃_基本_V.設定単価                       IS '設定単価'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク振替運賃_基本_V.ペナルティ単価                 IS 'ペナルティ単価'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク振替運賃_基本_V.作成者                         IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク振替運賃_基本_V.作成日                         IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク振替運賃_基本_V.最終更新者                     IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク振替運賃_基本_V.最終更新日                     IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク振替運賃_基本_V.最終更新ログイン               IS '最終更新ログイン'
/
