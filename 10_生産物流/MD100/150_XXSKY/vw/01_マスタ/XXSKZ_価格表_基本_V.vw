/*************************************************************************
 * 
 * View  Name      : XXSKZ_価格表_基本_V
 * Description     : XXSKZ_価格表_基本_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 ************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_価格表_基本_V
(
 価格表名
,仕入先コード
,仕入先名
...
/
COMMENT ON TABLE APPS.XXSKZ_価格表_基本_V IS 'SKYLINK用価格表（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.価格表名         IS '価格表名'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.仕入先コード     IS '仕入先コード'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.仕入先名         IS '仕入先名'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.仕入先略称       IS '仕入先略称'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.適用開始日       IS '適用開始日'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.適用終了日       IS '適用終了日'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.通貨             IS '通貨'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.通貨名           IS '通貨名'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.丸め処理先       IS '丸め処理先'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.有効フラグ       IS '有効フラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.商品区分         IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.商品区分名       IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.品目区分         IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.品目区分名       IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.群コード         IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.品目コード       IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.品目名           IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.品目略称         IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.明細_適用開始日  IS '明細_適用開始日'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.明細_適用終了日  IS '明細_適用終了日'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.単位             IS '単位'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.基準単位         IS '基準単位'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.適用方法         IS '適用方法'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.適用方法名       IS '適用方法名'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.値               IS '値'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.作成者           IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.作成日           IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.最終更新者       IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.最終更新日       IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKZ_価格表_基本_V.最終更新ログイン IS '最終更新ログイン'
/