CREATE OR REPLACE VIEW APPS.XXSKY_品目マスタ_基本_V
(
 品目コード
,品目名
,品目略称
...
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.品目コード             IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.品目名                 IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.品目略称               IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.品目カナ名             IS '品目カナ名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.適用開始日             IS '適用開始日'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.適用終了日             IS '適用終了日'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.適用済フラグ           IS '適用済フラグ'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.無効フラグ             IS '無効フラグ'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.無効フラグ名           IS '無効フラグ名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.単位                   IS '単位'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.ロット管理区分         IS 'ロット管理区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.ロット管理区分名       IS 'ロット管理区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.倉庫品目コード         IS '倉庫品目コード'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.倉庫品目名             IS '倉庫品目名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.倉庫品目略称           IS '倉庫品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.旧_群コード            IS '旧_群コード'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.新_群コード            IS '新_群コード'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.群コード適用開始日     IS '群コード適用開始日'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.旧_定価                IS '旧_定価'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.新_定価                IS '新_定価'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.定価適用開始日         IS '定価適用開始日'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.旧_営業原価            IS '旧_営業原価'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.新_営業原価            IS '新_営業原価'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.営業原価適用開始日     IS '営業原価適用開始日'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.売上対象区分           IS '売上対象区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.売上対象区分名         IS '売上対象区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.発売製造開始日         IS '発売製造開始日'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.JANｺｰﾄﾞ                IS 'JANｺｰﾄﾞ'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.ITFコード              IS 'ITFコード'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.ケース入数             IS 'ケース入数'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.NET                    IS 'NET'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.重量容積区分           IS '重量容積区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.重量容積区分名         IS '重量容積区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.重量                   IS '重量'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.容積                   IS '容積'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.仕向区分               IS '仕向区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.仕向区分名             IS '仕向区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.出荷区分               IS '出荷区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.出荷区分名             IS '出荷区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.原価管理区分           IS '原価管理区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.原価管理区分名         IS '原価管理区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.仕入単価導出日タイプ   IS '仕入単価導出日タイプ'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.仕入単価導出日タイプ名 IS '仕入単価導出日タイプ名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.代表入数               IS '代表入数'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.入出庫換算単位         IS '入出庫換算単位'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.試験有無区分           IS '試験有無区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.試験有無区分名         IS '試験有無区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.検査LT                 IS '検査LT'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.判定回数               IS '判定回数'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.発注可能判定回数       IS '発注可能判定回数'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.マスタ受信日時         IS 'マスタ受信日時'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.自動ロット採番有効     IS '自動ロット採番有効'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.親品目コード           IS '親品目コード'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.親品目名               IS '親品目名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.親品目略称             IS '親品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.廃止区分               IS '廃止区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.廃止区分名             IS '廃止区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.廃止_製造中止日        IS '廃止_製造中止日'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.型種別                 IS '型種別'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.型種別名               IS '型種別名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.商品分類               IS '商品分類'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.商品分類名             IS '商品分類名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.商品種別               IS '商品種別'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.商品種別名             IS '商品種別名'
/
...
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.標準歩留               IS '標準歩留'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.出荷停止日             IS '出荷停止日'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.率区分                 IS '率区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.率区分名               IS '率区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.消費期間               IS '消費期間'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.賞味期間区分           IS '賞味期間区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.賞味期間区分名         IS '賞味期間区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.容器区分               IS '容器区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.容器区分名             IS '容器区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.単位区分               IS '単位区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.単位区分名             IS '単位区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.棚卸区分               IS '棚卸区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.棚卸区分名             IS '棚卸区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.トレース区分           IS 'トレース区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.トレース区分名         IS 'トレース区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.出荷入数               IS '出荷入数'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.配数                   IS '配数'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.パレット当り最大段数   IS 'パレット当り最大段数'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.パレット段             IS 'パレット段'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.ケース重量容積         IS 'ケース重量容積'
/
...
-- 2016/11/25 K.Kiriu Add End   E_本稼動_09591
-- 2018/10/29 N.Koyama Add Start E_本稼動_15277
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.ロット逆転区分         IS 'ロット逆転区分'
/
...
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.最終更新者             IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.最終更新日             IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKY_品目マスタ_基本_V.最終更新ログイン       IS '最終更新ログイン'
/
