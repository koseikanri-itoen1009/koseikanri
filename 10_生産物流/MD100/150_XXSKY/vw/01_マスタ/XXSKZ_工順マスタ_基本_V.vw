/*************************************************************************
 * 
 * View  Name      : XXSKZ_工順マスタ_基本_V
 * Description     : XXSKZ_工順マスタ_基本_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 ************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_工順マスタ_基本_V
(
 工順番号
,工順名
,工順略称
...
/
COMMENT ON TABLE APPS.XXSKZ_工順マスタ_基本_V IS 'SKYLINK用工順マスタ（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.工順番号                       IS '工順番号'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.工順名                         IS '工順名'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.工順略称                       IS '工順略称'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.有効_自                        IS '有効_自'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.有効_至                        IS '有効_至'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.削除フラグ                     IS '削除フラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.削除フラグ名                   IS '削除フラグ名'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.区分                           IS '区分'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.区分名                         IS '区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.ライン区分                     IS 'ライン区分'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.ライン区分名                   IS 'ライン区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.ステータス                     IS 'ステータス'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.ステータス名                   IS 'ステータス名'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.計画損失                       IS '計画損失'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.数量                           IS '数量'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.単位                           IS '単位'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.取引先                         IS '取引先'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.取引先名                       IS '取引先名'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.賃率                           IS '賃率'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.標準能力                       IS '標準能力'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.MIN能力                        IS 'MIN能力'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.MAX能力                        IS 'MAX能力'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.納品場所                       IS '納品場所'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.納品場所名                     IS '納品場所名'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.工場区分                       IS '工場区分'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.工場区分名                     IS '工場区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.工場内ライン配分率             IS '工場内ライン配分率'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.リードタイム                   IS 'リードタイム'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.伝票区分                       IS '伝票区分'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.伝票区分名                     IS '伝票区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.成績管理部署                   IS '成績管理部署'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.成績管理部署名                 IS '成績管理部署名'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.内外区分                       IS '内外区分'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.内外区分名                     IS '内外区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.製造品区分                     IS '製造品区分'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.製造品区分名                   IS '製造品区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.新缶煎区分                     IS '新缶煎区分'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.新缶煎区分名                   IS '新缶煎区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.HHT送信対象フラグ              IS 'HHT送信対象フラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.HHT送信対象フラグ名            IS 'HHT送信対象フラグ名'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.固有記号                       IS '固有記号'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.固有記号名                     IS '固有記号名'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.作業部署                       IS '作業部署'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.作業部署名                     IS '作業部署名'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.納品倉庫                       IS '納品倉庫'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.納品倉庫名                     IS '納品倉庫名'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.作成者                         IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.作成日                         IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.最終更新者                     IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.最終更新日                     IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKZ_工順マスタ_基本_V.最終更新ログイン               IS '最終更新ログイン'
/
