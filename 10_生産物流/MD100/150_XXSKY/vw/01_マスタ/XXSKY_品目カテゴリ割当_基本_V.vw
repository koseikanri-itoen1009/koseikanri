CREATE OR REPLACE VIEW APPS.XXSKY_品目カテゴリ割当_基本_V
(
 品目コード
,品目名
,品目略称
...
-- 2010/01/28 T.Yoshimoto Del End 本稼動#1168
/
COMMENT ON TABLE APPS.XXSKY_品目カテゴリ割当_基本_V IS 'SKYLINK用品目カテゴリ割当（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.品目コード        IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.品目名            IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.品目略称          IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.品目カナ名        IS '品目カナ名'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.適用開始日        IS '適用開始日'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.適用終了日        IS '適用終了日'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.無効フラグ        IS '無効フラグ'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.無効フラグ名      IS '無効フラグ名'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.群コード          IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.政策群コード      IS '政策群コード'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.マーケ用群コード  IS 'マーケ用群コード'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.経理部用群コード  IS '経理部用群コード'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.商品製品区分      IS '商品製品区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.商品製品区分名    IS '商品製品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.商品区分          IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.商品区分名        IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.本社商品区分      IS '本社商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.本社商品区分名    IS '本社商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.品目区分          IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.品目区分名        IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.品質区分          IS '品質区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.品質区分名        IS '品質区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.バラ茶区分        IS 'バラ茶区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.バラ茶区分名      IS 'バラ茶区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.内外区分          IS '内外区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.内外区分名        IS '内外区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.作成者            IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.作成日            IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.最終更新者        IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.最終更新日        IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKY_品目カテゴリ割当_基本_V.最終更新ログイン  IS '最終更新ログイン'
/
