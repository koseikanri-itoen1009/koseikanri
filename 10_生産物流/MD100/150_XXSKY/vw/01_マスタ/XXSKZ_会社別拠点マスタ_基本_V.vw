/*******************************************************************************
 * 
 * View  Name      : XXSKZ_会社別拠点マスタ_基本_V
 * Description     : XXSKZ_会社別拠点マスタ_基本_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 ******************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_会社別拠点マスタ_基本_V
(
 組織番号
,組織_ステータス
,組織_ステータス名
...
/
COMMENT ON TABLE APPS.XXSKZ_会社別拠点マスタ_基本_V IS 'SKYLINK用会社別拠点マスタ（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.組織番号 IS '組織番号'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.組織_ステータス IS '組織_ステータス'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.組織_ステータス名 IS '組織_ステータス名'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客拠点_マスタ受信日 IS '顧客拠点_マスタ受信日'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客拠点_マスタ受信日 IS '顧客拠点_会社コード'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客拠点_マスタ受信日 IS '顧客拠点_会社名'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客拠点_番号 IS '顧客拠点_番号'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客拠点_名称 IS '顧客拠点_名称'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客拠点_略称 IS '顧客拠点_略称'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客拠点_カナ名 IS '顧客拠点_カナ名'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客拠点_ステータス IS '顧客拠点_ステータス'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客拠点_ステータス名 IS '顧客拠点_ステータス名'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客拠点_区分 IS '顧客拠点_区分'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客拠点_区分名 IS '顧客拠点_区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客拠点_適用開始日 IS '顧客拠点_適用開始日'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客拠点_適用終了日 IS '顧客拠点_適用終了日'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客拠点_郵便番号 IS '顧客拠点_郵便番号'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客拠点_住所１ IS '顧客拠点_住所１'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客拠点_住所２ IS '顧客拠点_住所２'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客拠点_電話番号 IS '顧客拠点_電話番号'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客拠点_FAX番号 IS '顧客拠点_FAX番号'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_引当順 IS '拠点_引当順'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_ドリンク運賃振替基準 IS '拠点_ドリンク運賃振替基準'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_ドリンク運賃振替基準名 IS '拠点_ドリンク運賃振替基準名'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_リーフ運賃振替基準 IS '拠点_リーフ運賃振替基準'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_リーフ運賃振替基準名 IS '拠点_リーフ運賃振替基準名'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_振替グループ IS '拠点_振替グループ'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_振替グループ名 IS '拠点_振替グループ名'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_物流ブロック IS '拠点_物流ブロック'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_物流ブロック名 IS '拠点_物流ブロック名'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_拠点大分類 IS '拠点_拠点大分類'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_拠点大分類名 IS '拠点_拠点大分類名'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_旧本部コード IS '拠点_旧本部コード'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_新本部コード IS '拠点_新本部コード'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_本部適用開始日 IS '拠点_本部適用開始日'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_実績有無区分 IS '拠点_実績有無区分'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_実績有無区分名 IS '拠点_実績有無区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_出荷管理元区分 IS '拠点_出荷管理元区分'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_出荷管理元区分名 IS '拠点_出荷管理元区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_倉替対象可否区分 IS '拠点_倉替対象可否区分'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_倉替対象可否区分名 IS '拠点_倉替対象可否区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客拠点_中止客申請フラグ IS '顧客拠点_中止客申請フラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客拠点_中止客申請フラグ名 IS '顧客拠点_中止客申請フラグ名'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_ドリンク拠点カテゴリ IS '拠点_ドリンク拠点カテゴリ'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_ドリンク拠点カテゴリ名 IS '拠点_ドリンク拠点カテゴリ名'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_リーフ拠点カテゴリ IS '拠点_リーフ拠点カテゴリ'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_リーフ拠点カテゴリ名 IS '拠点_リーフ拠点カテゴリ名'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_出荷依頼自動作成区分 IS '拠点_出荷依頼自動作成区分'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.拠点_出荷依頼自動作成区分名 IS '拠点_出荷依頼自動作成区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客_直送区分 IS '顧客_直送区分'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客_直送区分名 IS '顧客_直送区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客_当月売上拠点コード IS '顧客_当月売上拠点コード'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客_当月売上拠点名 IS '顧客_当月売上拠点名'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客_予約売上拠点コード IS '顧客_予約売上拠点コード'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客_予約売上拠点名 IS '顧客_予約売上拠点名'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客_売上チェーン店 IS '顧客_売上チェーン店'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.顧客_売上チェーン店名 IS '顧客_売上チェーン店名'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.作成者 IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.作成日 IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.最終更新者 IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.最終更新日 IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKZ_会社別拠点マスタ_基本_V.最終更新ログイン IS '最終更新ログイン'
/
