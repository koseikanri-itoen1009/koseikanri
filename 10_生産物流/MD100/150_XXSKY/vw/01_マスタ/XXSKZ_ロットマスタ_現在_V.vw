/*************************************************************************
 * 
 * View  Name      : XXSKZ_ロットマスタ_現在_V
 * Description     : XXSKZ_ロットマスタ_現在_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 ************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_ロットマスタ_現在_V
(
 商品区分
,商品区分名
,品目区分
...
/
COMMENT ON TABLE APPS.XXSKZ_ロットマスタ_現在_V IS 'SKYLINK用ロットマスタ（現在）VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.商品区分                       IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.商品区分名                     IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.品目区分                       IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.品目区分名                     IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.群コード                       IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.品目コード                     IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.品目名                         IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.品目略称                       IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.ロット番号                     IS 'ロット番号'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.製造年月日                     IS '製造年月日'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.固有記号                       IS '固有記号'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.賞味期限                       IS '賞味期限'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.納入日_初回                    IS '納入日_初回'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.納入日_最終                    IS '納入日_最終'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.在庫入数                       IS '在庫入数'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.在庫単価                       IS '在庫単価'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.取引先                         IS '取引先'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.取引先名                       IS '取引先名'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.仕入形態                       IS '仕入形態'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.仕入形態名                     IS '仕入形態名'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.茶期区分                       IS '茶期区分'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.茶期区分名                     IS '茶期区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.年度                           IS '年度'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.産地                           IS '産地'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.産地名                         IS '産地名'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.タイプ                         IS 'タイプ'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.ランク１                       IS 'ランク１'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.ランク２                       IS 'ランク２'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.ランク３                       IS 'ランク３'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.生産伝票区分                   IS '生産伝票区分'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.生産伝票区分名                 IS '生産伝票区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.ラインNO                       IS 'ラインNo'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.摘要                           IS '摘要'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.原料製造工場                   IS '原料製造工場'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.原料製造元ロット番号           IS '原料製造元ロット番号'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.検査依頼NO                     IS '検査依頼No'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.ロットステータス               IS 'ロットステータス'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.ロットステータス名             IS 'ロットステータス名'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.作成区分                       IS '作成区分'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.作成区分名                     IS '作成区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.作成者                         IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.作成日                         IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.最終更新者                     IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.最終更新日                     IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKZ_ロットマスタ_現在_V.最終更新ログイン               IS '最終更新ログイン'
/
