/*************************************************************************
 * 
 * View  Name      : XXSKZ_仕入単価明細_現在_V
 * Description     : XXSKZ_仕入単価明細_現在_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 ************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_仕入単価明細_現在_V
(
 商品区分
,商品区分名
,品目区分
...
/
COMMENT ON TABLE APPS.XXSKZ_仕入単価明細_現在_V IS 'SKYLINK用仕入単価明細（現在）VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.商品区分                       IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.商品区分名                     IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.品目区分                       IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.品目区分名                     IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.群コード                       IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.内訳品目コード                 IS '内訳品目コード'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.内訳品目名                     IS '内訳品目名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.内訳品目略称                   IS '内訳品目略称'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.付帯コード                     IS '付帯コード'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.メーカーコード                 IS 'メーカーコード'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.メーカー名                     IS 'メーカー名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.費目区分                       IS '費目区分'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.費目区分名                     IS '費目区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.項目区分                       IS '項目区分'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.項目区分名                     IS '項目区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.数量                           IS '数量'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.数量単位                       IS '数量単位'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.単価                           IS '単価'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.単価単位                       IS '単価単位'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.歩留率                         IS '歩留率'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.仕入単価                       IS '仕入単価'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.演算区分                       IS '演算区分'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.演算区分名                     IS '演算区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.実質単価                       IS '実質単価'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.ヘッダID                       IS 'ヘッダID'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.作成者                         IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.作成日                         IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.最終更新者                     IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.最終更新日                     IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入単価明細_現在_V.最終更新ログイン               IS '最終更新ログイン'
/
