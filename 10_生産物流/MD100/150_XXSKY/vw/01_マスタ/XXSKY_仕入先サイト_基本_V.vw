CREATE OR REPLACE VIEW APPS.XXSKY_仕入先サイト_基本_V
(
 仕入先コード
,仕入先名
,仕入先サイトコード
...
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.仕入先コード       IS '仕入先コード'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.仕入先名           IS '仕入先名'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.仕入先サイトコード IS '仕入先サイトコード'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.仕入先サイト名     IS '仕入先サイト名'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.仕入先サイト略称   IS '仕入先サイト略称'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.仕入先サイトカナ名 IS '仕入先サイトカナ名'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.適用開始日         IS '適用開始日'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.適用終了日         IS '適用終了日'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.郵便番号           IS '郵便番号'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.住所１             IS '住所１'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.住所２             IS '住所２'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.電話番号           IS '電話番号'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.FAX番号            IS 'FAX番号'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.相手先在庫入庫先   IS '相手先在庫入庫先'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.相手先在庫入庫先名 IS '相手先在庫入庫先名'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.発注納入先         IS '発注納入先'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.発注納入先名       IS '発注納入先名'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.備考               IS '備考'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.作成者             IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.作成日             IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.最終更新者         IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.最終更新日         IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKY_仕入先サイト_基本_V.最終更新ログイン   IS '最終更新ログイン'
/
