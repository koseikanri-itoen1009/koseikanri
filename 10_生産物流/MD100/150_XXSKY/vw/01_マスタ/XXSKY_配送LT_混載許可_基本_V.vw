CREATE OR REPLACE VIEW APPS.XXSKY_配送LT_混載許可_基本_V
(
 コード区分１
,コード区分名１
,入出庫場所コード１
...
-- 2010/01/28 T.Yoshimoto Del End 本稼動#1168
/
COMMENT ON TABLE APPS.XXSKY_配送LT_混載許可_基本_V IS 'SKYLINK用配送LTマスタ_混載許可（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.コード区分１        IS 'コード区分１'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.コード区分名１      IS 'コード区分名１'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.入出庫場所コード１  IS '入出庫場所コード１'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.入出庫場所名１      IS '入出庫場所名１'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.コード区分２        IS 'コード区分２'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.コード区分名２      IS 'コード区分名２'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.入出庫場所コード２  IS '入出庫場所コード２'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.入出庫場所名２      IS '入出庫場所名２'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.配送LT_適用開始日   IS '配送LT_適用開始日'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.配送LT_適用終了日   IS '配送LT_適用終了日'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.配送リードタイム    IS '配送リードタイム'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.ドリンク生産物流LT  IS 'ドリンク生産物流LT'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.リーフ生産物流LT    IS 'リーフ生産物流LT'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.引取変更LT          IS '引取変更LT'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.出荷方法            IS '出荷方法'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.出荷方法名          IS '出荷方法名'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.出荷方法_適用開始日 IS '出荷方法_適用開始日'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.出荷方法_適用終了日 IS '出荷方法_適用終了日'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.ドリンク積載重量    IS 'ドリンク積載重量'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.リーフ積載重量      IS 'リーフ積載重量'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.ドリンク積載容積    IS 'ドリンク積載容積'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.リーフ積載容積      IS 'リーフ積載容積'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.パレット最大枚数    IS 'パレット最大枚数'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.作成者              IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.作成日              IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.最終更新者          IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.最終更新日          IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKY_配送LT_混載許可_基本_V.最終更新ログイン    IS '最終更新ログイン'
/
