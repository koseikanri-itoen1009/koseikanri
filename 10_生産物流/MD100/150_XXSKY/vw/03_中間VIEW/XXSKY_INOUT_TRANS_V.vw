...
--     ・XXSKY_入出庫情報_発日_V
--*******************************************************************
CREATE OR REPLACE VIEW APPS.XXSKY_INOUT_TRANS_V
(
 reason_code
,whse_code
,location_code
...
-- << 出庫実績 END >>
/
COMMENT ON TABLE APPS.XXSKY_INOUT_TRANS_V IS 'XXSKY_入出庫情報_中間VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.reason_code       IS '事由コード'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.whse_code         IS '倉庫コード'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.location_code     IS '保管場所コード'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.location          IS '保管場所名'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.location_s_name   IS '保管場所略称'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.item_id           IS '品目ID'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.item_no           IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.item_name         IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.item_short_name   IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.case_content      IS 'ケース入数'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.lot_ctl           IS 'ロット管理区分'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.lot_no            IS 'ロットNo'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.lot_id            IS 'ロットID'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.manufacture_date  IS '製造年月日'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.uniqe_sign        IS '固有記号'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.expiration_date   IS '賞味期限'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.voucher_no        IS '伝票番号'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.line_no           IS '行番号'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.delivery_no       IS '配送番号'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.loct_code         IS '部署コード'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.loct_name         IS '部署名'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.in_out_kbn        IS '入出庫区分'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.leaving_date      IS '入出庫日_発日'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.arrival_date      IS '入出庫日_着日'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.standard_date     IS '基準日'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.ukebaraisaki_code IS '受払先コード'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.ukebaraisaki_name IS '受払先名'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.status            IS '予定実績区分'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.deliver_to_no     IS '配送先コード'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.deliver_to_name   IS '配送先名'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.stock_quantity    IS '入庫数'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.leaving_quantity  IS '出庫数'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_TRANS_V.quantity          IS '入出庫数'
/
