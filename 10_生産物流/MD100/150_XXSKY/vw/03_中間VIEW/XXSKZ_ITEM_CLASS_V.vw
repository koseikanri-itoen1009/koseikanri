...
/
COMMENT ON TABLE APPS.XXSKZ_ITEM_CLASS_V                   IS 'SKYLINK用中間VIEW OPM品目区分VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_ITEM_CLASS_V.ITEM_ID          IS '品目ID'
/
COMMENT ON COLUMN APPS.XXSKZ_ITEM_CLASS_V.ITEM_CLASS_CODE  IS '品目区分コード'
/
COMMENT ON COLUMN APPS.XXSKZ_ITEM_CLASS_V.ITEM_CLASS_NAME  IS '品目区分名'
/
