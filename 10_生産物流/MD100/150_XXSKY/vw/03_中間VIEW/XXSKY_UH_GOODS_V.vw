...
--     ・XXSKY_受払情報_製品_数量_V
--*******************************************************************
CREATE OR REPLACE VIEW APPS.XXSKY_UH_GOODS_V
(
 whse_code
,item_id
,lot_id
...
-- 2010/02/16 T.Yoshimoto Del End 本稼動#1168
/
COMMENT ON TABLE APPS.XXSKY_UH_GOODS_V IS 'XXSKY_受払情報_製品_中間VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_UH_GOODS_V.whse_code  IS '倉庫コード'
/
COMMENT ON COLUMN APPS.XXSKY_UH_GOODS_V.item_id    IS '品目ID'
/
COMMENT ON COLUMN APPS.XXSKY_UH_GOODS_V.lot_id     IS 'ロットID'
/
COMMENT ON COLUMN APPS.XXSKY_UH_GOODS_V.trans_qty  IS '受払数'
/
COMMENT ON COLUMN APPS.XXSKY_UH_GOODS_V.column_no  IS '項目番号'
/
COMMENT ON COLUMN APPS.XXSKY_UH_GOODS_V.trans_date IS '取引日'
/
