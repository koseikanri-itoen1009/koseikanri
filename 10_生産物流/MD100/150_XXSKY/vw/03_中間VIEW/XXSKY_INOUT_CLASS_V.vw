...
/
COMMENT ON TABLE APPS.XXSKY_INOUT_CLASS_V                      IS 'SKYLINK用中間VIEW OPM内外区分VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_CLASS_V.ITEM_ID             IS '品目ID'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_CLASS_V.INOUT_CLASS_CODE    IS '内外区分コード'
/
COMMENT ON COLUMN APPS.XXSKY_INOUT_CLASS_V.INOUT_CLASS_NAME    IS '内外区分名'
/
