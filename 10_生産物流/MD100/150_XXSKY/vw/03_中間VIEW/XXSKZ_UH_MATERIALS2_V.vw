/*************************************************************************
 * 
 * View  Name      : XXSKZ_UH_MATERIALS2_V
 * Description     : XXSKZ_UH_MATERIALS2_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
...
-- 受払情報_製品以外 中間VIEW
--   【使用対象VIEW】
--     ・XXSKZ_受払情報_製品以外_基本_V
--     ・XXSKZ_受払情報_製品以外_数量_V
--*******************************************************************
CREATE OR REPLACE VIEW APPS.XXSKZ_UH_MATERIALS2_V
(
 whse_code
,item_id
,lot_id
...
-- 2009/12/21 T.Yoshimoto Mod End
      ...
      FROM   xxcmn_ic_tran_pnd_arc            itp
            ,ic_xfer_mst                      ixm
            ,xxcmn_mov_req_instr_hdrs_arc     xmrh
...
-- 2009/12/21 T.Yoshimoto Mod End
      ...
      AND    xmrih.actual_arrival_date >= ADD_MONTHS(trunc(sysdate,'MM'), -2)   -- H.Itou Add 2009/12/17
      AND    xmrih.actual_arrival_date <  ADD_MONTHS(trunc(sysdate,'MM'),  1)   -- H.Itou Add 2009/12/17
      UNION ALL
      -- 倉庫移動
      -- ----------------------------------------------------
      -- TRNI :経理受払区分移動積送なし
...
/
COMMENT ON TABLE APPS.XXSKZ_UH_MATERIALS2_V IS 'XXSKZ_受払情報_製品以外_中間VIEW2'
/
COMMENT ON COLUMN APPS.XXSKZ_UH_MATERIALS2_V.whse_code  IS '倉庫コード'
/
COMMENT ON COLUMN APPS.XXSKZ_UH_MATERIALS2_V.item_id    IS '品目ID'
/
COMMENT ON COLUMN APPS.XXSKZ_UH_MATERIALS2_V.lot_id     IS 'ロットID'
/
COMMENT ON COLUMN APPS.XXSKZ_UH_MATERIALS2_V.trans_qty  IS '受払数'
/
COMMENT ON COLUMN APPS.XXSKZ_UH_MATERIALS2_V.column_no  IS '項目番号'
/
COMMENT ON COLUMN APPS.XXSKZ_UH_MATERIALS2_V.trans_date IS '取引日'
/
