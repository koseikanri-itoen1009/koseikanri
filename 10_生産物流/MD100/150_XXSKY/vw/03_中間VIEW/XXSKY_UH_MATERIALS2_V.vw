...
--*******************************************************************
CREATE OR REPLACE VIEW APPS.XXSKY_UH_MATERIALS2_V
(
 whse_code
,item_id
,lot_id
...
/
COMMENT ON TABLE APPS.XXSKY_UH_MATERIALS2_V IS 'XXSKY_受払情報_製品以外_中間VIEW2'
/
COMMENT ON COLUMN APPS.XXSKY_UH_MATERIALS2_V.whse_code  IS '倉庫コード'
/
COMMENT ON COLUMN APPS.XXSKY_UH_MATERIALS2_V.item_id    IS '品目ID'
/
COMMENT ON COLUMN APPS.XXSKY_UH_MATERIALS2_V.lot_id     IS 'ロットID'
/
COMMENT ON COLUMN APPS.XXSKY_UH_MATERIALS2_V.trans_qty  IS '受払数'
/
COMMENT ON COLUMN APPS.XXSKY_UH_MATERIALS2_V.column_no  IS '項目番号'
/
COMMENT ON COLUMN APPS.XXSKY_UH_MATERIALS2_V.trans_date IS '取引日'
/
