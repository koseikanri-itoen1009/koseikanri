...
--     ・XXSKZ_入出庫予実_発日_V
--*******************************************************************
CREATE OR REPLACE VIEW APPS.XXSKZ_INOUT_YJ_TRANS_V
(
 reason_code
,whse_code
,location_code
...
-- 2010/03/11 T.Yoshimoto Mod Start 本稼動#1168
         ...
         --      FROM
         --            xxskz_item_mst2_v                  ximv_in_po2               -- OPM品目情報VIEW
...
UNION ALL
  ...
  SELECT
    ...
    FROM
         ...
         ,xxcmn_mov_lot_details_arc                     xmld_in_xf                -- 移動ロット詳細(アドオン)
...
UNION ALL
  ...
  SELECT
    ...
    FROM
         ...
         ,xxcmn_mov_lot_details_arc                     xmld_in_tr                -- 移動ロット詳細(アドオン)
...
UNION ALL
  ...
  SELECT
    ...
    FROM
         ...
         ,xxcmn_mov_lot_details_arc                     xmld_in_xf20              -- 移動ロット詳細(アドオン)
...
UNION ALL
  ...
  SELECT
    ...
    FROM
         ...
         ,xxcmn_ic_tran_pnd_arc                         itp_in_pr                 -- OPM保留在庫トランザクション
   WHERE
     -- 受払区分アドオンマスタの条件
...
UNION ALL
  ...
  SELECT
    ...
    FROM
         ...
         ,xxcmn_ic_tran_pnd_arc                         itp_in_pr70               -- OPM保留在庫トランザクション
...
--■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
  ...
  SELECT
    ...
    FROM
         ...
         ,xxcmn_mov_lot_details_arc                     xmld_out_xf               -- 移動ロット詳細(アドオン)
...
UNION ALL
  ...
  SELECT
    ...
    FROM
         ...
         ,xxcmn_mov_lot_details_arc                     xmld_out_tr               -- 移動ロット詳細(アドオン)
...
UNION ALL
  ...
  SELECT
    ...
    FROM
         ...
         ,xxcmn_mov_lot_details_arc                     xmld_out_xf20             -- 移動ロット詳細(アドオン)
...
UNION ALL
  ...
  SELECT
    ...
    FROM
         ...
         ,xxcmn_mov_lot_details_arc                     xmld_out_om               -- 移動ロット詳細(アドオン)
...
UNION ALL
  ...
  SELECT
    ...
    FROM
         ...
         ,xxcmn_mov_lot_details_arc                     xmld_out_om2              -- 移動ロット詳細(アドオン)
...
UNION ALL
  ...
  SELECT
    ...
    FROM
         ...
         ,xxcmn_ic_tran_pnd_arc                         itp_out_pr                -- OPM保留在庫トランザクション
   WHERE
     --受払区分アドオンマスタの条件
...
UNION ALL
  ...
  SELECT
    ...
    FROM
         ...
         ,xxcmn_ic_tran_pnd_arc                         itp_out_pr70              -- OPM保留在庫トランザクション
...
--               FROM
--                     xxskz_item_mst2_v                  ximv_out_ad2              -- OPM品目情報VIEW
...
UNION ALL
  ...
  SELECT
    ...
    FROM
         ...
         ,xxcmn_mov_lot_details_arc                     xmld_in_xf_e              -- 移動ロット詳細(アドオン)
...
UNION ALL
  ...
  SELECT
    ...
    FROM
         ...
         ,xxcmn_mov_lot_details_arc                     xmld_in_tr_e              -- 移動ロット詳細(アドオン)
...
UNION ALL
  ...
  SELECT
    ...
    FROM
         ...
         ,xxcmn_ic_tran_pnd_arc                         itp_in_pr_e               -- OPM保留在庫トランザクション
   WHERE
     -- 受払区分アドオンマスタの条件
...
UNION ALL
  ...
  SELECT
    ...
    FROM
         ...
         ,xxcmn_mov_lot_details_arc                     xmld_in_po_e_rma          -- 移動ロット詳細(アドオン)
         ...
         ,(  -- 対象データを集計
             SELECT
               ...
               FROM
                    ...
                    ,xxcmn_ic_tran_cmp_arc              itc_in_ad_e_x97           -- OPM完了在庫トランザクション
...
--                    ,xxcmn_ic_tran_cmp_arc              itc_in_ad_e_x9            -- OPM完了在庫トランザクション
...
--                    ,xxcmn_ic_tran_cmp_arc                itc_in_ad_e_x2          -- OPM完了在庫トランザクション
         ...
         ,(  -- 対象データを集計
             SELECT
               ...
               FROM
                    ...
                    ,xxcmn_ic_tran_cmp_arc              itc_in_ad_e_xx            -- OPM完了在庫トランザクション
              WHERE
                -- 受払区分アドオンマスタの条件
...
--■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
  ...
  SELECT
    ...
    FROM
         ...
         ,xxcmn_mov_lot_details_arc                     xmld_out_xf_e             -- 移動ロット詳細(アドオン)
...
UNION ALL
  ...
  SELECT
    ...
    FROM
         ...
         ,xxcmn_mov_lot_details_arc                     xmld_out_tr_e             -- 移動ロット詳細(アドオン)
...
UNION ALL
  ...
  SELECT
    ...
    FROM
         ...
         ,xxcmn_ic_tran_pnd_arc                         itp_out_pr_e              -- OPM保留在庫トランザクション
   WHERE
     --受払区分アドオンマスタの条件
...
UNION ALL
  ...
  SELECT
    ...
    FROM
         ...
         ,xxcmn_mov_lot_details_arc                     xmld_out_om_e             -- 移動ロット詳細(アドオン)
...
-- *----------* 2009/04/23 M.Nomura update end   *----------*
    ...
    FROM
         ...
         ,xxcmn_mov_lot_details_arc                     xmld_out_om2_e            -- 移動ロット詳細(アドオン)
...
UNION ALL
  ...
  SELECT
    ...
    FROM
         ...
         ,xxcmn_mov_lot_details_arc                     xmld_out_om3_e            -- 移動ロット詳細(アドオン)
         ...
         ,(  -- 対象データを集計
             SELECT
               ...
               FROM
                    ...
                    ,xxcmn_ic_tran_cmp_arc              itc_out_ad_e_x97          -- OPM完了在庫トランザクション
    ...
    FROM
         ...
         ,(  -- 対象データを集計
             SELECT
               ...
               FROM
                     xxcmn_rcv_pay_mst                  xrpm_out_ad_e_x97         -- 受払区分アドオンマスタ
                    ,xxcmn_ic_tran_cmp_arc              itc_out_ad_e_x97          -- OPM完了在庫トランザクション -- <---- ここまで共通
                    ,ic_jrnl_mst                        ijm_out_ad_e_x97          -- OPMジャーナルマスタ
                    ,ic_adjs_jnl                        iaj_out_ad_e_x97          -- OPM在庫調整ジャーナル
         ...
         ,(  -- 対象データを集計
             SELECT
               ...
               FROM
                    ...
                    ,xxcmn_ic_tran_cmp_arc              itc_out_ad_e_xx           -- OPM完了在庫トランザクション
              WHERE
                --受払区分アドオンマスタの条件
...
-- << 出庫実績 END >>
/
COMMENT ON TABLE APPS.XXSKZ_INOUT_YJ_TRANS_V IS 'XXSKZ_入出庫予実_中間VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.reason_code       IS '事由コード'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.whse_code         IS '倉庫コード'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.location_code     IS '保管場所コード'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.location          IS '保管場所名'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.location_s_name   IS '保管場所略称'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.item_id           IS '品目ID'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.item_no           IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.item_name         IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.item_short_name   IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.case_content      IS 'ケース入数'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.lot_ctl           IS 'ロット管理区分'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.lot_no            IS 'ロットNo'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.lot_id            IS 'ロットID'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.manufacture_date  IS '製造年月日'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.uniqe_sign        IS '固有記号'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.expiration_date   IS '賞味期限'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.voucher_no        IS '伝票番号'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.line_no           IS '行番号'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.delivery_no       IS '配送番号'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.loct_code         IS '部署コード'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.loct_name         IS '部署名'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.in_out_kbn        IS '入出庫区分'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.leaving_date      IS '入出庫日_発日'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.arrival_date      IS '入出庫日_着日'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.standard_date     IS '基準日'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.ukebaraisaki_code IS '受払先コード'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.ukebaraisaki_name IS '受払先名'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.status            IS '予定実績区分'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.deliver_to_no     IS '配送先コード'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.deliver_to_name   IS '配送先名'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.stock_quantity    IS '入庫数'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.leaving_quantity  IS '出庫数'
/
COMMENT ON COLUMN APPS.XXSKZ_INOUT_YJ_TRANS_V.quantity          IS '入出庫数'
/
