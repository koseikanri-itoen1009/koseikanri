...
/
COMMENT ON TABLE APPS.XXSKY_CROWD_CODE_V               IS 'SKYLINK用中間VIEW  OPM品目区分VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_CROWD_CODE_V.ITEM_ID      IS '品目ID'
/
COMMENT ON COLUMN APPS.XXSKY_CROWD_CODE_V.CROWD_CODE   IS '群コード'
/
