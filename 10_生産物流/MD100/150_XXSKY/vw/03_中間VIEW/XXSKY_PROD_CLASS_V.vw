CREATE OR REPLACE VIEW APPS.XXSKY_PROD_CLASS_V
    (ITEM_ID
    ,PROD_CLASS_CODE
    ,PROD_CLASS_NAME
    )
...
/
COMMENT ON TABLE APPS.XXSKY_PROD_CLASS_V IS 'SKYLINK用中間VIEW OPM品目区分VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_PROD_CLASS_V.ITEM_ID          IS '品目ID'
/
COMMENT ON COLUMN APPS.XXSKY_PROD_CLASS_V.PROD_CLASS_CODE  IS '商品区分コード'
/
COMMENT ON COLUMN APPS.XXSKY_PROD_CLASS_V.PROD_CLASS_NAME  IS '商品区分名'
/
