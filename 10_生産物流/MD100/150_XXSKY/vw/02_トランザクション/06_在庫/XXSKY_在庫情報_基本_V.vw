CREATE OR REPLACE VIEW APPS.XXSKY_在庫情報_基本_V
(
 当月
,名義コード
,名義
             ...
             FROM  (
                    ...
                    --======================================================================
                      ...
                      SELECT  ITC.whse_code                 whse_code           --倉庫コード
                             ...
                             ,0                             sch_in_qty          --入庫予定数
                             ,0                             sch_out_qty         --出庫予定数
                        FROM  ic_tran_cmp                   ITC     --OPM完了トランザクション
                             ,(  --直近のクローズ在庫会計期間の次月(当月)の末日を取得
                                 SELECT  ADD_MONTHS( MAX( ICD2.period_end_date ), 1 )  this_last_day
                                   FROM  ic_cldr_dtl        ICD2
                                  WHERE  ICD2.orgn_code     = 'ITOE'
                    ...
                    UNION ALL
                      ...
                      SELECT  ITP.whse_code                 whse_code           --倉庫コード
                        ...
                        FROM  ic_tran_pnd                   ITP                 --OPM保留トランザクション
                             ...
                             ,oe_order_headers_all          OHA                 --受注ヘッダ(EBS標準)
                    ...
                    UNION ALL
                      ...
                      SELECT  XILV.whse_code                whse_code           --倉庫コード
                             ...
                             ,0                             sch_in_qty          --入庫予定数
                             ,0                             sch_out_qty         --出庫予定数
                        FROM  xxwsh_order_headers_all       OHA                 --受注ヘッダ
...
--
       ...
       ,xxsky_item_mst_v           ITEM    --品目名称取得用(SYSDATEで取得)
...
/
COMMENT ON TABLE APPS.XXSKY_在庫情報_基本_V IS 'SKYLINK用 在庫情報（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.当月           IS '当月'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.名義コード     IS '名義コード'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.名義           IS '名義'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.倉庫コード     IS '倉庫コード'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.倉庫名         IS '倉庫名'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.保管場所コード IS '保管場所コード'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.保管場所名     IS '保管場所名'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.保管場所略称   IS '保管場所略称'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.商品区分       IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.商品区分名     IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.品目区分       IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.品目区分名     IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.群コード       IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.品目           IS '品目'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.品目名         IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.品目略称       IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.ロットNO       IS 'ロットNo'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.製造年月日     IS '製造年月日'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.固有記号       IS '固有記号'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.賞味期限       IS '賞味期限'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.月首在庫数     IS '月首在庫数'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.当月入庫数     IS '当月入庫数'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.当月出庫数     IS '当月出庫数'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.当月入庫予定数 IS '当月入庫予定数'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.当月出庫予定数 IS '当月出庫予定数'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.月末在庫数     IS '月末在庫数'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.棚卸ケース数   IS '棚卸ケース数'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.棚卸バラ数     IS '棚卸バラ数'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.翌月入庫数     IS '翌月入庫数'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.翌月出庫数     IS '翌月出庫数'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.現在庫数       IS '現在庫数'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.入庫予定数     IS '入庫予定数'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.出庫予定数     IS '出庫予定数'
/
COMMENT ON COLUMN APPS.XXSKY_在庫情報_基本_V.引当可能数     IS '引数可能数'
/
