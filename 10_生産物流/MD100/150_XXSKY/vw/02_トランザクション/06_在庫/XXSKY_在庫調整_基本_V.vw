CREATE OR REPLACE VIEW APPS.XXSKY_在庫調整_基本_V
(
 入出庫区分
,事由コード
,事由コード名
...
SELECT  ZTIO.inout_kbn                      inout_kbn              -- 入出庫区分
  ...
  FROM
       ...
       ,xxsky_prod_class_v                            XPCV                      -- 商品区分取得VIEW
       ,xxsky_item_class_v                            XICV                      -- 品目区分取得VIEW
       ,xxsky_crowd_code_v                            XCCV                      -- 群コード取得VIEW
       ,xxsky_item_mst2_v                             XIMV2                     -- OPM品目情報VIEW2
...
/
COMMENT ON TABLE APPS.XXSKY_在庫調整_基本_V IS 'SKYLINK用在庫調整（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.入出庫区分                    IS '入出庫区分'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.事由コード                    IS '事由コード'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.事由コード名                  IS '事由コード名'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.倉庫コード                    IS '倉庫コード'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.保管場所コード                IS '保管場所コード'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.保管場所名                    IS '保管場所名'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.保管場所略称                  IS '保管場所略称'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.商品区分                      IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.商品区分名                    IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.品目区分                      IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.品目区分名                    IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.群コード                      IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.品目コード                    IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.品目名                        IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.品目略称                      IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.単位                          IS '単位'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.ロットNo                      IS 'ロットNo'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.製造年月日                    IS '製造年月日'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.固有記号                      IS '固有記号'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.賞味期限                      IS '賞味期限'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.在庫調整用摘要                IS '在庫調整用摘要'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.伝票No                        IS '伝票No'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.入出庫日                      IS '入出庫日'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.入庫数                        IS '入庫数'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.入庫ケース数                  IS '入庫ケース数'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.出庫数                        IS '出庫数'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.出庫ケース数                  IS '出庫ケース数'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.作成者                        IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.作成日                        IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.最終更新者                    IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.最終更新日                    IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKY_在庫調整_基本_V.最終更新ログイン              IS '最終更新ログイン'
/
