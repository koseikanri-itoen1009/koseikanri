/*************************************************************************
 * 
 * View  Name      : XXSKZ_ドリンク在庫実績_基本_V
 * Description     : XXSKZ_ドリンク在庫実績_基本_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 * ------------- ----- ------------ -------------------------------------
 *  2012/11/30    1.0   SCSK 月野    初回作成
 ************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_ドリンク在庫実績_基本_V
(
 対象年月
,倉庫コード
,倉庫名
                     ...
                     --======================================================================
                      ...
                      SELECT
                        ...
                        FROM
                             ...
                             ,xxskz_item_locations_v        XIL_TO              --OPM保管場所情報VIEW -- 2010/03/09 H.Itou Add E_本稼動_01822
                       WHERE
                    ...
                    UNION ALL
                      ...
                      SELECT
                        ...
                        FROM
                             ...
                             ,xxcmn_mov_lot_details_arc     XMD                 --移動ロット詳細（アドオン）バックアップ
                             ,xxskz_item_locations_v        XIL                 --OPM保管場所情報VIEW
                             ,xxskz_item_locations_v        XIL_FROM            --OPM保管場所情報VIEW -- 2010/03/09 H.Itou Add E_本稼動_01822
                       WHERE
                         -- 移動依頼/指示ヘッダ(アドオン)の条件
...
/
COMMENT ON TABLE APPS.XXSKZ_ドリンク在庫実績_基本_V IS 'SKYLINK用 ドリンク在庫実績（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.対象年月                IS '対象年月'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.倉庫コード              IS '倉庫コード'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.倉庫名                  IS '倉庫名'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.保管場所コード          IS '保管場所コード'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.保管場所名              IS '保管場所名'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.保管場所略称            IS '保管場所略称'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.商品区分                IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.商品区分名              IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.品目区分                IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.品目区分名              IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.群コード                IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.品目                    IS '品目'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.品目名                  IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.品目略称                IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.ロットNO                IS 'ロットNO'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.製造年月日              IS '製造年月日'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.固有記号                IS '固有記号'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.賞味期限                IS '賞味期限'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.棚卸ケース数            IS '棚卸ケース数'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.棚卸バラ数              IS '棚卸バラ数'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.積送中在庫ケース数      IS '積送中在庫ケース数'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.積送中在庫バラ数        IS '積送中在庫バラ数'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.論理_月末在庫ケース数   IS '論理_月末在庫ケース数'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.論理_月末在庫バラ数     IS '論理_月末在庫バラ数'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.返品_月間入庫ケース数   IS '返品_月間入庫ケース数'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.返品_月間入庫バラ数     IS '返品_月間入庫バラ数'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.生産_月間入庫ケース数   IS '生産_月間入庫ケース数'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.生産_月間入庫バラ数     IS '生産_月間入庫バラ数'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.移動_月間入庫ケース数   IS '移動_月間入庫ケース数'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.移動_月間入庫バラ数     IS '移動_月間入庫バラ数'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.その他_月間入庫ケース数 IS 'その他_月間入庫ケース数'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.その他_月間入庫バラ数   IS 'その他_月間入庫バラ数'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.拠点_月間出庫ケース数   IS '拠点_月間出庫ケース数'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.拠点_月間出庫バラ数     IS '拠点_月間出庫バラ数'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.移動_月間出庫ケース数   IS '移動_月間出庫ケース数'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.移動_月間出庫バラ数     IS '移動_月間出庫バラ数'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.その他_月間出庫ケース数 IS 'その他_月間出庫ケース数'
/
COMMENT ON COLUMN APPS.XXSKZ_ドリンク在庫実績_基本_V.その他_月間出庫バラ数   IS 'その他_月間出庫バラ数'
/
