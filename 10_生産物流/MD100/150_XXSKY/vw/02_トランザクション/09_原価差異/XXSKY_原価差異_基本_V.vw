CREATE OR REPLACE VIEW APPS.XXSKY_原価差異_基本_V
(
 対象年月
,商品区分
,商品区分名
...
/
COMMENT ON TABLE APPS.XXSKY_原価差異_基本_V IS 'SKYLINK用原価差異基本VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_原価差異_基本_V.対象年月       IS '対象年月'
/
COMMENT ON COLUMN APPS.XXSKY_原価差異_基本_V.商品区分       IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_原価差異_基本_V.商品区分名     IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_原価差異_基本_V.品目区分       IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKY_原価差異_基本_V.品目区分名     IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_原価差異_基本_V.群コード       IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKY_原価差異_基本_V.取引先コード   IS '取引先コード'
/
COMMENT ON COLUMN APPS.XXSKY_原価差異_基本_V.取引先名       IS '取引先名'
/
COMMENT ON COLUMN APPS.XXSKY_原価差異_基本_V.品目コード     IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKY_原価差異_基本_V.品目名         IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKY_原価差異_基本_V.品目略称       IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_原価差異_基本_V.費目           IS '費目'
/
COMMENT ON COLUMN APPS.XXSKY_原価差異_基本_V.費目名称       IS '費目名称'
/
COMMENT ON COLUMN APPS.XXSKY_原価差異_基本_V.項目           IS '項目'
/
COMMENT ON COLUMN APPS.XXSKY_原価差異_基本_V.項目名称       IS '項目名称'
/
COMMENT ON COLUMN APPS.XXSKY_原価差異_基本_V.月間数量       IS '月間数量'
/
COMMENT ON COLUMN APPS.XXSKY_原価差異_基本_V.月間ケース数量 IS '月間ケース数量'
/
COMMENT ON COLUMN APPS.XXSKY_原価差異_基本_V.月間金額       IS '月間金額'
/
COMMENT ON COLUMN APPS.XXSKY_原価差異_基本_V.標準金額       IS '標準金額'
/