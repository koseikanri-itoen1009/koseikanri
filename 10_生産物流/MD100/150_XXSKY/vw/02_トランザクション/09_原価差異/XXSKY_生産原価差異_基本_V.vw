CREATE OR REPLACE VIEW APPS.XXSKY_生産原価差異_基本_V
(
 生産日
,成績管理部署
,商品区分
             ...
             FROM  ( --集計対象データを『完成品』、『原料』、『副産物』別で取得
                      ...
                      SELECT  GBH.batch_no             batch_no      --バッチNo
                        ...
                        FROM  gme_batch_header         GBH           --生産バッチヘッダ
                             ...
                             ,gme_material_details     GMD           --原料詳細アドオン
...
/
COMMENT ON TABLE APPS.XXSKY_生産原価差異_基本_V IS 'SKYLINK用 生産原価差異（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.生産日       IS '生産日'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.成績管理部署 IS '成績管理部署'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.商品区分     IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.商品区分名   IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.品目区分     IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.品目区分名   IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.群コード     IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.品目         IS '品目'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.品目名       IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.品目略称     IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.ロットNO     IS 'ロットNo'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.製造年月日   IS '製造年月日'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.賞味期限     IS '賞味期限'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.固有記号     IS '固有記号'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.出来高数量   IS '出来高数量'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.標準原価単価 IS '標準原価単価'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.標準原価金額 IS '標準原価金額'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.投入金額     IS '投入金額'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.打込金額     IS '打込金額'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.副産物金額   IS '副産物金額'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.出来高金額   IS '出来高金額'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.出来高単価   IS '出来高単価'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.単価差異     IS '単価差異'
/
COMMENT ON COLUMN APPS.XXSKY_生産原価差異_基本_V.原価差異     IS '原価差異'
/
