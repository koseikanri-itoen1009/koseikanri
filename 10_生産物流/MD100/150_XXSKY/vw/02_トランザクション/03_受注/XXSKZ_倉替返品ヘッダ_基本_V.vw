/*************************************************************************
 * 
 * View  Name      : XXSKZ_倉替返品ヘッダ_基本_V
 * Description     : XXSKZ_倉替返品ヘッダ_基本_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 ************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_倉替返品ヘッダ_基本_V
(
 依頼NO
,受注タイプ名
,組織名
...
SELECT
  ...
  FROM  xxcmn_order_headers_all_arc      XOHA    --受注ヘッダ（アドオン）バックアップ
       ...
       ,xxskz_party_sites2_v         XPS2V01 --SKYLINK用中間VIEW 配送先情報VIEW2(出荷先名)
       ,qp_list_headers_tl           QLHT    --価格表
       ,xxskz_item_locations2_v      XIL2V   --SKYLINK用中間VIEW OPM保管場所情報VIEW2(出荷元保管場所名)
       ,xxskz_cust_accounts2_v       XCA2V02 --SKYLINK用中間VIEW 顧客情報VIEW2(管轄拠点名)
       ,xxskz_cust_accounts2_v       XCA2V03 --SKYLINK用中間VIEW 顧客情報VIEW2(入力拠点名)
       ,xxskz_party_sites2_v         XPS2V02 --SKYLINK用中間VIEW 配送先情報VIEW2(出荷先_実績名)
       ,xxskz_locations2_v           XL2V    --SKYLINK用中間VIEW 事業所情報VIEW2(成績管理部署名)
...
/
COMMENT ON TABLE APPS.XXSKZ_倉替返品ヘッダ_基本_V IS 'SKYLINK用倉替返品ヘッダ（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.依頼NO IS '依頼No'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.受注タイプ名 IS '受注タイプ名'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.組織名 IS '組織名'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.受注日 IS '受注日'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.最新フラグ IS '最新フラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.元依頼NO IS '元依頼No'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.顧客 IS '顧客'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.顧客名 IS '顧客名'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.出荷先 IS '出荷先'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.出荷先名 IS '出荷先名'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.出荷指示 IS '出荷指示'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.価格表 IS '価格表'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.価格表名 IS '価格表名'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.ステータス IS 'ステータス'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.ステータス名 IS 'ステータス名'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.出荷予定日 IS '出荷予定日'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.着荷予定日 IS '着荷予定日'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.出荷元保管場所 IS '出荷元保管場所'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.出荷元保管場所名 IS '出荷元保管場所名'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.管轄拠点 IS '管轄拠点'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.管轄拠点名 IS '管轄拠点名'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.管轄拠点略称 IS '管轄拠点略称'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.入力拠点 IS '入力拠点'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.入力拠点名 IS '入力拠点名'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.入力拠点略称 IS '入力拠点略称'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.商品区分 IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.商品区分名 IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.品目区分 IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.品目区分名 IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.合計数量 IS '合計数量'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.出荷先_実績 IS '出荷先_実績'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.出荷先_予実 IS '出荷先_予実'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.出荷先_実績名 IS '出荷先_実績名'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.出荷先_予実名 IS '出荷先_予実名'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.出荷日 IS '出荷日'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.出荷日_予実 IS '出荷日_予実'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.着荷日 IS '着荷日'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.着荷日_予実 IS '着荷日_予実'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.実績計上済区分 IS '実績計上済区分'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.確定通知実施日時 IS '確定通知実施日時'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.新規修正フラグ IS '新規修正フラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.新規修正フラグ名 IS '新規修正フラグ名'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.成績管理部署 IS '成績管理部署'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.成績管理部署名 IS '成績管理部署名'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.登録順序 IS '登録順序'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.出荷依頼締め日時 IS '出荷依頼締め日時'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.作成者 IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.作成日 IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.最終更新者 IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.最終更新日 IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKZ_倉替返品ヘッダ_基本_V.最終更新ログイン IS '最終更新ログイン'
/
