/*************************************************************************
 * 
 * View  Name      : XXSKZ_支給明細_基本_V
 * Description     : XXSKZ_支給明細_基本_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 ************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_支給明細_基本_V
(
 依頼NO
,明細番号
,レコードタイプ
...
SELECT  XOLL.request_no                 request_no                 --依頼No
  ...
  FROM  ( --名称取得系以外のデータはこの内部SQLで全て取得する
          SELECT XOLA.request_no                                   --依頼No
                ...
                ,XOLA.quantity
                  * DECODE( OTTA.order_category_code, 'RETURN', -1, 1 )       --返品の場合はマイナス値
                                           quantity                --数量
                ,XOLA.uom_code                                     --単位
                ,XOLA.unit_price                                   --単価
          ...
          WHERE  XOHA.order_header_id = XOLA.order_header_id
            ...
            AND  OTTA.attribute1 = '2'                             --2_支給
            AND  XMLD.document_type_code(+) = '30'                 --30_支給支持
...
/
COMMENT ON TABLE APPS.XXSKZ_支給明細_基本_V IS 'SKYLINK用 支給明細（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.依頼NO IS '依頼No'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.明細番号 IS '明細番号'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.レコードタイプ IS 'レコードタイプ'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.レコードタイプ名 IS 'レコードタイプ名'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.商品区分 IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.商品区分名 IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.品目区分 IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.品目区分名 IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.群コード IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.出荷品目 IS '出荷品目'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.出荷品目名 IS '出荷品目名'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.出荷品目略称 IS '出荷品目略称'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.ロットNO IS 'ロットNo'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.製造年月日 IS '製造年月日'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.固有記号 IS '固有記号'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.賞味期限 IS '賞味期限'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.削除フラグ IS '削除フラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.数量 IS '数量'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.単位 IS '単位'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.単価 IS '単価'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.出荷実績数量 IS '出荷実績数量'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.拠点依頼数量 IS '拠点依頼数量'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.依頼品目 IS '依頼品目'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.依頼品目名 IS '依頼品目名'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.依頼品目略称 IS '依頼品目略称'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.入庫実績数量 IS '入庫実績数量'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.付帯コード IS '付帯コード'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.重量 IS '重量'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.容積 IS '容積'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.引当数 IS '引当数'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.警告区分 IS '警告区分'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.警告区分名 IS '警告区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.警告日付 IS '警告日付'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.摘要 IS '摘要'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.実績日 IS '実績日'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.実績数量 IS '実績数量'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.訂正前実績数量 IS '訂正前実績数量'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.作成者 IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.作成日 IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.最終更新者 IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.最終更新日 IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKZ_支給明細_基本_V.最終更新ログイン IS '最終更新ログイン'
/
