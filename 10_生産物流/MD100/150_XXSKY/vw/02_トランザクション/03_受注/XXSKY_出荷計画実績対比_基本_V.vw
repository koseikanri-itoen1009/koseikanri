CREATE OR REPLACE VIEW APPS.XXSKY_出荷計画実績対比_基本_V
(
 着日
,商品区分
,商品区分名
...
/
COMMENT ON TABLE APPS.XXSKY_出荷計画実績対比_基本_V IS 'SKYLINK用 出荷計画実績対比（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_出荷計画実績対比_基本_V.着日 IS '着日'
/
COMMENT ON COLUMN APPS.XXSKY_出荷計画実績対比_基本_V.商品区分 IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_出荷計画実績対比_基本_V.商品区分名 IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_出荷計画実績対比_基本_V.品目区分 IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKY_出荷計画実績対比_基本_V.品目区分名 IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_出荷計画実績対比_基本_V.群コード IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKY_出荷計画実績対比_基本_V.品目 IS '品目'
/
COMMENT ON COLUMN APPS.XXSKY_出荷計画実績対比_基本_V.品目名 IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKY_出荷計画実績対比_基本_V.品目略称 IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_出荷計画実績対比_基本_V.拠点 IS '拠点'
/
COMMENT ON COLUMN APPS.XXSKY_出荷計画実績対比_基本_V.拠点名 IS '拠点名'
/
COMMENT ON COLUMN APPS.XXSKY_出荷計画実績対比_基本_V.引取計画数 IS '引取計画数'
/
COMMENT ON COLUMN APPS.XXSKY_出荷計画実績対比_基本_V.出荷予定数 IS '出荷予定数'
/
COMMENT ON COLUMN APPS.XXSKY_出荷計画実績対比_基本_V.出荷実績数 IS '出荷実績数'
/
COMMENT ON COLUMN APPS.XXSKY_出荷計画実績対比_基本_V.差異数 IS '差異数'
/
COMMENT ON COLUMN APPS.XXSKY_出荷計画実績対比_基本_V.引取率 IS '引取率'
/
