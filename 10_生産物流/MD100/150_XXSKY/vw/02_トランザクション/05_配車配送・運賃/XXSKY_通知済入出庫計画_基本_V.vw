CREATE OR REPLACE VIEW APPS.XXSKY_通知済入出庫計画_基本_V
(
 会社名
,依頼No
,配送No
...
-- 2010/1/8 #627 Y.Fukami Mod End
  ...
  FROM
       ...
       ,xxsky_item_locations_v          XILV                          --EOS宛先_出庫倉庫名取得用
       ,xxsky_carriers2_v               XCAR                          --EOS宛先_運送業者名取得用
       ,xxsky_locations2_v              XLOCT                         --報告部署名取得用
       ,xxsky_item_mst2_v               XITEM                         --品目情報取得用
       ,xxsky_prod_class_v              XPRODC                        --商品区分取得用
       ,xxsky_item_class_v              XITEMC                        --品目区分取得用
       ,xxsky_crowd_code_v              XCRWDC                        --群コード取得用
...
/
COMMENT ON TABLE APPS.XXSKY_通知済入出庫計画_基本_V IS 'SKYLINK用 通知済入出庫計画（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.会社名              IS '会社名'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.依頼No              IS '依頼No'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.配送No              IS '配送No'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.データ種別          IS 'データ種別'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.データ種別名        IS 'データ種別名'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.データ区分          IS 'データ区分'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.データ区分名        IS 'データ区分名'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.データタイプ        IS 'データタイプ'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.データタイプ名      IS 'データタイプ名'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.確定通知実施日時    IS '確定通知実施日時'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.更新日時            IS '更新日時'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.EOS宛先_出庫倉庫    IS 'EOS宛先_出庫倉庫'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.EOS宛先_出庫倉庫名  IS 'EOS宛先_出庫倉庫名'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.EOS宛先_運送業者    IS 'EOS宛先_運送業者'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.EOS宛先_運送業者名  IS 'EOS宛先_運送業者名'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.EOS宛先_CSV出力     IS 'EOS宛先_CSV出力'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.EOS宛先_CSV出力名   IS 'EOS宛先_CSV出力名'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.伝送用枝番          IS '伝送用枝番'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.伝送用枝番名        IS '伝送用枝番名'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.予備                IS '予備'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.管轄拠点コード      IS '管轄拠点コード'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.管轄拠点名称        IS '管轄拠点名称'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.出庫倉庫コード      IS '出庫倉庫コード'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.出庫倉庫名称        IS '出庫倉庫名称'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.入庫倉庫コード      IS '入庫倉庫コード'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.入庫倉庫名称        IS '入庫倉庫名称'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.運送業者コード      IS '運送業者コード'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.運送業者名          IS '運送業者名'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.配送先コード        IS '配送先コード'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.配送先名            IS '配送先名'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.発日                IS '発日'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.着日                IS '着日'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.配送区分            IS '配送区分'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.配送区分名          IS '配送区分名'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.依頼NO単位_重量容積 IS '依頼NO単位_重量容積'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.混載元依頼No        IS '混載元依頼No'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.パレット回収枚数    IS 'パレット回収枚数'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.着荷時間指定FROM    IS '着荷時間指定FROM'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.着荷時間指定FROM名  IS '着荷時間指定FROM名'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.着荷時間指定TO      IS '着荷時間指定TO'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.着荷時間指定TO名    IS '着荷時間指定TO名'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.顧客発注番号        IS '顧客発注番号'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.摘要                IS '摘要'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.ステータス          IS 'ステータス'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.ステータス名        IS 'ステータス名'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.運賃区分            IS '運賃区分'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.運賃区分名          IS '運賃区分名'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.パレット使用枚数    IS 'パレット使用枚数'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.報告部署コード      IS '報告部署コード'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.報告部署名          IS '報告部署名'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.予備１              IS '予備１'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.予備２              IS '予備２'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.予備３              IS '予備３'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.予備４              IS '予備４'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.明細番号            IS '明細番号'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.商品区分            IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.商品区分名          IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.品目区分            IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.品目区分名          IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.群コード            IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.品目コード          IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.品目名称            IS '品目名称'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.品目略称            IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.品目単位            IS '品目単位'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.品目数量            IS '品目数量'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.ロット番号          IS 'ロット番号'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.製造日              IS '製造日'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.賞味期限            IS '賞味期限'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.固有記号            IS '固有記号'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.ロット数量          IS 'ロット数量'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.作成者              IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.作成日              IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.最終更新者          IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.最終更新日          IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKY_通知済入出庫計画_基本_V.最終更新ログイン    IS '最終更新ログイン'
/
