/*************************************************************************
 * 
 * View  Name      : XXSKZ_運賃明細_基本_V
 * Description     : XXSKZ_運賃明細_基本_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 ************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_運賃明細_基本_V
(
 依頼NO
,送り状NO
,配送NO
...
--        ,XXSKY_配送先マスタ_基本_V    XHMV      -- SKYLINK用配送先マスタ_基本_V
        ,XXSKZ_配送先マスタ_基本2_V   XHM2V     -- SKYLINK用配送先マスタ_基本2_V
-- 2009/12/01 Y.Fukami Mod End
        ,xxskz_locations2_v     XL2V02          -- SKYLINK用中間VIEW 事業所情報VIEW2(管轄拠点名)
...
/
COMMENT ON TABLE APPS.XXSKZ_運賃明細_基本_V IS 'SKYLINK用運賃明細（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.依頼NO IS '依頼No'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.送り状NO IS '送り状No'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.配送NO IS '配送No'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.運送業者 IS '運送業者'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.運送業者名 IS '運送業者名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.出庫倉庫コード IS '出庫倉庫コード'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.出庫倉庫名 IS '出庫倉庫名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.配送区分 IS '配送区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.配送区分名 IS '配送区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.配送先コード区分 IS '配送先コード区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.配送先コード区分名 IS '配送先コード区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.配送先コード IS '配送先コード'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.代表配送先名 IS '代表配送先名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.支払判断区分 IS '支払判断区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.支払判断区分名 IS '支払判断区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.管轄拠点 IS '管轄拠点'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.管轄拠点名称 IS '管轄拠点名称'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.出庫日 IS '出庫日'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.到着日 IS '到着日'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.報告日 IS '報告日'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.判断日 IS '判断日'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.商品区分 IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.商品区分名 IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.重量容積区分 IS '重量容積区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.重量容積区分名 IS '重量容積区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.距離 IS '距離'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.実際距離 IS '実際距離'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.個数 IS '個数'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.重量 IS '重量'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.タイプ IS 'タイプ'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.タイプ名 IS 'タイプ名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.混載区分 IS '混載区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.混載区分名 IS '混載区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.契約外区分 IS '契約外区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.契約外区分名 IS '契約外区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.振替先 IS '振替先'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.振替先名 IS '振替先名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.摘要 IS '摘要'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.作成者 IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.作成日 IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.最終更新者 IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.最終更新日 IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃明細_基本_V.最終更新ログイン IS '最終更新ログイン'
/
