/*************************************************************************
 * 
 * View  Name      : XXSKZ_運賃品目別_基本_V2
 * Description     : XXSKZ_運賃品目別_基本_V2
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 ************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_運賃品目別_基本_V2
(
 配送NO
,依頼_移動NO
,区分
...
/
COMMENT ON TABLE APPS.XXSKZ_運賃品目別_基本_V2 IS 'SKYLINK用運賃品目別（基本） VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.配送NO IS '配送No'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.依頼_移動NO IS '依頼_移動No'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.区分 IS '区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.受注タイプ IS '受注タイプ'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.ステータス IS 'ステータス'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.ステータス名 IS 'ステータス名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.管轄拠点 IS '管轄拠点'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.管轄拠点名 IS '管轄拠点名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.運送業者 IS '運送業者'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.運送業者名 IS '運送業者名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.運送業者略称 IS '運送業者略称'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.入庫先_配送先 IS '入庫先_配送先'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.入庫先_配送先名 IS '入庫先_配送先名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.入庫先_配送先略称 IS '入庫先_配送先略称'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.出庫元 IS '出庫元'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.出庫元名 IS '出庫元名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.出庫元略称 IS '出庫元略称'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.配送区分 IS '配送区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.配送区分名 IS '配送区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.出庫日 IS '出庫日'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.入庫日 IS '入庫日'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.商品区分 IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.商品区分名 IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.品目区分 IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.品目区分名 IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.群コード IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.品目コード IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.品目名称 IS '品目名称'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.品目略称 IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.品目バラ数 IS '品目バラ数'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.品目ケース数 IS '品目ケース数'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.合計ケース数 IS '合計ケース数'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.積載重量合計 IS '積載重量合計'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.按分計算用_積載重量合計 IS '按分計算用_積載重量合計'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.品目重量合計 IS '品目重量合計'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.按分計算用_品目重量合計 IS '按分計算用_品目重量合計'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.合計金額 IS '合計金額'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃品目別_基本_V2.品目_合計金額 IS '品目_合計金額'
/
