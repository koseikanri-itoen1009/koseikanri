/*************************************************************************
 * 
 * View  Name      : XXSKZ_運賃ヘッダ_基本_V
 * Description     : XXSKZ_運賃ヘッダ_基本_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 ************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_運賃ヘッダ_基本_V
(
運送業者
,運送業者名
,配送NO
...
/
COMMENT ON TABLE APPS.XXSKZ_運賃ヘッダ_基本_V IS 'SKYLINK用運賃ヘッダ（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.運送業者             IS '運送業者'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.運送業者名           IS '運送業者名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.配送NO               IS '配送No'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.送り状NO             IS '送り状No'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.送り状NO２           IS '送り状No2'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.支払請求区分         IS '支払請求区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.支払請求区分名       IS '支払請求区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.支払判断区分         IS '支払判断区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.支払判断区分名       IS '支払判断区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.出庫日               IS '出庫日'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.到着日               IS '到着日'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.報告日               IS '報告日'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.判断日               IS '判断日'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.商品区分             IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.商品区分名           IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.混載区分             IS '混載区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.混載区分名           IS '混載区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.請求運賃             IS '請求運賃'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.契約運賃             IS '契約運賃'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.差額                 IS '差額'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.合計                 IS '合計'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.諸料金               IS '諸料金'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.最長距離             IS '最長距離'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.配送区分             IS '配送区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.配送区分名           IS '配送区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.代表出庫倉庫コード   IS '代表出庫倉庫コード'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.代表出庫倉庫名       IS '代表出庫倉庫名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.代表配送先コード区分     IS '代表配送先コード区'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.代表配送先コード区分名   IS '代表配送先コード区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.代表配送先コード     IS '代表配送先コード'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.代表配送先名         IS '代表配送先名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.個数１               IS '個数１'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.個数２               IS '個数２'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.重量１               IS '重量１'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.重量２               IS '重量２'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.混載割増金額         IS '混載割増金額'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.最長実際距離         IS '最長実際距離'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.通行料               IS '通行料'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.ピッキング料         IS 'ピッキング料'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.混載数               IS '混載数'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.代表タイプ           IS '代表タイプ'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.代表タイプ名         IS '代表タイプ名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.重量容積区分         IS '重量容積区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.重量容積区分名       IS '重量容積区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.契約外区分           IS '契約外区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.契約外区分名         IS '契約外区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.差異区分             IS '差異区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.差異区分名           IS '差異区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.支払確定区分         IS '支払確定区分'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.支払確定区分名       IS '支払確定区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.支払確定戻           IS '支払確定戻'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.支払確定戻名         IS '支払確定戻名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.振替先               IS '振替先'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.振替先名             IS '振替先名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.外部業者変更回数     IS '外部業者変更回数'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.運賃摘要             IS '運賃摘要'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.配車タイプ           IS '配車タイプ'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.配車タイプ名         IS '配車タイプ名'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.作成者               IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.作成日               IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.最終更新者           IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.最終更新日           IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKZ_運賃ヘッダ_基本_V.最終更新ログイン     IS '最終更新ログイン'
/
