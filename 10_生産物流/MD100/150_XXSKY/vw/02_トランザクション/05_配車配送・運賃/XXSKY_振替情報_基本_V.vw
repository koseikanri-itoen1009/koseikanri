CREATE OR REPLACE VIEW APPS.XXSKY_振替情報_基本_V
(
 対象年月
,営業ブロック
,営業ブロック名
...
SELECT 
  ...
  FROM  (
       ...
       ,xxsky_cust_accounts2_v          XCA2V           --SKYLINK用中間VIEW 拠点取得VIEW
       ,xxsky_item_locations_v          XILV            --SKYLINK用中間VIEW 出庫元取得VIEW
       ,xxsky_party_sites2_v            XPS2V           --SKYLINK用中間VIEW 配送先取得VIEW
       ,xxsky_item_class_v              XICV            --SKYLINK用中間VIEW 品目区分取得VIEW
       ,xxsky_crowd_code_v              XCCV            --SKYLINK用中間VIEW 群コード取得VIEW
       ,xxsky_item_mst2_v               XIM2V           --SKYLINK用中間VIEW 品目名取得VIEW
...
/
COMMENT ON TABLE APPS.XXSKY_振替情報_基本_V                     IS 'SKYLINK用振替情報（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.対象年月           IS '対象年月'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.営業ブロック       IS '営業ブロック'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.営業ブロック名     IS '営業ブロック名'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.商品区分           IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.商品区分名         IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.管轄拠点           IS '管轄拠点'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.管轄拠点名         IS '管轄拠点名'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.管轄拠点略称       IS '管轄拠点略称'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.地区名             IS '地区名'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.振替数量           IS '振替数量'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.振替金額           IS '振替金額'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.還元金額           IS '還元金額'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.運送費Ａ           IS '運送費Ａ'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.運送費Ｂ           IS '運送費Ｂ'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.運送費Ｃ           IS '運送費Ｃ'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.その他             IS 'その他'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.依頼NO             IS '依頼No'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.配送日             IS '配送日'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.出庫元             IS '出庫元'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.出庫元名           IS '出庫元名'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.配送先             IS '配送先'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.配送先名           IS '配送先名'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.品目区分           IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.品目区分名         IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.群コード           IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.品目コード         IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.品目名             IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.品目略称           IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.単価               IS '単価'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.計算数量           IS '計算数量'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.実際数量           IS '実際数量'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.金額               IS '金額'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.作成者             IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.作成日             IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.最終更新者         IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.最終更新日         IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKY_振替情報_基本_V.最終更新ログイン   IS '最終更新ログイン'
/