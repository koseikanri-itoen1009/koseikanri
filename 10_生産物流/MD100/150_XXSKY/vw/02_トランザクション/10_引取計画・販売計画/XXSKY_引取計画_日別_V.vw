CREATE OR REPLACE VIEW APPS.XXSKY_引取計画_日別_V
(
 年月
,商品区分
,商品区分名
...
SELECT  SMFC.frct_ym                frct_ym            --年月
  ...
  FROM  ( --年月、倉庫、拠点、品目単位で集計した（日別を横にした）計画数量集計データ
       ...
       ,xxsky_item_mst2_v       ITEM    --品目名取得用
       ,xxsky_prod_class_v      PRODC   --商品区分取得用
       ,xxsky_item_class_v      ITEMC   --品目区分取得用
       ,xxsky_crowd_code_v      CROWD   --群コード取得用
       ,xxsky_inout_class_v     INOUT   --内外区分取得用
       ,xxsky_item_locations_v  ITMLC   --保管倉庫名取得用
       ,xxsky_cust_accounts2_v  BRCH    --拠点名取得用
 WHERE
   --品目名取得
...
/
COMMENT ON TABLE APPS.XXSKY_引取計画_日別_V IS 'SKYLINK用 引取計画（日別）VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.年月             IS '年月'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.商品区分         IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.商品区分名       IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.品目区分         IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.品目区分名       IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.群コード         IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.内外区分         IS '内外区分'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.内外区分名       IS '内外区分名'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.品目             IS '品目'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.品目名           IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.品目略称         IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.出荷元保管倉庫   IS '出荷元保管倉庫'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.出荷元保管倉庫名 IS '出荷元保管倉庫名'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.拠点             IS '拠点'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.拠点名           IS '拠点名'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.ケース入数       IS 'ケース入数'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量１日         IS '数量１日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量２日         IS '数量２日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量３日         IS '数量３日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量４日         IS '数量４日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量５日         IS '数量５日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量６日         IS '数量６日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量７日         IS '数量７日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量８日         IS '数量８日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量９日         IS '数量９日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量１０日       IS '数量１０日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量１１日       IS '数量１１日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量１２日       IS '数量１２日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量１３日       IS '数量１３日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量１４日       IS '数量１４日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量１５日       IS '数量１５日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量１６日       IS '数量１６日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量１７日       IS '数量１７日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量１８日       IS '数量１８日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量１９日       IS '数量１９日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量２０日       IS '数量２０日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量２１日       IS '数量２１日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量２２日       IS '数量２２日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量２３日       IS '数量２３日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量２４日       IS '数量２４日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量２５日       IS '数量２５日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量２６日       IS '数量２６日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量２７日       IS '数量２７日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量２８日       IS '数量２８日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量２９日       IS '数量２９日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量３０日       IS '数量３０日'
/
COMMENT ON COLUMN APPS.XXSKY_引取計画_日別_V.数量３１日       IS '数量３１日'
/
