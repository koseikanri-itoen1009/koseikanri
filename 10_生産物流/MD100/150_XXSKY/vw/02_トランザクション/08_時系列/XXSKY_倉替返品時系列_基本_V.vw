CREATE OR REPLACE VIEW APPS.XXSKY_倉替返品時系列_基本_V
(
 年度
,拠点
,拠点名
...
SELECT  SMKH.year                    year             --年度
  ...
  FROM  (  --年度、拠点、品目、倉庫単位で集計した（月度集計を横にした）倉替返品数量集計データ
        ...
        ,xxsky_cust_accounts_v    BRCH    --拠点名取得（SYSDATEで有効データを抽出）
...
/
COMMENT ON TABLE APPS.XXSKY_倉替返品時系列_基本_V IS 'SKYLINK用 倉替返品時系列（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.年度 IS '年度'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.拠点 IS '拠点'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.拠点名 IS '拠点名'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.商品区分 IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.商品区分名 IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.品目区分 IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.品目区分名 IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.群コード IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.品目 IS '品目'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.品目名 IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.品目略称 IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.入庫倉庫 IS '入庫倉庫'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.入庫倉庫名 IS '入庫倉庫名'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.倉替総数_５月 IS '倉替総数_５月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.返品総数_５月 IS '返品総数_５月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.倉替総数_６月 IS '倉替総数_６月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.返品総数_６月 IS '返品総数_６月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.倉替総数_７月 IS '倉替総数_７月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.返品総数_７月 IS '返品総数_７月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.倉替総数_８月 IS '倉替総数_８月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.返品総数_８月 IS '返品総数_８月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.倉替総数_９月 IS '倉替総数_９月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.返品総数_９月 IS '返品総数_９月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.倉替総数_１０月 IS '倉替総数_１０月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.返品総数_１０月 IS '返品総数_１０月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.倉替総数_１１月 IS '倉替総数_１１月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.返品総数_１１月 IS '返品総数_１１月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.倉替総数_１２月 IS '倉替総数_１２月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.返品総数_１２月 IS '返品総数_１２月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.倉替総数_１月 IS '倉替総数_１月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.返品総数_１月 IS '返品総数_１月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.倉替総数_２月 IS '倉替総数_２月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.返品総数_２月 IS '返品総数_２月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.倉替総数_３月 IS '倉替総数_３月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.返品総数_３月 IS '返品総数_３月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.倉替総数_４月 IS '倉替総数_４月'
/
COMMENT ON COLUMN APPS.XXSKY_倉替返品時系列_基本_V.返品総数_４月 IS '返品総数_４月'
/
