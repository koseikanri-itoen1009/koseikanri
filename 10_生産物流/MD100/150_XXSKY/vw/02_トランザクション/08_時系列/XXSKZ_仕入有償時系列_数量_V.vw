/*************************************************************************
 * 
 * View  Name      : XXSKZ_仕入有償時系列_数量_V
 * Description     : XXSKZ_仕入有償時系列_数量_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 ************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_仕入有償時系列_数量_V
(
 年度
,部署
,部署名
...
/
COMMENT ON TABLE APPS.XXSKZ_仕入有償時系列_数量_V IS 'SKYLINK用 仕入有償時系列（数量）VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.年度                IS '年度'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.部署                IS '部署'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.部署名              IS '部署名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.取引先              IS '取引先'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.取引先名            IS '取引先名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.商品区分            IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.商品区分名          IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.品目区分            IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.品目区分名          IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.群コード            IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.品目コード          IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.品目名              IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.品目略称            IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.仕入形態            IS '仕入形態'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.仕入形態名          IS '仕入形態名'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.仕入数量_５月       IS '仕入数量_５月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.有償数量_５月       IS '有償数量_５月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.仕入数量_６月       IS '仕入数量_６月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.有償数量_６月       IS '有償数量_６月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.仕入数量_７月       IS '仕入数量_７月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.有償数量_７月       IS '有償数量_７月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.仕入数量_８月       IS '仕入数量_８月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.有償数量_８月       IS '有償数量_８月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.仕入数量_９月       IS '仕入数量_９月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.有償数量_９月       IS '有償数量_９月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.仕入数量_１０月     IS '仕入数量_１０月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.有償数量_１０月     IS '有償数量_１０月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.仕入数量_１１月     IS '仕入数量_１１月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.有償数量_１１月     IS '有償数量_１１月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.仕入数量_１２月     IS '仕入数量_１２月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.有償数量_１２月     IS '有償数量_１２月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.仕入数量_１月       IS '仕入数量_１月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.有償数量_１月       IS '有償数量_１月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.仕入数量_２月       IS '仕入数量_２月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.有償数量_２月       IS '有償数量_２月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.仕入数量_３月       IS '仕入数量_３月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.有償数量_３月       IS '有償数量_３月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.仕入数量_４月       IS '仕入数量_４月'
/
COMMENT ON COLUMN APPS.XXSKZ_仕入有償時系列_数量_V.有償数量_４月       IS '有償数量_４月'
/
