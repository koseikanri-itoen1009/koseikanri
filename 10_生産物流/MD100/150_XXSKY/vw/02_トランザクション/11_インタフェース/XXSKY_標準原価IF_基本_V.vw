CREATE OR REPLACE VIEW APPS.XXSKY_標準原価IF_基本_V
(
 商品区分
,商品区分名
,品目区分
...
FROM    xxcmn_standard_cost_if  XSCI        --標準原価インタフェース
       ,xxsky_item_mst2_v       XIMV_HIN    --品目名取得
       ...
       ,xxsky_item_mst2_v       XIMV_UCH    --内訳品目名取得
...
/
COMMENT ON TABLE APPS.XXSKY_標準原価IF_基本_V IS 'XXSKY_標準原価IF(基本) VIEW'
/	
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.商品区分	        IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.商品区分名	    IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.品目区分	        IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.品目区分名	    IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.群コード	        IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.品目	            IS '品目'
/
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.品目名	        IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.品目略称	        IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.適用開始日	    IS '適用開始日'
/
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.費目区分	        IS '費目区分'
/
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.費目区分名	    IS '費目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.項目区分	        IS '項目区分'
/
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.項目区分名	    IS '項目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.内訳品目	        IS '内訳品目'
/
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.内訳品目名	    IS '内訳品目名'
/
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.内訳品目略称	    IS '内訳品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.単価	            IS '単価'
/
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.作成者	        IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.作成日	        IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.最終更新者	    IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.最終更新日	    IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKY_標準原価IF_基本_V.最終更新ログイン	IS '最終更新ログイン'
/
