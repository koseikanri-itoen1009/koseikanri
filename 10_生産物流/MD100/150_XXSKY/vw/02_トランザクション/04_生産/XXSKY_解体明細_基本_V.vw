CREATE OR REPLACE VIEW APPS.XXSKY_解体明細_基本_V
(
バッチNO
,プラントコード
,プラント名
...
/
COMMENT ON TABLE APPS.XXSKY_解体明細_基本_V IS 'SKYLINK用解体明細（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.バッチNO           IS 'バッチNo'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.プラントコード     IS 'プラントコード'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.プラント名         IS 'プラント名'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.ラインNO           IS 'ラインNo'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.商品区分           IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.商品区分名         IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.品目区分           IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.品目区分名         IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.群コード           IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.品目コード         IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.品目正式名         IS '品目正式名'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.品目略称           IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.ロットNO           IS 'ロットNo'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.製造年月日         IS '製造年月日'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.固有記号           IS '固有記号'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.賞味期限日         IS '賞味期限日'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.計画数量           IS '計画数量'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.WIP計画数量        IS 'WIP計画数量'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.オリジナル数量     IS 'オリジナル数量'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.実績数量           IS '実績数量'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.単位               IS '単位'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.原価割当           IS '原価割当'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.割当済フラグ       IS '割当済フラグ'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.割当済フラグ名     IS '割当済フラグ名'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.作成者             IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.作成日             IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.最終更新者         IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.最終更新日         IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKY_解体明細_基本_V.最終更新ログイン   IS '最終更新ログイン'
/
