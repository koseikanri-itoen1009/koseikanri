/*************************************************************************
 * 
 * View  Name      : XXSKZ_生産明細_基本_V
 * Description     : XXSKZ_生産明細_基本_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 ************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_生産明細_基本_V
(
 バッチNO
,プラントコード
,プラント名
...
FROM
           ...
           SELECT  MTRL.*
             FROM  (  -- 原料詳細アドオンを外部結合＋予定区分の選択条件を満たす為、副問い合わせとする
                      SELECT
                        ...
                        FROM
                              xxcmn_gme_batch_header_arc      GBH               -- 生産バッチ
                             ,gmd_routings_b                  GRTB              -- 工順マスタ
                             ,xxcmn_gme_material_details_arc  GMD               -- 生産原料詳細(原料)
                             ,xxcmn_material_detail_arc       XMD               -- 生産原料詳細（アドオン）バックアップ
                             ,xxcmn_gme_material_details_arc  GMDF              -- 生産原料詳細(完成品)
                       WHERE
                         -- ヘッダテーブルとの結合
                              GBH.batch_type   = 0
         ...
         UNION ALL
           ...
           SELECT
             ...
             FROM
                  ...
                  ,gmd_routings_b                        GRTB               -- 工順マスタ
                  ,xxcmn_gme_material_details_arc        GMD                -- 生産原料詳細(副産物)
        ...
        ,xxskz_item_locations_v             XILV01              -- SKYLINK用中間VIEW OPM保管場所情報VIEW(出倉庫名1)
        ,xxskz_item_locations_v             XILV02              -- SKYLINK用中間VIEW OPM保管場所情報VIEW(出倉庫名2)
        ,xxskz_item_locations_v             XILV03              -- SKYLINK用中間VIEW OPM保管場所情報VIEW(出倉庫名3)
        ,xxskz_item_locations_v             XILV04              -- SKYLINK用中間VIEW OPM保管場所情報VIEW(出倉庫名4)
        ,xxskz_item_locations_v             XILV05              -- SKYLINK用中間VIEW OPM保管場所情報VIEW(出倉庫名5)
        ,xxskz_item_locations_v             XILV06              -- SKYLINK用中間VIEW OPM保管場所情報VIEW(ロット手配倉庫名)
...
/
COMMENT ON TABLE APPS.XXSKZ_生産明細_基本_V IS 'SKYLINK用生産明細（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.バッチNO               IS 'バッチNo'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.プラントコード         IS 'プラントコード'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.プラント名             IS 'プラント名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.ラインNO               IS 'ラインNo'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.商品区分               IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.商品区分名             IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.品目区分               IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.品目区分名             IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.群コード               IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.品目コード             IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.品目正式名             IS '品目正式名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.品目略称               IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.ロットNO               IS 'ロットNo'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.製造年月日             IS '製造年月日'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.固有記号               IS '固有記号'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.賞味期限日             IS '賞味期限日'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.ラインタイプ           IS 'ラインタイプ'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.ラインタイプ名         IS 'ラインタイプ名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.タイプ                 IS 'タイプ'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.タイプ名               IS 'タイプ名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.投入口区分             IS '投入口区分'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.投入口区分名           IS '投入口区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.打込区分               IS '打込区分'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.打込区分名             IS '打込区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.生産日                 IS '生産日'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.原料入庫日             IS '原料入庫日'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.計画数量               IS '計画数量'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.WIP計画数量            IS 'WIP計画数量'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.オリジナル数量         IS 'オリジナル数量'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.実績数量               IS '実績数量'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.単位                   IS '単位'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.原価割当               IS '原価割当'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.割当済フラグ           IS '割当済フラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.割当済フラグ名         IS '割当済フラグ名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.ランク１               IS 'ランク１'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.ランク２               IS 'ランク２'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.ランク３               IS 'ランク３'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.摘要                   IS '摘要'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.在庫入数               IS '在庫入数'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.依頼総数               IS '依頼総数'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.原料削除フラグ         IS '原料削除フラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.出倉庫コード１         IS '出倉庫コード１'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.出倉庫名１             IS '出倉庫名１'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.出倉庫コード２         IS '出倉庫コード２'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.出倉庫名２             IS '出倉庫名２'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.出倉庫コード３         IS '出倉庫コード３'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.出倉庫名３             IS '出倉庫名３'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.出倉庫コード４         IS '出倉庫コード４'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.出倉庫名４             IS '出倉庫名４'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.出倉庫コード５         IS '出倉庫コード５'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.出倉庫名５             IS '出倉庫名５'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.ロット_指示総数        IS 'ロット_指示総数'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.ロット_投入数量        IS 'ロット_投入数量'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.ロット_戻入数量        IS 'ロット_戻入数量'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.ロット_資材製造不良数  IS 'ロット_資材製造不良数'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.ロット_資材業者不良数  IS 'ロット_資材業者不良数'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.ロット_手配倉庫コード  IS 'ロット_手配倉庫コード'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.ロット_手配倉庫名      IS 'ロット_手配倉庫名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.ロット_予定区分        IS 'ロット_予定区分'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.ロット_予定区分名      IS 'ロット_予定区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.ロット_予定番号        IS 'ロット_予定番号'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.作成者                 IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.作成日                 IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.最終更新者             IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.最終更新日             IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKZ_生産明細_基本_V.最終更新ログイン       IS '最終更新ログイン'
/
