/*************************************************************************
 * 
 * View  Name      : XXSKZ_生産ヘッダ_基本_V
 * Description     : XXSKZ_生産ヘッダ_基本_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 ************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_生産ヘッダ_基本_V
(
 バッチNO
,プラントコード
,プラント名
...
FROM
       ...
       ,xxskz_prod_class_v              XPCV                -- SKYLINK用中間VIEW OPM品目区分VIEW(完成品_商品区分)
       ,xxskz_item_class_v              XICV                -- SKYLINK用中間VIEW OPM品目区分VIEW(完成品_品目区分)
       ,xxskz_crowd_code_v              XCCV                -- SKYLINK用中間VIEW OPM品目区分VIEW(完成品_群コード)
       ,xxskz_item_mst2_v               XIM2V               -- SKYLINK用中間VIEW OPM品目情報VIEW2(完成品_品目名)
       ...
       ,xxskz_item_locations_v          XILV01              -- SKYLINK用中間VIEW OPM保管場所情報VIEW(完成品_移動場所名)
...
/
COMMENT ON TABLE APPS.XXSKZ_生産ヘッダ_基本_V IS 'SKYLINK用生産ヘッダ（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.バッチNO              IS 'バッチNo'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.プラントコード        IS 'プラントコード'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.プラント名            IS 'プラント名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.レシピ                IS 'レシピ'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.レシピ名称            IS 'レシピ名称'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.レシピ摘要            IS 'レシピ摘要'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.フォーミュラ          IS 'フォーミュラ'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.フォーミュラ名称      IS 'フォーミュラ名称'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.フォーミュラ名称２    IS 'フォーミュラ名称２'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.フォーミュラ摘要      IS 'フォーミュラ摘要'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.フォーミュラ摘要２    IS 'フォーミュラ摘要２'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.工順                  IS '工順'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.工順名称              IS '工順名称'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.工順摘要              IS '工順摘要'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.業務ステータス        IS '業務ステータス'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.業務ステータス名      IS '業務ステータス名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.送信済みフラグ        IS '送信済みフラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.送信済みフラグ名      IS '送信済みフラグ名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.計画開始日            IS '計画開始日'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.実績開始日            IS '実績開始日'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.必須完了日            IS '必須完了日'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.計画完了日            IS '計画完了日'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.実績完了日            IS '実績完了日'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.バッチステータス      IS 'バッチステータス'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.バッチステータス名    IS 'バッチステータス名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.WIP倉庫               IS 'WIP倉庫'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.WIP倉庫名             IS 'WIP倉庫名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.クローズ日            IS 'クローズ日'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.削除マーク            IS '削除マーク'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.伝票区分              IS '伝票区分'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.成績管理部署          IS '成績管理部署'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.旧伝票番号            IS '旧伝票番号'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_商品区分       IS '完成品_商品区分'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_商品区分名     IS '完成品_商品区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_品目区分       IS '完成品_品目区分'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_品目区分名     IS '完成品_品目区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_群コード       IS '完成品_群コード'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_品目コード     IS '完成品_品目コード'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_品目正式名     IS '完成品_品目正式名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_品目略称       IS '完成品_品目略称'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_ロットNO       IS '完成品_ロットNo'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_タイプ         IS '完成品_タイプ'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_タイプ名       IS '完成品_タイプ名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_製造年月日     IS '完成品_製造年月日'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_固有記号       IS '完成品_固有記号'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_賞味期限日     IS '完成品_賞味期限日'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_生産日         IS '完成品_生産日'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_原料入庫日     IS '完成品_原料入庫日'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_計画数量       IS '完成品_計画数量'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_WIP計画数量    IS '完成品_WIP計画数量'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_オリジナル数量 IS '完成品_オリジナル数量'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_実績数量       IS '完成品_実績数量'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_単位           IS '完成品_単位'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_原価割当       IS '完成品_原価割当'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_割当済フラグ   IS '完成品_割当済フラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_割当済フラグ名 IS '完成品_割当済フラグ名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_ランク１       IS '完成品_ランク１'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_ランク２       IS '完成品_ランク２'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_ランク３       IS '完成品_ランク３'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_摘要           IS '完成品_摘要'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_在庫入数       IS '完成品_在庫入数'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_依頼総数       IS '完成品_依頼総数'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_指図総数       IS '完成品_指図総数'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_委託加工単価   IS '完成品_委託加工単価'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_委託加工費     IS '完成品_委託加工費'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_その他金額     IS '完成品_その他金額'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_計算区分       IS '完成品_計算区分'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_計算区分名     IS '完成品_計算区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_移動場所コード IS '完成品_移動場所コード'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.完成品_移動場所名     IS '完成品_移動場所名'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.作成者                IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.作成日                IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.最終更新者            IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.最終更新日            IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKZ_生産ヘッダ_基本_V.最終更新ログイン      IS '最終更新ログイン'
/
