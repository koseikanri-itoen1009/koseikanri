CREATE OR REPLACE VIEW APPS.XXSKY_解体ヘッダ_基本_V
(
 バッチNO
,プラントコード
,プラント名
...
FROM
        ...
        ,xxsky_prod_class_v             XPCV                -- SKYLINK用中間VIEW OPM品目区分VIEW(解体元_商品区分)
        ,xxsky_item_class_v             XICV                -- SKYLINK用中間VIEW OPM品目区分VIEW(解体元_品目区分)
        ,xxsky_crowd_code_v             XCCV                -- SKYLINK用中間VIEW OPM品目区分VIEW(解体元_群コード)
        ,xxsky_item_mst2_v              XIM2V               -- SKYLINK用中間VIEW OPM品目情報VIEW2(解体元_品目名)
...
/
COMMENT ON TABLE APPS.XXSKY_解体ヘッダ_基本_V IS 'SKYLINK用解体ヘッダ（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.バッチNO              IS 'バッチNO'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.プラントコード        IS 'プラントコード'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.プラント名            IS 'プラント名'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.レシピ                IS 'レシピ'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.レシピ名称            IS 'レシピ名称'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.レシピ摘要            IS 'レシピ摘要'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.フォーミュラ          IS 'フォーミュラ'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.フォーミュラ名称      IS 'フォーミュラ名称'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.フォーミュラ名称２    IS 'フォーミュラ名称２'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.フォーミュラ摘要      IS 'フォーミュラ摘要'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.フォーミュラ摘要２    IS 'フォーミュラ摘要２'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.工順                  IS '工順'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.工順名称              IS '工順名称'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.工順摘要              IS '工順摘要'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.計画開始日            IS '計画開始日'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.実績開始日            IS '実績開始日'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.必須完了日            IS '必須完了日'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.計画完了日            IS '計画完了日'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.実績完了日            IS '実績完了日'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.バッチステータス      IS 'バッチステータス'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.バッチステータス名    IS 'バッチステータス名'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.WIP倉庫               IS 'WIP倉庫'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.WIP倉庫名             IS 'WIP倉庫名'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.クローズ日            IS 'クローズ日'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.削除マーク            IS '削除マーク'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.解体元_商品区分       IS '解体元_商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.解体元_商品区分名     IS '解体元_商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.解体元_品目区分       IS '解体元_品目区分'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.解体元_品目区分名     IS '解体元_品目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.解体元_群コード       IS '解体元_群コード'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.解体元_品目コード     IS '解体元_品目コード'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.解体元_品目正式名     IS '解体元_品目正式名'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.解体元_品目略称       IS '解体元_品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.解体元_ロットNO       IS '解体元_ロットNO'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.解体元_製造年月日     IS '解体元_製造年月日'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.解体元_固有記号       IS '解体元_固有記号'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.解体元_賞味期限日     IS '解体元_賞味期限日'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.解体元_計画数量       IS '解体元_計画数量'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.解体元_WIP計画数量    IS '解体元_WIP計画数量'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.解体元_オリジナル数量 IS '解体元_オリジナル数量'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.解体元_実績数量       IS '解体元_実績数量'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.解体元_単位           IS '解体元_単位'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.解体元_原価割当       IS '解体元_原価割当'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.解体元_割当済フラグ   IS '解体元_割当済フラグ'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.解体元_割当済フラグ名 IS '解体元_割当済フラグ名'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.作成者                IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.作成日                IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.最終更新者            IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.最終更新日            IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKY_解体ヘッダ_基本_V.最終更新ログイン      IS '最終更新ログイン'
/
