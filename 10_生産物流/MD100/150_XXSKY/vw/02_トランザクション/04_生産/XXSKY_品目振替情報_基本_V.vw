CREATE OR REPLACE VIEW APPS.XXSKY_品目振替情報_基本_V
(
 バッチNO
,プラントコード
,プラント名
  ...
  FROM  (
        ...
        FROM
               ...
               ,gmd_routings_b               GRB                           --品目振替情報取得条件用
                --【振替後情報取得用】
               ,gme_material_details         GMD_AFT                       --生産バッチ明細取得用
               ,ic_tran_pnd                  ITP_AFT                       --保留在庫トランザクション
                --【振替前情報取得用】
               ,gme_material_details         GMD_BEF                       --生産バッチ明細取得用
               ,ic_tran_pnd                  ITP_BEF                       --保留在庫トランザクション
        WHERE
                GBH.batch_type               =  0
          --品目振替情報取得条件
       ...
       ,ic_whse_mst                     IWM                         --WIP倉庫名取得用
        --【振替後情報取得用】
       ,xxsky_prod_class_v              XPCV_AFT                    --SKYLINK用中間VIEW 商品区分取得VIEW
       ,xxsky_item_class_v              XICV_AFT                    --SKYLINK用中間VIEW 品目商品区分取得VIEW
       ,xxsky_crowd_code_v              XCCV_AFT                    --SKYLINK用中間VIEW 群コード取得VIEW
       ,xxsky_item_mst2_v               XIM2V_AFT                   --SKYLINK用中間VIEW OPM品目情報VIEW2
       ,ic_lots_mst                     ILM_AFT                     --OPMロットマスタ
        --【振替前情報取得用】
       ,xxsky_prod_class_v              XPCV_BEF                    --SKYLINK用中間VIEW 商品区分取得VIEW
       ,xxsky_item_class_v              XICV_BEF                    --SKYLINK用中間VIEW 品目商品区分取得VIEW
       ,xxsky_crowd_code_v              XCCV_BEF                    --SKYLINK用中間VIEW 群コード取得VIEW
       ,xxsky_item_mst2_v               XIM2V_BEF                   --SKYLINK用中間VIEW OPM品目情報VIEW2
...
/
COMMENT ON TABLE APPS.XXSKY_品目振替情報_基本_V IS 'SKYLINK用品目振替情報（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.バッチNO               IS 'バッチNo'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.プラントコード         IS 'プラントコード'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.プラント名             IS 'プラント名'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.レシピ                 IS 'レシピ'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.レシピ名称             IS 'レシピ名称'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.レシピ摘要             IS 'レシピ摘要'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.フォーミュラ           IS 'フォーミュラ'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.フォーミュラ名称       IS 'フォーミュラ名称'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.フォーミュラ名称２     IS 'フォーミュラ名称２'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.フォーミュラ摘要       IS 'フォーミュラ摘要'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.フォーミュラ摘要２     IS 'フォーミュラ摘要２'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.工順                   IS '工順'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.工順名称               IS '工順名称'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.工順摘要               IS '工順摘要'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.品目振替名称           IS '品目振替名称'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.品目振替摘要           IS '品目振替摘要'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.品目振替目的           IS '品目振替目的'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.品目振替目的名         IS '品目振替目的名'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.計画開始日             IS '計画開始日'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.実績開始日             IS '実績開始日'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.必須完了日             IS '必須完了日'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.計画完了日             IS '計画完了日'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.実績完了日             IS '実績完了日'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.バッチステータス       IS 'バッチステータス'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.バッチステータス名     IS 'バッチステータス名'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.WIP倉庫                IS 'WIP倉庫'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.WIP倉庫名              IS 'WIP倉庫名'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.クローズ日             IS 'クローズ日'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.削除マーク             IS '削除マーク'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.払出_商品区分          IS '払出_商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.払出_商品区分名        IS '払出_商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.払出_品目区分          IS '払出_品目区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.払出_品目区分名        IS '払出_品目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.払出_群コード          IS '払出_群コード'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.払出_品目コード        IS '払出_品目コード'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.払出_品目正式名        IS '払出_品目正式名'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.払出_品目略称          IS '払出_品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.払出_ロットNO          IS '払出_ロットNo'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.払出_製造年月日        IS '払出_製造年月日'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.払出_固有記号          IS '払出_固有記号'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.払出_賞味期限日        IS '払出_賞味期限日'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.払出_計画数量          IS '払出_計画数量'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.払出_WIP計画数量       IS '払出_WIP計画数量'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.払出_オリジナル数量    IS '払出_オリジナル数量'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.払出_実績数量          IS '払出_実績数量'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.払出_単位              IS '払出_単位'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.払出_原価割当          IS '払出_原価割当'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.払出_割当済フラグ      IS '払出_割当済フラグ'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.払出_割当済フラグ名    IS '払出_割当済フラグ名'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.受入_商品区分          IS '受入_商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.受入_商品区分名        IS '受入_商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.受入_品目区分          IS '受入_品目区分'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.受入_品目区分名        IS '受入_品目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.受入_群コード          IS '受入_群コード'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.受入_品目コード        IS '受入_品目コード'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.受入_品目正式名        IS '受入_品目正式名'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.受入_品目略称          IS '受入_品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.受入_ロットNO          IS '受入_ロットNo'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.受入_製造年月日        IS '受入_製造年月日'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.受入_固有記号          IS '受入_固有記号'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.受入_賞味期限日        IS '受入_賞味期限日'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.受入_計画数量          IS '受入_計画数量'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.受入_WIP計画数量       IS '受入_WIP計画数量'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.受入_オリジナル数量    IS '受入_オリジナル数量'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.受入_実績数量          IS '受入_実績数量'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.受入_単位              IS '受入_単位'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.受入_原価割当          IS '受入_原価割当'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.受入_割当済フラグ      IS '受入_割当済フラグ'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.受入_割当済フラグ名    IS '受入_割当済フラグ名'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.作成者                 IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.作成日                 IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.最終更新者             IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.最終更新日             IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKY_品目振替情報_基本_V.最終更新ログイン       IS '最終更新ログイン'
/
