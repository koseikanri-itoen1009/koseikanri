...
/
COMMENT ON TABLE APPS.XXSKZ_外注出来高実績_V IS 'XXSKZ_外注出来高実績 VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.処理タイプ IS '処理タイプ'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.処理タイプ名 IS '処理タイプ名'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.生産日 IS '生産日'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.取引先コード IS '取引先コード'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.取引先名 IS '取引先名'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.工場コード IS '工場コード'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.工場名 IS '工場名'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.納入先コード IS '納入先コード'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.納入先名 IS '納入先名'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.品目コード IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.品目名 IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.品目略称 IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.ロットNO IS 'ロットNo'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.製造日 IS '製造日'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.固有記号 IS '固有記号'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.賞味期限 IS '賞味期限'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.数量 IS '数量'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.単位コード IS '単位コード'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.出来高数量 IS '出来高数量'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.訂正数量 IS '訂正数量'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.出来高単位コード IS '出来高単位コード'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.換算入数 IS '換算入数'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.発注作成フラグ IS '発注作成フラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.発注作成日 IS '発注作成日'
/
...
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.最終更新者 IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.最終更新日 IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKZ_外注出来高実績_V.最終更新ログイン IS '最終更新ログイン'
/
