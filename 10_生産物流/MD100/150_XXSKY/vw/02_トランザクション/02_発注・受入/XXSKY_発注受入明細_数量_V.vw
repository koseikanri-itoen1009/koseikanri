CREATE OR REPLACE VIEW APPS.XXSKY_発注受入明細_数量_V
(
 発注番号
,受入返品番号
,明細番号
...
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.商品区分 IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.商品区分名 IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.品目区分 IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.品目区分名 IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.群コード IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.品目コード IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.品目名 IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.品目略称 IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.数量 IS '数量'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.ロット番号 IS 'ロット番号'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.製造年月日 IS '製造年月日'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.固有記号 IS '固有記号'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.賞味期限 IS '賞味期限'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.工場コード IS '工場コード'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.工場名 IS '工場名'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.付帯コード IS '付帯コード'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.在庫入数 IS '在庫入数'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.依頼数量 IS '依頼数量'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.依頼数量単位コード IS '依頼数量単位コード'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.仕入先出荷日 IS '仕入先出荷日'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.仕入先出荷数量 IS '仕入先出荷数量'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.受入数量 IS '受入数量'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.日付指定 IS '日付指定'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.発注単位 IS '発注単位'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.発注数量 IS '発注数量'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.相手先在庫入庫先 IS '相手先在庫入庫先'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.相手先在庫入庫先名 IS '相手先在庫入庫先名'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.数量確定フラグ IS '数量確定フラグ'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.数量確定フラグ名 IS '数量確定フラグ名'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.金額確定フラグ IS '金額確定フラグ'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.金額確定フラグ名 IS '金額確定フラグ名'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.取消フラグ IS '取消フラグ'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.取消フラグ名 IS '取消フラグ名'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.摘要 IS '摘要'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.発注_作成者 IS '発注_作成者'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.発注_作成日 IS '発注_作成日'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.発注_最終更新者 IS '発注_最終更新者'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.発注_最終更新日 IS '発注_最終更新日'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.発注_最終更新ログイン IS '発注_最終更新ログイン'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.受入実績日 IS '受入実績日'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.受入単位 IS '受入単位'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.受入返品数量 IS '受入返品数量'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.受入返品単位 IS '受入返品単位'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.受入返品換算入数 IS '受入返品換算入数'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.粉引率 IS '粉引率'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.口銭区分 IS '口銭区分'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.口銭区分名 IS '口銭区分名'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.賦課金区分 IS '賦課金区分'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.賦課金区分名 IS '賦課金区分名'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.受入_作成者 IS '受入_作成者'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.受入_作成日 IS '受入_作成日'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.受入_最終更新者 IS '受入_最終更新者'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.受入_最終更新日 IS '受入_最終更新日'
/
COMMENT ON COLUMN APPS.XXSKY_発注受入明細_数量_V.受入_最終更新ログイン IS '受入_最終更新ログイン'
/
