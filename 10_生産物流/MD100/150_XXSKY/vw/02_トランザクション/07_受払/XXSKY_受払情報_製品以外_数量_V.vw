CREATE OR REPLACE VIEW APPS.XXSKY_受払情報_製品以外_数量_V
(
 年月
,商品区分
,商品区分名
...
/
COMMENT ON TABLE APPS.XXSKY_受払情報_製品以外_数量_V IS 'SKYLINK用受払情報製品以外（数量）VIEW'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.年月                           IS '年月'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.商品区分                       IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.商品区分名                     IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.倉庫コード                     IS '倉庫コード'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.倉庫名                         IS '倉庫名'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.品目区分                       IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.品目区分名                     IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.群コード                       IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.品目コード                     IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.品目名称                       IS '品目名称'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.品目略称                       IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.月首在庫                       IS '月首在庫'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.月首在庫ケース                 IS '月首在庫ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.受入数量_仕入                  IS '受入数量_仕入'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.受入数量_仕入ケース            IS '受入数量_仕入ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.受入数量_再製                  IS '受入数量_再製'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.受入数量_再製ケース            IS '受入数量_再製ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.受入数量_合組                  IS '受入数量_合組'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.受入数量_合組ケース            IS '受入数量_合組ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.受入数量_再製合組              IS '受入数量_再製合組'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.受入数量_再製合組ケース        IS '受入数量_再製合組ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.受入数量_製品より              IS '受入数量_製品より'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.受入数量_製品よりケース        IS '受入数量_製品よりケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.受入数量_原料_半製品より       IS '受入数量_原料_半製品より'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.受入数量_原料_半製品よりケース IS '受入数量_原料_半製品よりケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.受入数量_浜岡                  IS '受入数量_浜岡'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.受入数量_浜岡ケース            IS '受入数量_浜岡ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.受入数量_品種移動              IS '受入数量_品種移動'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.受入数量_品種移動ケース        IS '受入数量_品種移動ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.受入数量_倉庫移動              IS '受入数量_倉庫移動'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.受入数量_倉庫移動ケース        IS '受入数量_倉庫移動ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.受入数量_その他                IS '受入数量_その他'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.受入数量_その他ケース          IS '受入数量_その他ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_再製                  IS '払出数量_再製'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_再製ケース            IS '払出数量_再製ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_ブレンド合組          IS '払出数量_ブレンド合組'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_ブレンド合組ケース    IS '払出数量_ブレンド合組ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_再製合組              IS '払出数量_再製合組'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_再製合組ケース        IS '払出数量_再製合組ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_包装                  IS '払出数量_包装'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_包装ケース            IS '払出数量_包装ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_セット                IS '払出数量_セット'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_セットケース          IS '払出数量_セットケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_沖縄                  IS '払出数量_沖縄'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_沖縄ケース            IS '払出数量_沖縄ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_有償                  IS '払出数量_有償'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_有償ケース            IS '払出数量_有償ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_拠点                  IS '払出数量_拠点'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_拠点ケース            IS '払出数量_拠点ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_振替出庫              IS '払出数量_振替出庫'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_振替出庫ケース        IS '払出数量_振替出庫ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_製品へ                IS '払出数量_製品へ'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_製品へケース          IS '払出数量_製品へケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_原料_半製品へ         IS '払出数量_原料_半製品へ'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_原料_半製品へケース   IS '払出数量_原料_半製品へケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_転売                  IS '払出数量_転売'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_転売ケース            IS '払出数量_転売ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_廃却                  IS '払出数量_廃却'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_廃却ケース            IS '払出数量_廃却ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_見本                  IS '払出数量_見本'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_見本ケース            IS '払出数量_見本ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_総務払出              IS '払出数量_総務払出'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_総務払出ケース        IS '払出数量_総務払出ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_経理払出              IS '払出数量_経理払出'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_経理払出ケース        IS '払出数量_経理払出ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_品種移動              IS '払出数量_品種移動'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_品種移動ケース        IS '払出数量_品種移動ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_倉庫移動              IS '払出数量_倉庫移動'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_倉庫移動ケース        IS '払出数量_倉庫移動ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_その他                IS '払出数量_その他'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_その他ケース          IS '払出数量_その他ケース'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_棚卸減耗              IS '払出数量_棚卸減耗'
/
COMMENT ON COLUMN APPS.XXSKY_受払情報_製品以外_数量_V.払出数量_棚卸減耗ケース        IS '払出数量_棚卸減耗ケース'
/
