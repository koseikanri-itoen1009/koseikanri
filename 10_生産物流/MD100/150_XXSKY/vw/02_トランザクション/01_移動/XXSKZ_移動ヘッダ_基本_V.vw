/*************************************************************************
 * 
 * View  Name      : XXSKZ_移動ヘッダ_基本_V
 * Description     : XXSKZ_移動ヘッダ_基本_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 ************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_移動ヘッダ_基本_V
(
 移動番号
,移動タイプ
,移動タイプ名
...
-- 2010/1/7 #627 Y.FUkami Mod End
  ...
  FROM  xxcmn_mov_req_instr_hdrs_arc  XMRIH --移動依頼/指示ヘッダ（アドオン）バックアップ
       ,xxcmn_carriers_schedule_arc      XCS   --配車配送計画（アドオン）バックアップ
       ,xxskz_locations2_v           XLV   --SKYLINK用中間VIEW 事業所情報VIEW
       ,xxskz_item_locations2_v      XILV1 --SKYLINK用中間VIEW OPM保管場所情報VIEW(出庫元保管場所名取得用)
       ,xxskz_item_locations2_v      XILV2 --SKYLINK用中間VIEW OPM保管場所情報VIEW(入庫先保管場所名取得用)
       ,hr_all_organization_units_tl HAOUT --
       ,xxskz_carriers2_v            XCV1  --SKYLINK用中間VIEW 運送業者情報VIEW(運送業者名取得用)
       ,xxskz_carriers2_v            XCV2  --SKYLINK用中間VIEW 運送業者情報VIEW(運送業者名_実績取得用)
...
/
COMMENT ON TABLE APPS.XXSKZ_移動ヘッダ_基本_V IS 'SKYLINK用移動ヘッダ（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.移動番号                       IS '移動番号'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.移動タイプ                     IS '移動タイプ'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.移動タイプ名                   IS '移動タイプ名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送NO                         IS '配送No'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.入力日                         IS '入力日'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.指示部署                       IS '指示部署'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.指示部署名                     IS '指示部署名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.ステータス                     IS 'ステータス'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.ステータス名                   IS 'ステータス名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.通知ステータス                 IS '通知ステータス'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.通知ステータス名               IS '通知ステータス名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.出庫元保管場所                 IS '出庫元保管場所'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.出庫元保管場所名               IS '出庫元保管場所名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.入庫先保管場所                 IS '入庫先保管場所'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.入庫先保管場所名               IS '入庫先保管場所名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.出庫予定日                     IS '出庫予定日'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.入庫予定日                     IS '入庫予定日'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.運賃区分                       IS '運賃区分'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.運賃区分名                     IS '運賃区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.パレット回収枚数               IS 'パレット回収枚数'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.パレット枚数_出                IS 'パレット枚数_出'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.パレット枚数_入                IS 'パレット枚数_入'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.契約外運賃区分                 IS '契約外運賃区分'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.契約外運賃区分名               IS '契約外運賃区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.移動_摘要                      IS '移動_摘要'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.積載率_重量                    IS '積載率_重量'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.積載率_容積                    IS '積載率_容積'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.組織名                         IS '組織名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.運送業者                       IS '運送業者'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.運送業者名                     IS '運送業者名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送区分                       IS '配送区分'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送区分名                     IS '配送区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.運送業者_実績                  IS '運送業者_実績'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.運送業者名_実績                IS '運送業者名_実績'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送区分_実績                  IS '配送区分_実績'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送区分名_実績                IS '配送区分名_実績'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.運送業者_予実                  IS '運送業者_予実'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.運送業者名_予実                IS '運送業者名_予実'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送区分_予実                  IS '配送区分_予実'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送区分名_予実                IS '配送区分名_予実'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.着荷時間FROM                   IS '着荷時間FROM'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.着荷時間FROM名                 IS '着荷時間FROM名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.着荷時間TO                     IS '着荷時間TO'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.着荷時間TO名                   IS '着荷時間TO名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.送り状NO                       IS '送り状No'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.合計数量                       IS '合計数量'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.小口個数                       IS '小口個数'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.ラベル枚数                     IS 'ラベル枚数'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.基本重量                       IS '基本重量'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.基本容積                       IS '基本容積'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.積載重量合計                   IS '積載重量合計'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.積載容積合計                   IS '積載容積合計'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.合計パレット重量               IS '合計パレット重量'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.パレット合計枚数               IS 'パレット合計枚数'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.混載率                         IS '混載率'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.重量容積区分                   IS '重量容積区分'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.重量容積区分名                 IS '重量容積区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.出庫実績日                     IS '出庫実績日'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.出庫日_予実                    IS '出庫日_予実'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.入庫実績日                     IS '入庫実績日'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.入庫日_予実                    IS '入庫日_予実'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.混載記号                       IS '混載記号'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.手配NO                         IS '手配No'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.商品区分                       IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.商品区分名                     IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.製品識別区分                   IS '製品識別区分'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.製品識別区分名                 IS '製品識別区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.指示なし実績区分               IS '指示なし実績区分'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.実績計上済フラグ               IS '実績計上済フラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.実績計上済フラグ名             IS '実績計上済フラグ名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.実績訂正フラグ                 IS '実績訂正フラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.実績訂正フラグ名               IS '実績訂正フラグ名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.前回通知ステータス             IS '前回通知ステータス'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.前回通知ステータス名           IS '前回通知ステータス名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.確定通知実施日時               IS '確定通知実施日時'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.前回配送No                     IS '前回配送No'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.新規修正フラグ                 IS '新規修正フラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.新規修正フラグ名               IS '新規修正フラグ名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.画面更新者                     IS '画面更新者'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.画面更新日時                   IS '画面更新日時'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送_処理種別                  IS '配送_処理種別'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送_処理種別名                IS '配送_処理種別名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送_混載種別                  IS '配送_混載種別'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送_混載種別名                IS '配送_混載種別名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送_配送先コード区分          IS '配送_配送先コード区分'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送_配送先コード区分名        IS '配送_配送先コード区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送_自動配車対象区分          IS '配送_自動配車対象区分'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送_自動配車対象区分名        IS '配送_自動配車対象区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送_摘要                      IS '配送_摘要'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送_支払運賃計算対象フラグ    IS '配送_支払運賃計算対象フラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送_支払運賃計算対象フラグ名  IS '配送_支払運賃計算対象フラグ名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送_請求運賃計算対象フラグ    IS '配送_請求運賃計算対象フラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送_請求運賃計算対象フラグ名  IS '配送_請求運賃計算対象フラグ名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送_積載重量合計_配車         IS '配送_積載重量合計_配車'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送_積載容積合計_配車         IS '配送_積載容積合計_配車'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送_重量積載効率              IS '配送_重量積載効率'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送_容積積載効率              IS '配送_容積積載効率'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送_運賃形態                  IS '配送_運賃形態'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.配送_運賃形態名                IS '配送_運賃形態名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.作成者                         IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.作成日                         IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.最終更新者                     IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.最終更新日                     IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKZ_移動ヘッダ_基本_V.最終更新ログイン               IS '最終更新ログイン'
/
