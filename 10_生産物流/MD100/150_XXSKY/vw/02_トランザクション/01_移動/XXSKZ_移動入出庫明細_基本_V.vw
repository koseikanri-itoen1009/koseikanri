/*************************************************************************
 * 
 * View  Name      : XXSKZ_移動入出庫明細_基本_V
 * Description     : XXSKZ_移動入出庫明細_基本_V
 * MD.070          : 
 * Version         : 1.0
 * 
 * Change Record
 ...
 ************************************************************************/
CREATE OR REPLACE VIEW APPS.XXSKZ_移動入出庫明細_基本_V
(
 移動番号
,明細番号
,組織名
           ...
           SELECT  XMRIH.mov_num                     --移動番号
             ...
             FROM  xxcmn_mov_req_instr_lines_arc    XMRIL               --移動依頼/指示明細（アドオン）バックアップ
                  ...
                  ,(  SELECT  distinct mov_line_id
                                      ...
                                      ,lot_id
                                      ,lot_no
                        FROM  xxcmn_mov_lot_details_arc  --移動ロット詳細（アドオン）バックアップ
                  ...
                  ,(  SELECT  XMLD10.mov_line_id
                        ...
                        FROM  xxcmn_mov_lot_details_arc       XMLD10  --移動ロット詳細（アドオン）バックアップ
                  ...
                  ,(  SELECT  XMLD20.mov_line_id
                        ...
                        FROM  xxcmn_mov_lot_details_arc       XMLD20  --移動ロット詳細（アドオン）バックアップ
                  ...
                  ,(  SELECT  XMLD30.mov_line_id
                        ...
                        FROM  xxcmn_mov_lot_details_arc       XMLD30  --移動ロット詳細（アドオン）バックアップ
...
/
COMMENT ON TABLE APPS.XXSKZ_移動入出庫明細_基本_V IS 'SKYLINK用移動入出庫明細（基本）VIEW'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.移動番号 IS '移動番号'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.明細番号 IS '明細番号'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.組織名 IS '組織名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.商品区分 IS '商品区分'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.商品区分名 IS '商品区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.品目区分 IS '品目区分'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.品目区分名 IS '品目区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.群コード IS '群コード'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.品目コード IS '品目コード'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.品目名 IS '品目名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.品目略称 IS '品目略称'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.依頼数量 IS '依頼数量'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.パレット数 IS 'パレット数'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.段数 IS '段数'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.ケース数 IS 'ケース数'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.指示数量 IS '指示数量'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.引当数 IS '引当数'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.単位 IS '単位'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.指定製造日 IS '指定製造日'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.パレット枚数 IS 'パレット枚数'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.参照移動番号 IS '参照移動番号'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.参照発注番号 IS '参照発注番号'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.初回指示数量 IS '初回指示数量'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.出庫実績数量 IS '出庫実績数量'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.入庫実績数量 IS '入庫実績数量'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.重量 IS '重量'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.容積 IS '容積'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.パレット重量 IS 'パレット重量'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.自動手動引当区分 IS '自動手動引当区分'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.自動手動引当区分名 IS '自動手動引当区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.取消フラグ IS '取消フラグ'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.取消フラグ名 IS '取消フラグ名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.警告日付 IS '警告日付'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.警告区分 IS '警告区分'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.ロットNO IS 'ロットNo'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.製造年月日 IS '製造年月日'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.固有記号 IS '固有記号'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.賞味期限 IS '賞味期限'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.指示_レコードタイプ IS '指示_レコードタイプ'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.指示_レコードタイプ名 IS '指示_レコードタイプ名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.指示_実績日 IS '指示_実績日'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.指示_実績数量 IS '指示_実績数量'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.指示_訂正前実績数量 IS '指示_訂正前実績数量'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.指示_自動手動引当区分 IS '指示_自動手動引当区分'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.指示_自動手動引当区分名 IS '指示_自動手動引当区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.出庫_レコードタイプ IS '出庫_レコードタイプ'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.出庫_レコードタイプ名 IS '出庫_レコードタイプ名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.出庫_実績日 IS '出庫_実績日'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.出庫_実績数量 IS '出庫_実績数量'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.出庫_訂正前実績数量 IS '出庫_訂正前実績数量'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.出庫_自動手動引当区分 IS '出庫_自動手動引当区分'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.出庫_自動手動引当区分名 IS '出庫_自動手動引当区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.入庫_レコードタイプ IS '入庫_レコードタイプ'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.入庫_レコードタイプ名 IS '入庫_レコードタイプ名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.入庫_実績日 IS '入庫_実績日'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.入庫_実績数量 IS '入庫_実績数量'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.入庫_訂正前実績数量 IS '入庫_訂正前実績数量'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.入庫_自動手動引当区分 IS '入庫_ロット_自動手動引当区分'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.入庫_自動手動引当区分名 IS '入庫_ロット_自動手動引当区分名'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.作成者 IS '作成者'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.作成日 IS '作成日'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.最終更新者 IS '最終更新者'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.最終更新日 IS '最終更新日'
/
COMMENT ON COLUMN APPS.XXSKZ_移動入出庫明細_基本_V.最終更新ログイン IS '最終更新ログイン'
/
