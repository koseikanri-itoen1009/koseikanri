CREATE OR REPLACE VIEW xxwsh_head_branch_rf_dept_v
(
  user_id,
  party_number,
  party_short_name
...
;
--
COMMENT ON COLUMN xxwsh_head_branch_rf_dept_v.user_id          IS 'ユーザID';
COMMENT ON COLUMN xxwsh_head_branch_rf_dept_v.party_number     IS '管轄拠点';
COMMENT ON COLUMN xxwsh_head_branch_rf_dept_v.party_short_name IS '管轄拠点名称';
--
COMMENT ON TABLE  xxwsh_head_branch_rf_dept_v IS '管轄拠点(部署情報参照)VIEW';
