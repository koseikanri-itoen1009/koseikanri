...
-- 2009/04/24 Y.Kazama 本番障害#1398対応(60A) Mod Start
AND   xcasv.party_site_number(+)  = xoha.deliver_to                   -- 出荷先名称
AND   xcasv2.party_site_number(+) = xoha.result_deliver_to            -- 出荷先_実績名称
--AND   xcasv.party_site_id(+)      = xoha.deliver_to_id
--AND   xcasv2.party_site_id(+)     = xoha.result_deliver_to_id
-- 2009/04/24 Y.Kazama 本番障害#1398対応(60A) Mod End
