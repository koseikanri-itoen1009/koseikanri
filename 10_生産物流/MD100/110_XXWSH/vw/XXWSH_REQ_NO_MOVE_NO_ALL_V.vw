...
;
--
COMMENT ON COLUMN xxwsh_req_no_move_no_all_v.biz_type   IS '‹Æ–±Ží•Ê';
COMMENT ON COLUMN xxwsh_req_no_move_no_all_v.request_no IS 'ˆË—ŠNo/ˆÚ“®No';
--
COMMENT ON TABLE xxwsh_req_no_move_no_all_v IS 'ˆË—ŠNo/ˆÚ“®No(‘S‚Ä)VIEW';
