CREATE OR REPLACE FORCE VIEW xxcmn_stnd_unit_price2_v
  (
    start_date_active
--    period
--   ,start_date_active
...
AS
  SELECT cldd.start_date                      AS start_date_active
...
--        ,cm_cmpt_mst_b  cmpm10
  WHERE  cldd.calendar_code        = cmpd1.calendar_code
...
--
--COMMENT ON COLUMN xxcmn_stnd_unit_price2_v.period                IS '年度' ;
COMMENT ON COLUMN xxcmn_stnd_unit_price2_v.start_date_active     IS '適用開始日' ;
COMMENT ON COLUMN xxcmn_stnd_unit_price2_v.end_date_active       IS '適用終了日' ;
COMMENT ON COLUMN xxcmn_stnd_unit_price2_v.item_id               IS '品目ID' ;
COMMENT ON COLUMN xxcmn_stnd_unit_price2_v.stnd_unit_price       IS '標準原価' ;
COMMENT ON COLUMN xxcmn_stnd_unit_price2_v.stnd_unit_price_gen   IS '標準原価＿原料' ;
COMMENT ON COLUMN xxcmn_stnd_unit_price2_v.stnd_unit_price_sai   IS '標準原価＿再製費' ;
COMMENT ON COLUMN xxcmn_stnd_unit_price2_v.stnd_unit_price_shi   IS '標準原価＿資材費' ;
COMMENT ON COLUMN xxcmn_stnd_unit_price2_v.stnd_unit_price_hou   IS '標準原価＿包装費' ;
COMMENT ON COLUMN xxcmn_stnd_unit_price2_v.stnd_unit_price_gai   IS '標準原価＿外注加工費' ;
COMMENT ON COLUMN xxcmn_stnd_unit_price2_v.stnd_unit_price_hok   IS '標準原価＿保管費' ;
COMMENT ON COLUMN xxcmn_stnd_unit_price2_v.stnd_unit_price_kei   IS '標準原価＿その他経費' ;
--
COMMENT ON TABLE  xxcmn_stnd_unit_price2_v IS '標準原価情報View2' ;
