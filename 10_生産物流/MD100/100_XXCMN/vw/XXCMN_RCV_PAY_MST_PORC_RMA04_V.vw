 ...
 * Description     : 経理受払区分情報VIEW_購買関連_出荷(for XXCMN770004C)
 * Version         : 1.7
 *
 * Change Record
 * ------------- ----- ---------------- ---------------------------------
...
WHERE xrpm.doc_type                   = 'PORC'
  ...
  AND iimb_a.item_id            = gic_a2.item_id
/
COMMENT ON TABLE XXCMN_RCV_PAY_MST_PORC_RMA04_V IS '経理受払区分情報VIEW_購買関連_出荷04'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA04_V.NEW_DIV_ACCOUNT IS '新経理受払区分'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA04_V.DEALINGS_DIV IS '取引区分'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA04_V.RCV_PAY_DIV IS '受払区分'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA04_V.DOC_TYPE IS '文書タイプ'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA04_V.DOC_ID   IS '文書ID'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA04_V.DOC_LINE IS '取引明細番号'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA04_V.RESULT_POST IS '成績部署'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA04_V.ITEM_ID IS '品目ID'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA04_V.ITEM_DIV IS '品目区分'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA04_V.PROD_DIV IS '商品区分'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA04_V.DEALINGS_DIV_NAME IS '取引区分名'
/