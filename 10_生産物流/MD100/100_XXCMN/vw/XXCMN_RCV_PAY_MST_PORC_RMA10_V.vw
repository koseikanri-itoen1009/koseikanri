 ...
 * Description     : 経理受払区分情報VIEW_購買関連_出荷(for XXCMN770010C)
 * Version         : 1.0
 *
 * Change Record
 * ------------- ----- ---------------- ---------------------------------
 ...
 * ------------- ----- ---------------- ---------------------------------
 *  2008-08-07    1.0   Y.Majikina       新規作成
 *
 ************************************************************************/
...
SELECT NULL                            AS item_id                    -- 品目ID
      ,xrpm.new_div_account            AS new_div_account            -- 新経理受払区分
...
WHERE xrpm.doc_type                   = 'PORC'
  ...
  AND xrpm.ship_prov_rcv_pay_category = otta.attribute11
/
COMMENT ON TABLE XXCMN_RCV_PAY_MST_PORC_RMA10_V IS '経理受払区分情報VIEW_購買関連_出荷10'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA10_V.ITEM_ID IS '品目ID'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA10_V.NEW_DIV_ACCOUNT IS '新経理受払区分'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA10_V.DEALINGS_DIV IS '取引区分'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA10_V.RCV_PAY_DIV IS '受払区分'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA10_V.DOC_ID   IS '文書ID'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA10_V.DOC_LINE IS '取引明細番号'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA10_V.DEALINGS_DIV_NAME IS '取引区分名'
/
