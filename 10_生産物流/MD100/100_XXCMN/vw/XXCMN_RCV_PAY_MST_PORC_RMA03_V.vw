 ...
 *
 * View Name       : XXCMN_RCV_PAY_MST_PORC_RMA03_V
 * Description     : 経理受払区分情報VIEW_購買関連_出荷(for XXCMN770003C)
 * Version         : 1.7
 *
 * Change Record
 * ------------- ----- ---------------- ---------------------------------
 ...
 *
 ************************************************************************/
CREATE OR REPLACE VIEW XXCMN_RCV_PAY_MST_PORC_RMA03_V
    (DEALINGS_DIV,RCV_PAY_DIV,DOC_TYPE,DOC_ID,DOC_LINE,DEALINGS_DIV_NAME)
AS
...
WHERE xrpm.doc_type                   = 'PORC'
  ...
  AND xrpm.ship_prov_rcv_pay_category = otta.attribute11
/
COMMENT ON TABLE XXCMN_RCV_PAY_MST_PORC_RMA03_V IS '経理受払区分情報VIEW_購買関連_出荷'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA03_V.DEALINGS_DIV IS '取引区分'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA03_V.RCV_PAY_DIV IS '受払区分'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA03_V.DOC_TYPE IS '文書タイプ'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA03_V.DOC_ID   IS '文書ID'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA03_V.DOC_LINE IS '取引明細番号'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA03_V.DEALINGS_DIV_NAME IS '取引区分名'
/