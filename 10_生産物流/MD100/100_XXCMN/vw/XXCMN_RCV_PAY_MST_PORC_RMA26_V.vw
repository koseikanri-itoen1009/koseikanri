...
WHERE xrpm.doc_type                   = 'PORC'
  ...
  AND iimb_a.item_id            = gic_a4.item_id
/
COMMENT ON TABLE XXCMN_RCV_PAY_MST_PORC_RMA26_V IS '経理受払区分情報VIEW_購買関連_出荷'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.NEW_DIV_ACCOUNT IS '新経理受払区分'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.DEALINGS_DIV IS '取引区分'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.RCV_PAY_DIV IS '受払区分'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.DOC_TYPE IS '文書タイプ'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.SOURCE_DOCUMENT_CODE IS 'ソース文書'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.TRANSACTION_TYPE IS 'PO取引タイプ'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.SHIPMENT_PROVISION_DIV IS '出荷支給区分'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.STOCK_ADJUSTMENT_DIV IS '在庫調整区分'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.SHIP_PROV_RCV_PAY_CATEGORY IS '出荷支給受払カテゴリ'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.ITEM_DIV_AHEAD IS '品目区分（振替先）'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.ITEM_DIV_ORIGIN IS '品目区分（振替元）'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.PROD_DIV_AHEAD IS '商品区分（振替先）'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.PROD_DIV_ORIGIN IS '商品区分（振替元）'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.ROUTING_CLASS IS '工順区分'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.LINE_TYPE IS 'ラインタイプ'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.HIT_IN_DIV IS '打込区分'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.REASON_CODE IS '事由コード'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.DOC_ID   IS '文書ID'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.DOC_LINE IS '取引明細番号'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.RESULT_POST IS '成績部署'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.UNIT_PRICE IS '販売単価'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.REQUEST_ITEM_CODE IS '依頼品目コード'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.DELIVER_TO_ID IS '出荷先ID'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.ITEM_ID IS '品目ID'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.ITEM_DIV IS '品目区分'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.PROD_DIV IS '商品区分'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.CROWD_CODE IS '郡'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.ACNT_CROWD_CODE IS '経理郡'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.DEALINGS_DIV_NAME IS '取引区分名'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA26_V.VENDOR_SITE_ID IS '仕入先ID'
/