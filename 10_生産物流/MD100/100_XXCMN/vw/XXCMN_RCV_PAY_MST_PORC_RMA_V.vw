 ...
 *  2008-06-13    1.5   Y.Ishikawa       カテゴリ取得部分でGROUP BYの利用をやめる
 *  2008-07-01    1.6   Y.Ishikawa       出荷支給区分によって受注ヘッダーの抽出条件
 *                                       が出荷実績か支給実績を判断するよう変更する
 *  2008-07-24    1.7   Y.Ishikawa       利用していないカテゴリ情報の結合削除
 *
 ************************************************************************/
...
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA_V.DEALINGS_DIV_NAME IS '取引区分名'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA_V.VENDOR_SITE_ID IS '仕入先ID'
/