 ...
 *
 * View Name       : XXCMN_RCV_PAY_MST_PORC_RMA01_V
 * Description     : 経理受払区分情報VIEW_購買関連_出荷(for XXCMN770001C)
 * Version         : 1.0
 *
 * Change Record
 * ------------- ----- ---------------- ---------------------------------
 ...
 * ------------- ----- ---------------- ---------------------------------
 *  2008-07-31    1.0   R.Tomoyose       新規作成
 *
 ************************************************************************/
CREATE OR REPLACE VIEW XXCMN_RCV_PAY_MST_PORC_RMA01_V
    (ITEM_ID,DEALINGS_DIV,RCV_PAY_DIV,DOC_TYPE,DOC_ID,DOC_LINE,DEALINGS_DIV_NAME)
AS
SELECT NULL                            AS item_id                    -- 品目ID
...
WHERE xrpm.doc_type                   = 'PORC'
  ...
  AND xrpm.ship_prov_rcv_pay_category = otta.attribute11
/
COMMENT ON TABLE XXCMN_RCV_PAY_MST_PORC_RMA01_V IS '経理受払区分情報VIEW_購買関連_出荷01'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA01_V.ITEM_ID IS '品目ID'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA01_V.DEALINGS_DIV IS '取引区分'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA01_V.RCV_PAY_DIV IS '受払区分'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA01_V.DOC_TYPE IS '文書タイプ'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA01_V.DOC_ID   IS '文書ID'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA01_V.DOC_LINE IS '取引明細番号'
/
COMMENT ON COLUMN XXCMN_RCV_PAY_MST_PORC_RMA01_V.DEALINGS_DIV_NAME IS '取引区分名'
/