...
COMMENT ON COLUMN xxcmn_cust_accounts_v.department              IS '部署';
COMMENT ON COLUMN xxcmn_cust_accounts_v.billing_department      IS '請求管理部署';
COMMENT ON COLUMN xxcmn_cust_accounts_v.payment_term_id         IS '支払条件';
COMMENT ON COLUMN xxcmn_cust_accounts_v.tax_rounding_rule       IS '四捨五入区分';
COMMENT ON COLUMN xxcmn_cust_accounts_v.consumption_tax_code    IS '消費税区分';
COMMENT ON COLUMN xxcmn_cust_accounts_v.eos_control_type        IS 'EOS管理区分';
COMMENT ON COLUMN xxcmn_cust_accounts_v.eos_detination          IS 'EOS宛先';
COMMENT ON COLUMN xxcmn_cust_accounts_v.carriage_due_date       IS '運送費 - 締日';
COMMENT ON COLUMN xxcmn_cust_accounts_v.carriage_rounding_rule  IS '運送費 - 四捨五入区分';
COMMENT ON COLUMN xxcmn_cust_accounts_v.carriage_tax_code       IS '運送費 - 消費税区分';
COMMENT ON COLUMN xxcmn_cust_accounts_v.pay_judgement_code      IS '支払判断区分';
--
